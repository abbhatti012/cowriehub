...
*/
(function(U, K) { "object" === typeof module && module.exports ? (K["default"] = K, module.exports = U.document ? K(U) : K) : "function" === typeof define && define.amd ? define("highcharts/highcharts", function() { return K(U) }) : (U.Highcharts && U.Highcharts.error(16, !0), U.Highcharts = K(U)) })("undefined" !== typeof window ? window : this, function(U) {
    function K(a, C, f, H) { a.hasOwnProperty(C) || (a[C] = H.apply(null, f), "function" === typeof CustomEvent && U.dispatchEvent(new CustomEvent("HighchartsModuleLoaded", { detail: { path: C, module: a[C] } }))) }
    var f = {};
    ...
    K(f, "Core/Utilities.js", [f["Core/Globals.js"]], function(a) {
        function f(d, r, h, l) {
            ...
            z(a, "displayError", { chart: h, code: d, message: c, params: l }, function() {
                if (r) throw Error(c);
        ...
        function B(b, d) {
            var v = {};
            y(b, function(r, h) {
                if (I(b[h], !0) && !b.nodeType && d[h]) r = B(b[h], d[h]), Object.keys(r).length && (v[h] = r);
                else if (I(b[h]) || b[h] !== d[h] || h in b && !(h in d)) v[h] = b[h]
            });
            return v
        }
        ...
        function E(b) { b = Object.prototype.toString.call(b); return "[object Array]" === b || "[object Array Iterator]" === b }

        function I(b, d) { return !!b && "object" === typeof b && (!d || !E(b)) }

        function A(b) { return I(b) && "number" === typeof b.nodeType }

        function u(b) { var d = b && b.constructor; return !(!I(b, !0) || A(b) || !d || !d.name || "Object" === d.name) }

        function n(b) { return "number" === typeof b && !isNaN(b) && Infinity > b && -Infinity < b }

        function k(b) { return "undefined" !== typeof b && null !== b }

        function e(b,
            d, h) {
            var v = w(d) && !k(h),
                r, l = function(d, h) { k(d) ? b.setAttribute(h, d) : v ? (r = b.getAttribute(h)) || "class" !== h || (r = b.getAttribute(h + "Name")) : b.removeAttribute(h) };
            w(d) ? l(h, d) : y(d, l);
            return r
        }
        ...
        function p() { for (var b = arguments, d = b.length, h = 0; h < d; h++) { var l = b[h]; if ("undefined" !== typeof l && null !== l) return l } }
        ...
        function t(b) {
            return Math.pow(10, Math.floor(Math.log(b) /
                Math.LN10))
        }

        function q(b, d) { return 1E14 < b ? b : parseFloat(b.toPrecision(d || 14)) }
        ...
        function y(b, d, h) { for (var v in b) Object.hasOwnProperty.call(b, v) && d.call(h || b[v], b[v], v, b) }
        ...
        function x(b, d, h) {
            ...
            function r(r) {
                ...
                if (b.nodeName) {
                    ...
                    y(L, function(b, d) {
                        if (r[d])
                            for (J = r[d].length; J--;) v(d, r[d][J].fn)
                    })
                }
            }
            var l = "function" === typeof b && b.prototype || b;
            if (Object.hasOwnProperty.call(l,
                    "hcEvents")) {
                var m = l.hcEvents;
                d ? (l = m[d] || [], h ? (m[d] = l.filter(function(b) { return h !== b.fn }), v(d, h)) : (r(m), m[d] = [])) : (r(m), delete l.hcEvents)
            }
        }
        ...
        function z(b, d, l, m) {
            ...
            if (h.createEvent && (b.dispatchEvent || b.fireEvent && b !== a)) {
                ...
                l.target || c(l, { preventDefault: function() { l.defaultPrevented = !0 }, target: b, type: d });
                v = [];
                for (var r = b, q = !1; r.hcEvents;) Object.hasOwnProperty.call(r,
                    "hcEvents") && r.hcEvents[d] && (v.length && (q = !0), v.unshift.apply(v, r.hcEvents[d])), r = Object.getPrototypeOf(r);
                q && v.sort(function(b, d) { return b.order - d.order });
                v.forEach(function(d) {!1 === d.fn.call(b, l) && l.preventDefault() })
            }
        ...
        var l = Array.prototype.find ? function(b, d) { return b.find(d) } : function(b, d) {
            var v, r = b.length;
            for (v = 0; v < r; v++)
                if (d(b[v], v)) return b[v]
        };
        y({ map: "map", each: "forEach", grep: "filter", reduce: "reduce", some: "some" }, function(b, d) {
            a[d] = function(v) {
                var r;
        ...
        var d, D = function() {
            var b = Math.random().toString(36).substring(2, 9) + "-",
                r = 0;
            return function() { return "highcharts-" + (d ? "" : b) + r++ }
        }();
        b.jQuery && (b.jQuery.fn.highcharts = function() {
            var b = [].slice.call(arguments);
            if (this[0]) return b[0] ? (new(a[w(b[0]) ? b.shift() : "Chart"])(this[0],
                b[0], b[1]), this) : m[e(this[0], "data-highcharts-chart")]
        });
        l = {
            addEvent: function(b, d, h, l) {
                ...
                v && v.call(b, d, h, a.supportsPassiveEvents ? { passive: void 0 === l.passive ? -1 !== d.indexOf("touch") : l.passive, capture: !1 } : !1);
                r[d] || (r[d] = []);
                r[d].push({ fn: h, order: "number" === typeof l.order ? l.order : Infinity });
                r[d].sort(function(b, d) { return b.order - d.order });
                return function() { x(b, d, h) }
            },
            arrayMax: function(b) { for (var d = b.length, v = b[0]; d--;) b[d] > v && (v = b[d]); return v },
            arrayMin: function(b) { for (var d = b.length, v = b[0]; d--;) b[d] < v && (v = b[d]); return v },
            attr: e,
            clamp: function(b, d, h) { return b > d ? b < h ? b : h : d },
            cleanRecursively: B,
            clearTimeout: function(b) { k(b) && clearTimeout(b) },
            correctFloat: q,
            ...
            discardElement: function(b) { b && b.parentElement && b.parentElement.removeChild(b) },
            erase: function(b, d) {
                for (var r = b.length; r--;)
                    if (b[r] === d) { b.splice(r, 1); break }
            },
            error: f,
            extend: c,
            ...
            getStyle: F,
            inArray: function(b, d, h) { f(32, !1, void 0, { "Highcharts.inArray": "use Array.indexOf" }); return d.indexOf(b, h) },
            isArray: E,
            isClass: u,
            isDOMElement: A,
            isFunction: function(b) { return "function" === typeof b },
            isNumber: n,
            isObject: I,
            isString: w,
            keys: function(b) {
            ...
            merge: function() {
                var b, d = arguments,
                    ...
                    l = function(b, d) {
                        "object" !== typeof b && (b = {});
                        y(d, function(r, J) { "__proto__" !== J && "constructor" !== J && (!I(r, !0) || u(r) || A(r) ? b[J] = d[J] : b[J] = l(b[J] || {}, r)) });
                        return b
                    };
            ...
            offset: function(d) {
                ...
                d = d.parentElement || d.parentNode ? d.getBoundingClientRect() : { top: 0, left: 0, width: 0, height: 0 };
                return { top: d.top + (b.pageYOffset || r.scrollTop) - (r.clientTop || 0), left: d.left + (b.pageXOffset || r.scrollLeft) - (r.clientLeft || 0), width: d.width, height: d.height }
            },
            pad: function(b, d, h) {
                return Array((d || 2) + 1 - String(b).replace("-",
                    "").length).join(h || "0") + b
            },
            pick: p,
            pInt: H,
            relativeLength: function(b, d, h) { return /%$/.test(b) ? d * parseFloat(b) / 100 + (h || 0) : parseFloat(b) },
            removeEvent: x,
            splat: function(b) { return E(b) ? b : [b] },
            stableSort: function(b, d) {
                var h = b.length,
                    r, l;
                for (l = 0; l < h; l++) b[l].safeI = l;
                b.sort(function(b, h) { r = d(b, h); return 0 === r ? b.safeI - h.safeI : r });
            ...
            uniqueKey: D,
            useSerialIds: function(b) { return d = p(b, d) },
            wrap: function(b, d, h) {
                var l = b[d];
                b[d] = function() {
                    var b = Array.prototype.slice.call(arguments),
                        d = arguments,
                        r = this;
                    r.proceed = function() { l.apply(r, arguments.length ? arguments : d) };
                    b.unshift(l);
                    b = h.apply(this, b);
                    r.proceed = null;
                    return b
    ...
    K(f, "Core/Color/Color.js", [f["Core/Globals.js"], f["Core/Utilities.js"]], function(a, f) {
        ...
        f = function() {
            ...
            f.parse = function(a) { return a ? new f(a) : f.None };
            f.prototype.init = function(a) {
                var A;
                if ("object" === typeof a && "undefined" !== typeof a.stops) this.stops = a.stops.map(function(e) { return new f(e[1]) });
            ...
            f.prototype.get = function(a) {
                ...
                if ("object" === typeof A && "undefined" !== typeof this.stops) {
                    ...
                    this.stops.forEach(function(k, e) { n.stops[e] = [n.stops[e][0], k.get(a)] });
                    return n
                }
            ...
            f.prototype.brighten = function(a) {
                var A = this.rgba;
                if (this.stops) this.stops.forEach(function(n) { n.brighten(a) });
                else if (C(a) && 0 !== a)
                    for (var u = 0; 3 > u; u++) A[u] += w(255 * a), 0 > A[u] && (A[u] = 0), 255 < A[u] && (A[u] = 255);
                return this
            };
            f.prototype.setOpacity = function(a) { this.rgba[3] = a; return this };
            ...
            f.parsers = [{ regex: /rgba\(\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9]?(?:\.[0-9]+)?)\s*\)/, parse: function(a) { return [w(a[1]), w(a[2]), w(a[3]), parseFloat(a[4], 10)] } }, { regex: /rgb\(\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*\)/, parse: function(a) { return [w(a[1]), w(a[2]), w(a[3]), 1] } }];
            f.None = new f("");
            return f
        }();
        "";
    ...
    K(f, "Core/Color/Palettes.js", [], function() { return { colors: "#7cb5ec #434348 #90ed7d #f7a35c #8085e9 #f15c80 #e4d354 #2b908f #f45b5b #91e8e1".split(" ") } });
        ...
        f = function() {
            ...
            t.prototype.timezoneOffsetFunction = function() {
                var c = this,
                    ...
                    g = e.moment || C.moment;
                if (!this.useUTC) return function(c) { return 6E4 * (new Date(c.toString())).getTimezoneOffset() };
                if (e.timezone) {
                    if (g) return function(c) { return 6E4 * -g.tz(c, e.timezone).utcOffset() };
                    w(25)
                }
                return this.useUTC &&
                    p ? function(c) { return 6E4 * p(c.valueOf()) } : function() { return 6E4 * (c.timezoneOffset || 0) }
            };
            t.prototype.dateFormat = function(c, e, p) {
                ...
                u(g, function(b, d) { for (; - 1 !== c.indexOf("%" + d);) c = c.replace("%" + d, "function" === typeof b ? b.call(q, e) : b) });
                return p ? c.substr(0, 1).toUpperCase() + c.substr(1) : c
            };
            t.prototype.resolveDTLFormat = function(c) { return I(c, !0) ? c : (c = e(c), { main: c[0], from: c[1], to: c[2] }) };
            t.prototype.getTimeTicks =
                function(e, g, p, t) {
                    ...
                    if (H(g)) {
                        ...
                        if (l >=
                            c.month) { q.set("Month", b, l >= c.year ? 0 : d * Math.floor(q.get("Month", b) / d)); var v = q.get("FullYear", b) }
                        ...
                        g = b.getTime();
                        for (b = 1; g < p;) m.push(g), g = l === c.year ? q.makeTime(v + b * d, 0) : l === c.month ? q.makeTime(v,
                            t + b * d) : !D || l !== c.day && l !== c.week ? D && l === c.hour && 1 < d ? q.makeTime(v, t, r, y + b * d) : g + l * d : q.makeTime(v, t, r + b * d * (l === c.day ? 1 : 7)), b++;
                        m.push(g);
                        l <= c.hour && 1E4 > m.length && m.forEach(function(b) { 0 === b % 18E5 && "000000000" === q.dateFormat("%H%M%S%L", b) && (h[b] = "day") })
                    }
                    m.info = E(e, { higherRanks: h, totalRange: l * d });
                    return m
                };
            t.prototype.getDateFormat = function(e, g, p, t) {
                var q = this.dateFormat("%m-%d %H:%M:%S.%L", g),
                    ...
                    h = "millisecond";
                for (b in c) {
                    if (e === c.week && +this.dateFormat("%w",
                            g) === p && "00:00:00.000" === q.substr(6)) { var b = "week"; break }
                    if (c[b] > e) { b = h; break }
    ...
    K(f, "Core/DefaultOptions.js", [f["Core/Chart/ChartDefaults.js"], f["Core/Color/Color.js"], f["Core/Globals.js"], f["Core/Color/Palettes.js"], f["Core/Time.js"], f["Core/Utilities.js"]], function(a, f, B, H, w, E) {
        ...
        a = {
            defaultOptions: A,
            defaultTime: u,
            getOptions: function() { return A },
            setOptions: function(n) { C(!0, A, n); if (n.time || n.global) B.time ? B.time.update(C(A.global, A.time, n.global, n.time)) : B.time = u; return A }
        };
        "";
        return a
    });
    K(f, "Core/Animation/Fx.js", [f["Core/Color/Color.js"], f["Core/Globals.js"], f["Core/Utilities.js"]], function(a, f, B) {
        ...
        return function() {
            ...
            a.prototype.run = function(u, n, k) {
                var e = this,
                    c = e.options,
                    p = function(c) { return p.stopped ? !1 : e.step(c) },
                    g = w.requestAnimationFrame || function(c) { setTimeout(c, 13) },
                    t = function() {
            ...
            a.prototype.initPath = function(a, n, k) {
                ...
                function c(c, m) {
                    for (; c.length < x;)
                        if (m = c[Math.floor(c.length / q) - 1].slice(), "C" === m[0] && (m[1] = m[5], m[2] = m[6]), t) {
                ...
                if (p && g && g.length) {
                    for (a = 0; a < p.length; a++)
                        if (p[a] === g[0]) { var F = a; break } else if (p[0] ===
                        g[g.length - p.length + a]) { F = a; var y = !0; break } else if (p[p.length - 1] === g[g.length - p.length + a]) { F = p.length - a; break }
            ...
            a.prototype.fillSetter = function() { a.prototype.strokeSetter.apply(this, arguments) };
            a.prototype.strokeSetter = function() { this.elem.attr(this.prop, C(this.start).tweenTo(C(this.end), this.pos), void 0, !0) };
            a.timers = [];
            return a
        }()
    });
    K(f, "Core/Animation/AnimationUtilities.js", [f["Core/Animation/Fx.js"],
        f["Core/Utilities.js"]
    ], function(a, f) {
        function C(c) { return u(c) ? n({ duration: 500, defer: 0 }, c) : { duration: c ? 500 : 0, defer: 0 } }

        function H(c, e) { for (var g = a.timers.length; g--;) a.timers[g].elem !== c || e && e !== a.timers[g].prop || (a.timers[g].stopped = !0) }
        var w = f.defined,
            E = f.getStyle,
            I = f.isArray,
            A = f.isNumber,
        ...
        return {
            animate: function(c, e, g) {
                ...
                g.easing = "function" ===
                    typeof g.easing ? g.easing : Math[g.easing] || Math.easeInOutSine;
                g.curAnim = n(e);
                k(e, function(t, m) {
                    H(c, m);
                    y = new a(c, g, m);
            ...
            getDeferredAnimation: function(c, e, g) {
                ...
                (g ? [g] : c.series).forEach(function(c) {
                    ...
                    q = e && w(e.defer) ? p.defer :
                        Math.max(q, c.duration + c.defer);
                    k = Math.min(p.duration, c.duration)
                });
                c.renderer.forExport && (q = 0);
                return { defer: Math.max(0, q - k), duration: Math.min(q, k) }
            },
            setAnimation: function(c, p) { p.renderer.globalAnimation = e(c, p.options.chart.animation, !0) },
            stop: H
        }
    });
    K(f, "Core/Renderer/HTML/AST.js", [f["Core/Globals.js"], f["Core/Utilities.js"]], function(a, f) {
        var C = a.SVG_NS,
            ...
            n = f.objectEach,
            k = f.splat,
            e = (f = a.win.trustedTypes) && A(f.createPolicy) && f.createPolicy("highcharts", { createHTML: function(c) { return c } }),
            c = e ? e.createHTML("") : "";
        try { var p = !!(new DOMParser).parseFromString(c, "text/html") } catch (g) { p = !1 }
        A = function() {
            function g(c) { this.nodes = "string" === typeof c ? this.parseMarkup(c) : c }
            g.filterUserAttributes = function(c) {
                n(c, function(e, p) {
                    var q = !0; - 1 === g.allowedAttributes.indexOf(p) && (q = !1); - 1 !== ["background", "dynsrc", "href", "lowsrc", "src"].indexOf(p) && (q = u(e) && g.allowedReferences.some(function(c) { return 0 === e.indexOf(c) }));
                    q || (I(33, !1, void 0, {
            ...
            g.parseStyle = function(c) {
                return c.split(";").reduce(function(c, e) {
                    ...
                    var g = e.shift();
                    g && e.length && (c[g.replace(/-([a-z])/g, function(c) { return c[1].toUpperCase() })] = e.join(":"));
                    return c
                }, {})
            };
                ...
                function e(c, p) {
                    ...
                    k(c).forEach(function(c) {
                        ...
                        if (m)
                            ...
                            var d = c.attributes || {};
                            n(c, function(b, c) { "tagName" !== c && "attributes" !== c && "children" !== c && "style" !== c && "textContent" !== c && (d[c] = b) });
                            H(m, b ? d : g.filterUserAttributes(d));
                            c.style && E(m, c.style);
                            h && m.appendChild(h);
                            e(c.children || [], m);
                            l = m
                        } else I(33, !1, void 0, { "Invalid tagName in config": m });
                        l && p.appendChild(l);
                        q = l
                    });
                    return q
            ...
            g.prototype.parseMarkup =
                function(c) {
                    ...
                    if (p) c = (new DOMParser).parseFromString(e ? e.createHTML(c) : c, "text/html");
                    else {
                        var k = w("div");
                        k.innerHTML = c;
                        c = { body: k }
                    ...
                    var t = function(c, e) {
                        ...
                        if (m = c.attributes) {
                            var b = {};
                            [].forEach.call(m, function(d) { "data-style" === d.name ? h.style = g.parseStyle(d.value) : b[d.name] = d.value });
                            h.attributes = b
                        }
                    ...
                    [].forEach.call(c.body.childNodes, function(c) { return t(c, q) });
                    return q
                };
    ...
    K(f, "Core/FormatUtilities.js", [f["Core/DefaultOptions.js"], f["Core/Utilities.js"]], function(a, f) {
        ...
        var H = a.defaultOptions,
            ...
            u = f.pInt;
        return {
            dateFormat: function(a, k, e) { return w.dateFormat(a, k, e) },
    ...
    K(f, "Core/Renderer/RendererUtilities.js", [f["Core/Utilities.js"]],
        function(a) {
            var f = a.clamp,
                B = a.pick,
                H = a.stableSort,
            ...
            (function(a) {
                function C(a, u, n) {
                    var k = a,
                        e = k.reducedLen || u,
                        c = function(c, e) { return (e.rank || 0) - (c.rank || 0) },
                        p = function(c, e) { return c.target - e.target },
                        g, t = !0,
                        q = [],
                        F = 0;
                    ...
                    H(a, p);
                    for (a = a.map(function(c) { return { size: c.size, targets: [c.target], align: B(c.align, .5) } }); t;) {
                        for (g = a.length; g--;) e = a[g], c = (Math.min.apply(0, e.targets) + Math.max.apply(0, e.targets)) /
                            2, e.pos = f(c - e.size * e.align, 0, u - e.size);
                        g = a.length;
                    ...
                    a.some(function(c) {
                        ...
                        return (c.targets || []).some(function() {
                            k[g].pos = c.pos + e;
                            if ("undefined" !== typeof n && Math.abs(k[g].pos - k[g].target) > n) return k.slice(0, g + 1).forEach(function(c) { return delete c.pos }), k.reducedLen =
                                (k.reducedLen || u) - .1 * u, k.reducedLen > .1 * u && C(k, u, n), !0;
                            e += k[g].size;
                            g++;
                            return !1
                        })
    ...
    K(f, "Core/Renderer/SVG/SVGElement.js", [f["Core/Animation/AnimationUtilities.js"], f["Core/Renderer/HTML/AST.js"], f["Core/Color/Color.js"], f["Core/Globals.js"], f["Core/Utilities.js"]], function(a, f, B, H, w) {
        ...
        a = function() {
            ...
            a.prototype._defaultSetter = function(b, d, c) { c.setAttribute(d, b) };
            ...
            a.prototype.addClass = function(b, d) {
                var c = d ? "" : this.attr("class") ||
                    "";
                b = (b || "").split(/ /g).reduce(function(b, d) {-1 === c.indexOf(d) && b.push(d); return b }, c ? [c] : []).join(" ");
                b !== c && this.attr("class", b);
                return this
            };
            a.prototype.afterSetters = function() { this.doTransform && (this.updateTransform(), this.doTransform = !1) };
            a.prototype.align = function(b, c, J) {
                var h = {},
                    l = this.renderer,
                    e = l.alignedObjects,
                    m, a, G;
                if (b) { if (this.alignOptions = b, this.alignByTranslate = c, !J || d(J)) this.alignTo = m = J || "renderer", x(e, this), e.push(this), J = void 0 } else b = this.alignOptions, c = this.alignByTranslate,
                    m = this.alignTo;
            ...
            a.prototype.animate = function(b, d, c) {
                ...
                0 !== h.duration ? (c && (h.complete = c), P(function() { J.element && C(J, b, h) }, d)) : (this.attr(b, void 0, c || h.complete), v(b, function(b, d) { h.step && h.step.call(this, b, { prop: d, pos: 1, elem: this }) }, this));
                return this
            };
            a.prototype.applyTextOutline = function(b) {
                ...
                if ((J = J[0]) && "none" !== J && H.svg) {
                    ...
                    J = J.replace(/(^[\d\.]+)(.*?)$/g, function(b, d, c) { return 2 * Number(d) + c });
                    this.removeTextOutline();
                    var h = n.createElementNS(c, "tspan");
                    t(h, { "class": "highcharts-text-outline", fill: b, stroke: b, "stroke-width": J, "stroke-linejoin": "round" });
                    [].forEach.call(d.childNodes, function(b) {
                        var d = b.cloneNode(!0);
                        d.removeAttribute && ["fill", "stroke", "stroke-width", "stroke"].forEach(function(b) { return d.removeAttribute(b) });
                        h.appendChild(d)
                    });
            ...
            a.prototype.attr = function(b, d, c, h) {
                ...
                "string" === typeof b ? L = (this[b + "Getter"] ||
                    this._defaultGetter).call(this, b, J) : (v(b, function(d, c) {
                    G = !1;
                    h || A(this, c);
            ...
            a.prototype.complexColor = function(b, d, c) {
                var J = this.renderer,
                    l, r, e, a, G, g, p, q, k, t, x = [],
                    z;
                m(this.renderer, "complexColor", { args: arguments }, function() {
                    b.radialGradient ? r = "radialGradient" :
                    ...
                    if (r) {
                        ...
                        g = b.stops;
                        k = c.radialReference;
                        h(e) && (b[r] = e = { x1: e[0], y1: e[1], x2: e[2], y2: e[3], gradientUnits: "userSpaceOnUse" });
                        "radialGradient" === r && k && !y(e.gradientUnits) && (a = e, e = D(e, J.getRadialAttr(k, a), { gradientUnits: "userSpaceOnUse" }));
                        v(e, function(b, d) { "id" !== d && x.push(d, b) });
                        v(g, function(b) { x.push(b) });
                        x = x.join(",");
                        if (G[x]) t = G[x].attr("id");
                        else {
                            e.id = t = S();
                            ...
                            g.forEach(function(b) {
                                0 ===
                                    b[1].indexOf("rgba") ? (l = B.parse(b[1]), p = l.get("rgb"), q = l.get("a")) : (p = b[1], q = 1);
                                b = J.createElement("stop").attr({ offset: b[0], "stop-color": p, "stop-opacity": q }).add(L);
                                L.stops.push(b)
                            })
                        }
                        z = "url(" + J.url + "#" + t + ")";
            ...
            a.prototype.css = function(b) {
                ...
                d && v(b, function(b, J) { d && d[J] !== b && (c[J] = b, l = !0) });
                if (l) {
                    d && (b = z(d, c));
                    if (null === b.width || "auto" === b.width) delete this.textWidth;
                    else if ("text" === h.nodeName.toLowerCase() && b.width) var r = this.textWidth = O(b.width);
                    this.styles = b;
                    r && !e && this.renderer.forExport && delete b.width;
                    var m = D(b);
                    h.namespaceURI === this.SVG_NS && ["textOutline", "textOverflow", "width"].forEach(function(b) { return m && delete m[b] });
                    F(h, m);
            ...
            a.prototype.destroy = function() {
                var b = this,
                    ...
                    h = d.ownerSVGElement,
                    l = c.isSVG &&
                    "SPAN" === d.nodeName && b.parentGroup || void 0;
                d.onclick = d.onmouseout = d.onmouseover = d.onmousemove = d.point = null;
                A(b);
                if (b.clipPath && h) {
                    var r = b.clipPath;
                    [].forEach.call(h.querySelectorAll("[clip-path],[CLIP-PATH]"), function(b) {-1 < b.getAttribute("clip-path").indexOf(r.element.id) && b.removeAttribute("clip-path") });
                ...
                b.safeRemoveChild(d);
                for (c.styledMode || b.destroyShadows(); l && l.div && 0 === l.div.childNodes.length;) d =
                    l.parentGroup, b.safeRemoveChild(l.div), delete l.div, l = d;
            ...
            a.prototype.destroyShadows = function() {
                (this.shadows || []).forEach(function(b) { this.safeRemoveChild(b) }, this);
                this.shadows = void 0
            };
            a.prototype.destroyTextPath = function(b, d) {
                ...
                if (c) {
                    if (c.removeAttribute("dx"), c.removeAttribute("dy"), d.element.setAttribute("id", ""), this.textPathWrapper &&
                        c.getElementsByTagName("textPath").length) {
            ...
            a.prototype.fadeOut = function(b) {
                var d = this;
                d.animate({ opacity: 0 }, { duration: r(b, 150), complete: function() { d.attr({ y: -9999 }).hide() } })
            };
            a.prototype.fillSetter = function(b, d, c) { "string" === typeof b ? c.setAttribute(d, b) : b && this.complexColor(b, d, c) };
            a.prototype.getBBox = function(d, c) {
                ...
                var q = e.styledMode ? l && a.prototype.getStyle.call(l, "font-size") : m && m.fontSize,
                    D;
                if (y(v)) {
                    var k = v.toString(); - 1 === k.indexOf("<") && (k = k.replace(/[0-9]/g, "0"));
                ...
                if (!D) {
                    if (p || e.forExport) {
                        ...
                        if (!D || 0 > D.width) D = { x: 0, y: 0, width: 0, height: 0 }
                    } else D = this.htmlGetBBox();
                    if (e.isSVG && (e = D.width, d = D.height, p && (D.height = d = { "11px,17": 14, "13px,20": 16 }[(q || "") + "," + Math.round(d)] || d), c)) {
                        p = Number(l.getAttribute("y") || 0) - D.y;
                        h = { right: 1, center: .5 }[h || 0] || 0;
                        m = c * u;
                        q = (c - 90) * u;
                        var x = e * Math.cos(m);
                        c = e * Math.sin(m);
            ...
            a.prototype.getStyle = function(b) { return p.getComputedStyle(this.element || this, "").getPropertyValue(b) };
            a.prototype.hasClass = function(b) { return -1 !== ("" + this.attr("class")).split(" ").indexOf(b) };
            a.prototype.hide = function() { return this.attr({ visibility: "hidden" }) };
            a.prototype.htmlGetBBox = function() { return { height: 0, width: 0, x: 0, y: 0 } };
            a.prototype.init =
                function(b, d) {
            ...
            a.prototype.removeClass = function(b) {
                return this.attr("class", ("" + this.attr("class")).replace(d(b) ?
            ...
            a.prototype.setTextPath = function(b, d) {
                var c = this.element,
                    ...
                    a = !m;
                d = D(!0, { enabled: !0, attributes: { dy: -5, startOffset: "50%", textAnchor: "middle" } }, d);
                ...
                if (b && d && d.enabled) {
                    ...
                    m || (this.textPathWrapper = m = this.renderer.createElement("textPath"),
                        e = !0);
                    var g = m.element;
                    (d = b.element.getAttribute("id")) || b.element.setAttribute("id", d = S());
                    if (a)
                        for (h.setAttribute("y", 0), l(G.dx) && h.setAttribute("x", -G.dx), b = [].slice.call(h.childNodes), a = 0; a < b.length; a++) {
                            var q = b[a];
                    ...
                    v(G, function(b, d) { g.setAttribute(r[d] || d, b) });
            ...
            a.prototype.shadow = function(b, d, c) {
                var h = [],
                    ...
                    r = { color: "#000000", offsetX: this.parentInverted ? -1 : 1, offsetY: this.parentInverted ? -1 : 1, opacity: .15, width: 3 },
                    e = !1,
                    G;
                !0 === b ? G = r : "object" === typeof b && (G = z(r, b));
                G && (G && J && v(G, function(b, d) { b !== J[d] && (e = !0) }), e && this.destroyShadows(), this.oldShadowOptions = G);
                if (!G) this.destroyShadows();
                    ...
                    for (r = 1; r <= G.width; r++) {
                        ...
                        t(g, { stroke: b.color || "#000000", "stroke-opacity": m * r, "stroke-width": p, transform: a, fill: "none" });
            ...
            a.prototype.show = function(b) { void 0 === b && (b = !0); return this.attr({ visibility: b ? "inherit" : "visible" }) };
            a.prototype.strokeSetter = function(b,
                d, c) {
                this[d] = b;
            ...
            a.prototype.strokeWidth = function() {
                ...
                var b = this.getStyle("stroke-width"),
                    d = 0;
                if (b.indexOf("px") === b.length - 2) d = O(b);
                else if ("" !== b) {
                    var h = n.createElementNS(c, "rect");
                    t(h, { width: b, "stroke-width": 0 });
            ...
            a.prototype.symbolAttr = function(b) {
                var d = this;
                "x y r start end width height innerR anchorX anchorY clockwise".split(" ").forEach(function(c) { d[c] = r(b[c], d[c]) });
            ...
            a.prototype.updateShadows = function(b, d, c) {
                var h = this.shadows;
                if (h)
                    for (var l = h.length; l--;) c.call(h[l], "height" === b ? Math.max(d - (h[l].cutHeight || 0), 0) : "d" === b ? this.d : d, b, h[l])
            };
            a.prototype.updateTransform = function() {
                ...
                c ? m.push("rotate(90) scale(-1,1)") :
                    h && m.push("rotate(" + h + " " + r(this.rotationOriginX, e.getAttribute("x"), 0) + " " + r(this.rotationOriginY, e.getAttribute("y") || 0) + ")");
            ...
            a.prototype.xGetter = function(b) { "circle" === this.element.nodeName && ("x" === b ? b = "cx" : "y" === b && (b = "cy")); return this._defaultGetter(b) };
            a.prototype.zIndexSetter =
                function(b, d) {
                    var c = this.renderer,
                        h = this.parentGroup,
                        l = (h || c).element || c.box,
                    ...
                    if (m) {
                        ...
                        for (G = d.length - 1; 0 <= G && !e; G--) {
                            ...
                            var a = !y(m);
                            if (h !== r)
                                if (0 > b && a && !c && !G) l.insertBefore(r, d[G]), e = !0;
                                else if (O(m) <= b || a && (!y(b) || 0 <= b)) l.insertBefore(r,
                                d[G + 1] || null), e = !0
                        }
    ...
    K(f, "Core/Renderer/RendererRegistry.js", [f["Core/Globals.js"]], function(a) {
        ...
        (function(f) {
            f.rendererTypes = {};
            var C;
            f.getRendererType = function(a) { void 0 === a && (a = C); return f.rendererTypes[a] || f.rendererTypes[C] };
            f.registerRendererType = function(w, B, I) { f.rendererTypes[w] = B; if (!C || I) C = w, a.Renderer = B }
        })(f || (f = {}));
        return f
    });
    K(f, "Core/Renderer/SVG/SVGLabel.js", [f["Core/Renderer/SVG/SVGElement.js"], f["Core/Utilities.js"]], function(a, f) {
        var C = this && this.__extends || function() {
                var a = function(k, e) {
                    ...
                    instanceof Array && function(c, e) { c.__proto__ = e } || function(c, e) { for (var a in e) e.hasOwnProperty(a) && (c[a] = e[a]) };
                    return a(k, e)
                };
                return function(k, e) {
                    function c() { this.constructor = k }
                    a(k, e);
        ...
        return function(n) {
            ...
            k.prototype.alignSetter = function(e) {
                ...
                e !== this.alignFactor && (this.alignFactor = e, this.bBox && E(this.xSetting) && this.attr({ x: this.xSetting }))
            };
            ...
            k.prototype.boxAttr = function(e, c) { this.box ? this.box.attr(e, c) : this.deferredAttr[e] = c };
            ...
            k.prototype.getCrispAdjust = function() { return this.renderer.styledMode && this.box ? this.box.strokeWidth() % 2 / 2 : (this["stroke-width"] ? parseInt(this["stroke-width"], 10) : 0) % 2 / 2 };
            k.prototype.heightSetter = function(e) { this.heightSetting = e };
            ...
            k.prototype.paddingSetter = function(e, c) { E(e) ? e !== this[c] && (this[c] = e, this.updateTextPadding()) : this[c] = void 0 };
            k.prototype.rSetter = function(e, c) { this.boxAttr(c, e) };
            k.prototype.shadow = function(e) { e && !this.renderer.styledMode && (this.updateBoxSize(), this.box && this.box.shadow(e)); return this };
            ...
            k.prototype["text-alignSetter"] = function(e) { this.textAlign = e };
            ...
            k.prototype.updateBoxSize = function() {
                ...
                this.height =
                    (this.heightSetting || g.height || 0) + 2 * a;
                ...
                this.needsBox && (this.box || (a = this.box = this.symbolKey ? this.renderer.symbol(this.symbolKey) : this.renderer.rect(), a.addClass(("button" === this.className ? "" : "highcharts-label-box") + (this.className ? " highcharts-" + this.className + "-box" : "")), a.add(this)), a = this.getCrispAdjust(),
                    c.x = a, c.y = (this.baseline ? -this.baselineOffset : 0) + a, c.width = Math.round(this.width), c.height = Math.round(this.height), this.box.attr(w(c, this.deferredAttr)), this.deferredAttr = {})
            };
            k.prototype.updateTextPadding = function() {
                ...
                H(this.widthSetting) && this.bBox && ("center" === this.textAlign || "right" === this.textAlign) && (a += { center: .5, right: 1 }[this.textAlign] * (this.widthSetting - this.bBox.width));
                if (a !==
                    e.x || c !== e.y) e.attr("x", a), e.hasBoxWidthChanged && (this.bBox = e.getBBox(!0)), "undefined" !== typeof c && e.attr("y", c);
                e.x = a;
                e.y = c
            };
            k.prototype.widthSetter = function(e) { this.widthSetting = E(e) ? e : void 0 };
    ...
    K(f, "Core/Renderer/SVG/Symbols.js", [f["Core/Utilities.js"]], function(a) {
        ...
        function H(a, f, n, k,
            ...
            return [
                ["M", a + e, f],
                ["L", a + n - e, f],
                ["C", a + n, f, a + n, f, a + n, f + e],
                ["L", a + n, f + k - e],
                ["C", a + n, f + k, a + n, f + k, a + n - e, f + k],
                ["L", a + e, f + k],
                ["C", a, f + k, a, f + k, a, f + k - e],
                ["L", a, f + e],
                ["C", a, f, a, f, a + e, f]
            ]
        }
        ...
        return {
            ...
            callout: function(a, f, n, k, e) {
                ...
                var t = H(a, f, n, k, { r: c });
                if (!E(g)) return t;
                a + g >= n ? e > f + p && e < f + k - p ? t.splice(3, 1, ["L", a + n, e - 6], ["L", a + n + 6, e], ["L", a + n, e + 6], ["L", a + n, f + k - c]) : t.splice(3, 1, ["L", a + n, k /
                    2
                ], ["L", g, e], ["L", a + n, k / 2], ["L", a + n, f + k - c]) : 0 >= a + g ? e > f + p && e < f + k - p ? t.splice(7, 1, ["L", a, e + 6], ["L", a - 6, e], ["L", a, e - 6], ["L", a, f + c]) : t.splice(7, 1, ["L", a, k / 2], ["L", g, e], ["L", a, k / 2], ["L", a, f + c]) : e && e > k && g > a + p && g < a + n - p ? t.splice(5, 1, ["L", g + 6, f + k], ["L", g, f + k + 6], ["L", g - 6, f + k], ["L", a + c, f + k]) : e && 0 > e && g > a + p && g < a + n - p && t.splice(1, 1, ["L", g - 6, f], ["L", g, f - 6], ["L", g + 6, f], ["L", n - c, f]);
                return t
            },
            circle: function(a, u, n, k) { return f(a + n / 2, u + k / 2, n / 2, k / 2, { start: .5 * Math.PI, end: 2.5 * Math.PI, open: !1 }) },
    ...
    K(f, "Core/Renderer/SVG/TextBuilder.js", [f["Core/Renderer/HTML/AST.js"], f["Core/Globals.js"], f["Core/Utilities.js"]], function(a, f, B) {
        ...
        return function() {
            ...
            e.prototype.buildSVG = function() {
                ...
                var y = /<br.*?>/g,
                    x = [t, this.ellipsis, this.noWrap, this.textLineHeight,
            ...
            e.prototype.modifyDOM = function() {
                ...
                for (var k; k = a.element.firstChild;)
                    ...
                    g.nextSibling && g.previousSibling && (0 === q && 1 === g.previousSibling.nodeType && (a.firstLineMetrics = a.renderer.fontMetrics(void 0,
                        g.previousSibling)), I(g, { dy: c.getLineHeight(g.nextSibling), x: e }))
                });
                var q = this.width || 0;
                if (q) {
                    var f = function(g, k) {
                            var m = g.textContent || "",
                                ...
                                d = 0,
                                D = a.actualWidth;
                            if (c.ellipsis) m && c.truncate(g, m, void 0, 0, Math.max(0, q - parseInt(c.fontSize || 12, 10)), function(b, d) { return b.substring(0, d) + "\u2026" });
                            else if (b) {
                                m = [];
                                for (b = []; k.firstChild && k.firstChild !== g;) b.push(k.firstChild), k.removeChild(k.firstChild);
                                for (; h.length;) h.length && !c.noWrap && 0 < d && (m.push(g.textContent || ""), g.textContent = h.join(" ").replace(/- /g, "-")), c.truncate(g, void 0, h, 0 === d ? D || 0 : 0, q, function(b, d) { return h.slice(0, d).join(" ").replace(/- /g, "-") }), D = a.actualWidth, d++;
                                b.forEach(function(b) { k.insertBefore(b, g) });
                        ...
                        y = function(c) {
                            [].slice.call(c.childNodes).forEach(function(e) {
                                e.nodeType ===
                                    E.Node.TEXT_NODE ? f(e, c) : (-1 !== e.className.baseVal.indexOf("highcharts-br") && (a.actualWidth = 0), y(e))
                            })
                        };
                    y(a.element)
                }
            ...
            e.prototype.modifyTree = function(c) {
                var a =
                    ...
                    e = function(g, q) {
                        ...
                        if ("b" === f || "strong" === f) m ? k["class"] = "highcharts-strong" : t.fontWeight = "bold";
                        else if ("i" === f || "em" === f) m ? k["class"] = "highcharts-emphasized" : t.fontStyle = "italic";
                        ...
                        A(g, { attributes: k, style: t });
                        p && p.filter(function(c) { return "#text" !== c.tagName }).forEach(e)
                    };
                c.forEach(e)
            };
                ...
                var g = this.svgElement,
                    ...
                    d, D = function(b, d) {
                        ...
                        if (h && "undefined" === typeof m[d])
                            if (h.getSubStringLength) try { m[d] = k + h.getSubStringLength(0, e ? d + 1 : d) } catch (S) { "" } else p.getSpanWidth &&
                                (c.textContent = f(a || e, b), m[d] = k + p.getSpanWidth(g, c));
                        return m[d]
                    };
                g.rotation = 0;
            ...
            e.prototype.unescapeEntities = function(c, a) { n(this.renderer.escapes, function(e, k) { a && -1 !== a.indexOf(e) || (c = c.toString().replace(new RegExp(e, "g"), k)) }); return c };
            return e
        }()
    });
    K(f, "Core/Renderer/SVG/SVGRenderer.js", [f["Core/Renderer/HTML/AST.js"], f["Core/Color/Color.js"], f["Core/Globals.js"], f["Core/Renderer/RendererRegistry.js"], f["Core/Renderer/SVG/SVGElement.js"], f["Core/Renderer/SVG/SVGLabel.js"], f["Core/Renderer/SVG/Symbols.js"], f["Core/Renderer/SVG/TextBuilder.js"], f["Core/Utilities.js"]], function(a, f, B, H, w, E, I, A, u) {
        ...
        B = function() {
            ...
            J.prototype.init = function(b, d, a, l, r, m, J) {
                ...
                b.appendChild(L);
                z(b, "dir", "ltr"); - 1 === b.innerHTML.indexOf("xmlns") && z(L, "xmlns", this.SVG_NS);
                this.isSVG = !0;
                this.box = L;
                this.boxWrapper = G;
                this.alignedObjects = [];
                ...
                c && b.getBoundingClientRect && (d = function() {
                    ...
                    h(b, { left: Math.ceil(g.left) - g.left + "px", top: Math.ceil(g.top) - g.top + "px" })
                }, d(), this.unSubPixelFix = x(y, "resize", d))
            };
            J.prototype.definition = function(b) { return (new a([b])).addToDOM(this.defs.element) };
                ...
                if ((c || g) && e.getElementsByTagName("base").length) {
                    if (!b(X)) {
                        ...
                        d = (new a([{
                            ...
                            }, { tagName: "rect", attributes: { id: "hitme", width: 8, height: 8, "clip-path": "url(#" + d + ")", fill: "rgba(0,0,0,0.001)" } }]
                        }])).addToDOM(e.body);
                        h(d, { position: "fixed", top: 0, left: 0, zIndex: 9E5 });
            ...
            J.prototype.getStyle =
                function(b) { return this.style = d({ fontFamily: '"Lucida Grande", "Lucida Sans Unicode", Arial, Helvetica, sans-serif', fontSize: "12px" }, b) };
            J.prototype.setStyle = function(b) { this.boxWrapper.css(this.getStyle(b)) };
            J.prototype.isHidden = function() { return !this.boxWrapper.getBBox().width };
            ...
            J.prototype.getRadialAttr = function(b, d) { return { cx: b[0] - b[2] / 2 + (d.cx || 0) * b[2], cy: b[1] - b[2] / 2 + (d.cy || 0) * b[2], r: (d.r || 0) * b[2] } };
            ...
            J.prototype.button = function(b, c, h, l, e, m, J, g, v, q) {
                ...
                var L = 0,
                    k = e ? P(e) : {},
                    f = P({ color: "#333333", cursor: "pointer", fontWeight: "normal" }, k.style);
                delete k.style;
                k = a.filterUserAttributes(k);
                G.attr(P({ padding: 8, r: 2 }, k));
                if (!D) {
                    k = P({ fill: "#f7f7f7", stroke: "#cccccc", "stroke-width": 1 }, k);
                    m = P(k, { fill: "#e6e6e6" }, a.filterUserAttributes(m || b.hover || {}));
                    var t = m.style;
                    delete m.style;
                    J = P(k, { fill: "#e6ebf5", style: { color: "#000000", fontWeight: "bold" } }, a.filterUserAttributes(J || b.select || {}));
                    var M = J.style;
                    delete J.style;
                    g = P(k, { style: { color: "#cccccc" } }, a.filterUserAttributes(g || b.disabled || {}));
                    var y = g.style;
                    delete g.style
                }
                x(G.element, p ? "mouseover" : "mouseenter", function() { 3 !== L && G.setState(1) });
                x(G.element, p ? "mouseout" : "mouseleave", function() { 3 !== L && G.setState(L) });
                ...
                D ||
                    G.attr(k).css(d({ cursor: "default" }, f));
                return G.on("touchstart", function(b) { return b.stopPropagation() }).on("click", function(b) { 3 !== L && l.call(G, b) })
            };
            ...
            J.prototype.circle =
                function(b, d, c) {
                    b = r(b) ? b : "undefined" === typeof b ? {} : { x: b, y: d, r: c };
                    d = this.createElement("circle");
                    d.xSetter = d.ySetter = function(b, d, c) { c.setAttribute("c" + d, b) };
                    return d.attr(b)
                };
            J.prototype.arc = function(b, d, c, a, h, e) {
                r(b) ? (a = b, d = a.y, c = a.r, b = a.x) : a = { innerR: a, start: h, end: e };
            ...
            J.prototype.rect = function(b, d, c, a, h, e) {
                ...
                b = r(b) ? b : "undefined" === typeof b ? {} : { x: b, y: d, width: Math.max(c, 0), height: Math.max(a, 0) };
                this.styledMode ||
                    ("undefined" !== typeof e && (b["stroke-width"] = e, b = l.crisp(b)), b.fill = "none");
                h && (b.r = h);
                l.rSetter = function(b, d, c) {
                    l.r = b;
                    z(c, { rx: b, ry: b })
                };
                l.rGetter = function() { return l.r || 0 };
                return l.attr(b)
            };
            J.prototype.setSize = function(b, d, c) {
                this.width = b;
                this.height = d;
                this.boxWrapper.animate({ width: b, height: d }, { step: function() { this.attr({ viewBox: "0 0 " + this.attr("width") + " " + this.attr("height") }) }, duration: S(c, !0) ? void 0 : 0 });
                this.alignElements()
            };
            ...
            J.prototype.image = function(b, d, c, a, h, e) {
                var l = { preserveAspectRatio: "none" },
                    r = function(b, d) { b.setAttributeNS ? b.setAttributeNS("http://www.w3.org/1999/xlink", "href", d) : b.setAttribute("hc-svg-href", d) };
                v(d) && (l.x = d);
                v(c) && (l.y = c);
                v(a) && (l.width = a);
                v(h) && (l.height = h);
                ...
                e ? (r(m.element, "data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw=="), c = new y.Image, x(c, "load", d), c.src = b, c.complete && d({})) :
                    r(m.element, b);
                return m
            };
            J.prototype.symbol = function(c, a, l, r, J, G) {
                ...
                if (k) {
                    ...
                    d(p, { symbolName: D || void 0, x: a, y: l, width: r, height: J });
                    G && d(p, G)
                } else if (q) {
                    var L = c.match(v)[1];
                    var t = p = this.image(L);
                    t.imgwidth = S(F[L] && F[L].width, G && G.width);
                    t.imgheight = S(F[L] && F[L].height,
                        G && G.height);
                    var y = function(b) { return b.attr({ width: b.width, height: b.height }) };
                    ["width", "height"].forEach(function(d) {
                        t[d + "Setter"] = function(d, c) {
                            var a = this["img" + c];
                            this[c] = d;
                            b(a) && (G && "within" === G.backgroundSize && this.width && this.height && (a = Math.round(a * Math.min(this.width / this.imgwidth, this.height / this.imgheight))), this.element && this.element.setAttribute(c, a), this.alignByTranslate || (d = ((this[c] || 0) - a) / 2, this.attr("width" === c ? { translateX: d } : { translateY: d })))
                        }
                    });
                    b(a) && t.attr({ x: a, y: l });
                    t.isImg = !0;
                    b(t.imgwidth) && b(t.imgheight) ? y(t) : (t.attr({ width: 0, height: 0 }), m("img", {
                        onload: function() {
                            var b = n[g.chartIndex];
                            0 === this.width && (h(this, { position: "absolute", top: "-999em" }), e.body.appendChild(this));
            ...
            J.prototype.clipRect = function(b, d, c, a) {
                var h = C() + "-",
                    l =
                    this.createElement("clipPath").attr({ id: h }).add(this.defs);
            ...
            J.prototype.text = function(d, c, a, h) {
                ...
                if (!h || this.forExport && !this.allowHTML) d.xSetter = function(b, d, c) {
                    for (var a = c.getElementsByTagName("tspan"), h = c.getAttribute(d), l = 0, e; l < a.length; l++) e = a[l], e.getAttribute(d) ===
                        h && e.setAttribute(d, b);
                    c.setAttribute(d, b)
                };
                return d
            };
            ...
            J.prototype.rotCorr = function(b, d, c) {
                ...
                return { x: -b / 3 * Math.sin(d * k), y: a }
            };
            J.prototype.pathToSegments = function(b) {
                for (var d = [], c = [], a = { A: 8, C: 7, H: 2, L: 3, M: 3, Q: 5, S: 5, T: 3, V: 2 }, h = 0; h < b.length; h++) O(c[0]) && v(b[h]) && c.length === a[c[0].toUpperCase()] && b.splice(h, 0, c[0].replace("M", "L").replace("m", "l")), "string" === typeof b[h] && (c.length && d.push(c.slice(0)), c.length = 0), c.push(b[h]);
                d.push(c.slice(0));
                return d
            };
            J.prototype.label = function(b, d, c, a, h, l, e, r, m) { return new E(this, b, d, c, a, h, l, e, r, m) };
            J.prototype.alignElements = function() { this.alignedObjects.forEach(function(b) { return b.align() }) };
            return J
        }();
        d(B.prototype, {
            Element: w,
    ...
    K(f, "Core/Renderer/HTML/HTMLElement.js", [f["Core/Globals.js"], f["Core/Renderer/SVG/SVGElement.js"], f["Core/Utilities.js"]], function(a, f, B) {
        var C = this && this.__extends || function() {
                var c = function(a, e) {
                    c = Object.setPrototypeOf || { __proto__: [] }
                    instanceof Array && function(c, a) { c.__proto__ = a } || function(c, a) { for (var e in a) a.hasOwnProperty(e) && (c[e] = a[e]) };
                    return c(a, e)
                };
                return function(a,
                    e) {
                    function g() { this.constructor = a }
                    c(a, e);
        ...
        return function(a) {
            ...
            g.prototype.htmlGetBBox =
                function() { var c = this.element; return { x: c.offsetLeft, y: c.offsetTop, width: c.offsetWidth, height: c.offsetHeight } };
            g.prototype.htmlUpdateTransform = function() {
                if (this.added) {
                    var a = this.renderer,
                        ...
                        h = { left: 0, center: .5, right: 1 }[m],
                        b = this.styles;
                    b = b && b.whiteSpace;
                    u(e, { marginLeft: g, marginTop: k });
                    !a.styledMode && this.shadows && this.shadows.forEach(function(b) { u(b, { marginLeft: g + 1, marginTop: k + 1 }) });
                    this.inverted && [].forEach.call(e.childNodes, function(b) { a.invertChild(b, e) });
                    if ("SPAN" === e.tagName) {
                        var l = this.rotation,
                        ...
                        if (d !== this.oldTextWidth) {
                            ...
                            else u(e, { width: "", whiteSpace: b || "nowrap" }), r = e.offsetWidth;
                        ...
                        u(e, { left: f + (this.xCorr || 0) + "px", top: p + (this.yCorr || 0) + "px" });
                        this.cTT = D;
                        this.oldRotation = l;
                        this.oldAlign = m
                    }
            ...
            g.prototype.setSpanRotation = function(c, a, e) {
                var g = {},
                    k = E && !/Edge/.test(A.navigator.userAgent) ? "-ms-transform" :
                    I ? "-webkit-transform" : w ? "MozTransform" : A.opera ? "-o-transform" : void 0;
    ...
    K(f, "Core/Renderer/HTML/HTMLRenderer.js", [f["Core/Renderer/HTML/AST.js"], f["Core/Renderer/SVG/SVGElement.js"], f["Core/Renderer/SVG/SVGRenderer.js"], f["Core/Utilities.js"]], function(a, f, B, H) {
        var C = this && this.__extends || function() {
            ...
            u = H.pick;
        return function(n) {
            function k() { return null !== n && n.apply(this, arguments) || this }
            C(k, n);
            k.compose = function(a) {
                -1 === k.composedClasses.indexOf(a) && (k.composedClasses.push(a), a.prototype.html =
                    k.prototype.html);
                return a
            };
            k.prototype.html = function(e, c, k) {
                ...
                g.textSetter = function(c) { c !== this.textStr && (delete this.bBox, delete this.oldTextWidth, a.setElementHTML(this.element, u(c, "")), this.textStr = c, g.doTransform = !0) };
                ...
                g.afterSetters = function() { this.doTransform && (this.htmlUpdateTransform(), this.doTransform = !1) };
                g.attr({ text: e, x: Math.round(c), y: Math.round(k) }).css({ position: "absolute" });
                q.styledMode || g.css({ fontFamily: this.style.fontFamily, fontSize: this.style.fontSize });
                        ...
                        if (!h) {
                            ...
                            e.reverse().forEach(function(b) {
                                ...
                                var d = E(b.element, "class"),
                                    m = b.styles || {};
                                h = b.div = b.div || I("div", d ? { className: d } : void 0, { position: "absolute", left: (b.translateX || 0) + "px", top: (b.translateY || 0) + "px", display: b.display, opacity: b.opacity, cursor: m.cursor, pointerEvents: m.pointerEvents, visibility: b.visibility }, h || a);
                                var v = h.style;
                                A(b, {
                                    ...
                                    on: function() { e[0].div && g.on.apply({ element: e[0].div, onEvents: b.onEvents }, arguments); return b },
                                    translateXSetter: c,
                                    translateYSetter: c
                                });
                                b.addedSetters || y(b)
    ...
    K(f, "Core/Axis/AxisDefaults.js", [], function() {
        ...
        (function(a) {
            a.defaultXAxisOptions = {
                ...
                gridZIndex: 1,
                labels: { autoRotation: void 0, autoRotationLimit: 80, distance: void 0, enabled: !0, indentation: 10, overflow: "justify", padding: 5, reserveSpace: void 0, rotation: void 0, staggerLines: 0, step: 0, useHTML: !1, x: 0, zIndex: 7, style: { color: "#666666", cursor: "default", fontSize: "11px" } },
                maxPadding: .01,
            ...
            a.defaultYAxisOptions = {
                ...
                stackLabels: {
                    ...
                    crop: !0,
                    overflow: "justify",
                    formatter: function() { var a = this.axis.chart.numberFormatter; return a(this.total, -1) },
                    style: {
                        color: "#000000",
                        fontSize: "11px",
                        fontWeight: "bold",
    ...
    K(f, "Core/Foundation.js", [f["Core/Utilities.js"]], function(a) {
        ...
        (function(a) {
            a.registerEventOptions = function(a, u) {
                ...
                H(u.events, function(n, k) { a.eventOptions[k] !== n && (a.eventOptions[k] && (w(a, k, a.eventOptions[k]), delete a.eventOptions[k]), B(n) && (a.eventOptions[k] = n, f(a, k, n))) })
            }
        })(E || (E = {}));
        return E
    });
        ...
        f = function() {
            ...
            g.prototype.addLabel = function() {
                var c = this,
                    ...
                    D = h === l[l.length - 1],
                    v =
                    (!b.step || 1 === b.step) && 1 === e.tickInterval;
                l = l.info;
                var r = c.label,
                    O;
                ...
                if (e.dateTime)
                    if (l) { var P = f.time.resolveDTLFormat(g.dateTimeLabelFormats[!g.grid && l.higherRanks[h] || l.unitName]); var S = P.main } else k(x) && (S = e.dateTime.getXDateFormat(x, g.dateTimeLabelFormats || {}));
                c.isFirst = d;
                c.isLast = D;
                var N = { axis: e, chart: f, dateTimeLabelFormat: S, isFirst: d, isLast: D, pos: h, tick: c, tickPositionInfo: l, value: x };
                ...
                c.shortenLabel = X ? function() {
                    for (O = 0; O < X.length; O++)
                        if (u(N, { dateTimeLabelFormat: X[O] }), r.attr({ text: C.call(N, N) }), r.getBBox().width < e.getSlotWidth(c) - 2 * b.padding) return;
                    r.attr({ text: "" })
                } : void 0;
                v && e._addedPlotLB && c.moveLabel(g, b);
                I(r) || c.movedLabel ? r && r.textStr !== g && !v && (!r.textWidth || b.style.width || r.styles.width || r.css({ width: null }), r.attr({ text: g }),
                    r.textPxLength = r.getBBox().width) : (c.label = r = c.createLabel({ x: 0, y: 0 }, g, b), c.rotation = 0)
            };
            ...
            g.prototype.destroy = function() { A(this, this.axis) };
            g.prototype.getPosition = function(c, a, e, g) {
                var k = this.axis,
                    f = k.chart,
                    m = g && f.oldChartHeight || f.chartHeight;
                c = {
                    x: c ? E(k.translate(a + e, null, null,
                        g) + k.transB) : k.left + k.offset + (k.opposite ? (g && f.oldChartWidth || f.chartWidth) - k.right - k.left : 0),
            ...
            g.prototype.getLabelPosition = function(c, a, e, g, k, f, m, h) {
                var b = this.axis,
                    ...
                    r = g || b.reserveSpaceDefault ? 0 : -b.labelOffset * ("center" === b.labelAlign ?
                        .5 : 1),
                    p = {},
                    q = k.y;
                ...
                p.x = c;
                p.y = Math.round(a);
                n(this, "afterGetLabelPosition", { pos: p, tickmarkOffset: f, index: m });
                return p
            };
            g.prototype.getLabelSize = function() { return this.label ? this.label.getBBox()[this.axis.horiz ? "height" : "width"] : 0 };
            g.prototype.getMarkPath =
                function(c, a, e, g, k, f) {
                    return f.crispLine([
                        ["M", c, a],
                        ["L", c + (k ? 0 : -e), a + (k ? e : 0)]
                    ], g)
            ...
            g.prototype.handleOverflow = function(c) {
                ...
                var h = this.label,
                    b = this.rotation,
                    l = { left: 0, center: .5, right: 1 }[a.labelAlign || h.attr("align")],
                    d = h.getBBox().width,
                    ...
                    n = 1,
                    t;
                if (b || "justify" !== e.overflow) 0 > b && g - l * d < m ? t = Math.round(g /
                    Math.cos(b * C) - m) : 0 < b && g + l * d > f && (t = Math.round((k - g) / Math.cos(b * C)));
                else if (k = g + (1 - l) * d, g - l * d < m ? r = c.x + r * (1 - l) - m : k > f && (r = f - c.x + r * l, n = -1), r = Math.min(D, r), r < D && "center" === a.labelAlign && (c.x += n * (D - r - l * (D - Math.min(d, r)))), d > r || a.autoRotation && (h.styles || {}).width) t = r;
            ...
            g.prototype.moveLabel = function(a, e) {
                var g = this,
                    ...
                    m = !1;
                k && k.textStr === a ?
                    (g.movedLabel = k, m = !0, delete g.label) : c(f.ticks, function(b) { m || b.isNew || b === g || !b.label || b.label.textStr !== a || (g.movedLabel = b.label, m = !0, b.labelPos = g.movedLabel.xy, delete b.label) });
                if (!m && (g.labelPos || k)) {
                    var h = g.labelPos || k.xy;
                    k = f.horiz ? p ? 0 : f.width + f.left : h.x;
                    f = f.horiz ? h.y : p ? f.width + f.left : 0;
                    g.movedLabel = g.createLabel({ x: k, y: f }, a, e);
            ...
            g.prototype.renderGridLine = function(c, a, e) {
                ...
                "minor" === this.type &&
                    (D = k.minorGridLineWidth, v = k.minorGridLineColor, r = k.minorGridLineDashStyle);
                ...
                if (d && (e = g.getPlotLinePath({ value: m + b, lineWidth: d.strokeWidth() * e, force: "pass", old: c }))) d[c || this.isNew ? "attr" : "animate"]({ d: e, opacity: a })
            };
            g.prototype.renderMark = function(c, a, e) {
                ...
                var d = this.mark,
                    D = !d;
                h && (g.opposite && (h[0] = -h[0]), d || (this.mark = d = f.path().addClass("highcharts-" + (m ? m + "-" : "") + "tick").add(g.axisGroup), g.chart.styledMode || d.attr({ stroke: k, "stroke-width": l })), d[D ? "attr" : "animate"]({ d: this.getMarkPath(b, c, h[0], d.strokeWidth() * e, g.horiz, f), opacity: a }))
            };
    ...
    K(f, "Core/Axis/Axis.js", [f["Core/Animation/AnimationUtilities.js"], f["Core/Axis/AxisDefaults.js"], f["Core/Color/Color.js"], f["Core/DefaultOptions.js"], f["Core/Foundation.js"], f["Core/Globals.js"],
        f["Core/Axis/Tick.js"], f["Core/Utilities.js"]
        ...
        var u = a.animObject,
            ...
            N = A.syncTimeout,
            C = function(b, d) {
                return D(d, void 0, void 0, r(b.options.allowDecimals,
        ...
        a = function() {
            ...
            a.prototype.init = function(d, c) {
                ...
                this.crosshair = !0 === c ? {} : c; - 1 === d.axes.indexOf(this) && (a ? d.axes.splice(d.xAxis.length, 0, this) : d.axes.push(this), d[this.coll].push(this));
                this.series =
                    this.series || [];
            ...
            a.prototype.defaultLabelFormatter =
                function(d) {
                    ...
                    var r = c.logarithmic ? Math.abs(a) : c.tickInterval,
                        m = g && g.length;
                    if (c.categories) var J = "" + this.value;
                    else if (h) J = e.dateFormat(h, a);
                    else if (m && 1E3 <= r)
                        for (; m-- && "undefined" === typeof J;) c = Math.pow(l, m + 1), r >= c && 0 === 10 * a % c && null !== g[m] && 0 !== a && (J = d(a / c, -1) + g[m]);
            ...
            a.prototype.toValue = function(b, d) { return this.translate(b - (d ? 0 : this.pos), !0, !this.horiz, null, !0) };
            a.prototype.getPlotLinePath = function(d) {
                function c(b, d, c) { if ("pass" !== n && b < d || b > c) n ? b = g(b, d, c) : P = !0; return b }
                var a = this,
                    e = a.chart,
                    h = a.left,
                    l = a.top,
                ...
                m(this, "getPlotLinePath", d, function(d) {
                    ...
                    d.path = P && !n ? null : e.renderer.crispLine([
                        ["M", t, z],
                        ["L", y, O]
                    ], f || 1)
                });
            ...
            a.prototype.getMinorTickInterval = function() { var b = this.options; return !0 === b.minorTicks ? r(b.minorTickInterval, "auto") : !1 === b.minorTicks ? null : b.minorTickInterval };
            a.prototype.getMinorTickPositions = function() {
                ...
                if (h && h / c < this.len / 3) {
                    ...
                    else if (this.dateTime && "auto" === this.getMinorTickInterval()) l = l.concat(this.getTimeTicks(this.dateTime.normalizeTimeTickInterval(c), e, a, b.startOfWeek));
                    else
                        for (b = e + (d[0] - e) % c; b <= a && b !== l[0]; b += c) l.push(b)
                }
            ...
            a.prototype.adjustForMinRange = function() {
                var b = this.options,
                    ...
                    h = 0,
                    l, g, m, k;
                this.isXAxis && "undefined" === typeof this.minRange && !d && (q(b.min) || q(b.max) || q(b.floor) || q(b.ceiling) ?
                    this.minRange = null : (this.series.forEach(function(b) {
                        m = b.xData;
                        k = b.xIncrement ? 1 : m.length - 1;
                        if (1 < m.length)
                            for (l = k; 0 < l; l--)
                                if (g = m[l] - m[l - 1], !h || g < h) h = g
            ...
            a.prototype.nameToX = function(b) {
                ...
                if (-1 === a) { if (!d && c) var e = c.length } else e = a;
            ...
            a.prototype.updateNames = function() {
                var b = this,
                    d = this.names;
                0 < d.length && (Object.keys(d.keys).forEach(function(b) { delete d.keys[b] }), d.length = 0, this.minRange = this.userMinRange, (this.series || []).forEach(function(d) {
                    d.xIncrement = null;
            ...
            a.prototype.minFromRange = function() { return this.max - this.range };
            a.prototype.setTickInterval = function(d) {
                ...
                f &&
                    q(this.dataMin) && (p = p || 0, !q(n) && this.min < p && this.dataMin >= p ? this.min = this.options.minRange ? Math.min(p, this.max - this.minRange) : p : !q(z) && this.max > p && this.dataMax <= p && (this.max = this.options.minRange ? Math.max(p, this.min + this.minRange) : p));
                ...
                this.tickInterval = this.min === this.max || "undefined" === typeof this.min || "undefined" === typeof this.max ? 1 : l && this.linkedParent &&
                    !J && g === this.linkedParent.options.tickPixelInterval ? J = this.linkedParent.tickInterval : r(J, this.tickAmount ? (this.max - this.min) / Math.max(this.tickAmount - 1, 1) : void 0, k ? 1 : (this.max - this.min) * g / Math.max(this.len, g));
                if (h && !d) {
                ...
                d = r(e.minTickInterval, this.dateTime && !this.series.some(function(b) { return b.noSharedTooltip }) ? this.closestPointRange : 0);
            ...
            a.prototype.setTickPositions = function() {
                ...
                if (!c) {
                    if (this.ordinal && this.ordinal.positions || !((this.max -
                            this.min) / this.tickInterval > Math.max(2 * this.len, 200)))
                        ...
                        for (var l = b = this.tickInterval; l <= 2 * b;)
                            if (c = this.getLinearTickPositions(this.tickInterval, this.min, this.max), this.tickAmount && c.length > this.tickAmount) this.tickInterval =
                                C(this, l *= 1.1);
                            else break;
                ...
                this.isLinked || (this.single && 2 > c.length && !this.categories && !this.series.some(function(b) { return b.is("heatmap") && "between" === b.options.pointPlacement }) && (this.min -= .5, this.max += .5), d || e || this.adjustTickAmount());
            ...
            a.prototype.alignToOthers = function() {
                var d = this,
                    ...
                    h = [],
                    l;
                d.thresholdAlignment =
                    void 0;
                if ((!1 !== this.chart.options.chart.alignTicks && a.alignTicks || e) && !1 !== a.startOnTick && !1 !== a.endOnTick && !d.logarithmic) {
                    var g = function(b) { var d = b.options; return [b.horiz ? d.left : d.top, d.width, d.height, d.pane].join() },
                        m = g(this);
                    this.chart[this.coll].forEach(function(b) {
                        var a = b.series;
                        a.length && a.some(function(b) { return b.visible }) && b !== d && g(b) === m && (l = !0, c.push(b))
                    })
                }
                if (l && e) {
                    ...
                    var r = 1 < h.length ? h.reduce(function(b, d) { return b + d },
                        0) / h.length : void 0;
                    c.forEach(function(b) { b.thresholdAlignment = r })
                }
                return l
            };
            a.prototype.getThresholdAlignment = function(d) {
                (!b(this.dataMin) || this !== d && this.series.some(function(b) { return b.isDirty || b.isDirtyData })) && this.getSeriesExtremes();
            ...
            a.prototype.getTickAmount = function() {
                var b = this.options,
                    ...
                    c = b.tickAmount;
                !q(b.tickInterval) && !c &&
                    this.len < d && !this.isRadial && !this.logarithmic && b.startOnTick && b.endOnTick && (c = 2);
            ...
            a.prototype.adjustTickAmount = function() {
                ...
                if (d.hasData() &&
                    ...
                    if (q(c)) {
                        for (v =
                            f = l.length; v--;)(3 === c && 1 === v % 2 || 2 >= c && 0 < v && v < f - 1) && l.splice(v, 1);
            ...
            a.prototype.setExtremes = function(b, d, c, a, e) {
                var h = this,
                    l = h.chart;
                c = r(c, !0);
                h.series.forEach(function(b) { delete b.kdTree });
                e = z(e, { min: b, max: d });
            ...
            a.prototype.zoom = function(b, d) {
                ...
                m(this, "zoom", b, function(b) {
                    var d = b.newMin,
                        h = b.newMax;
                    if (d !== c.min || h !== c.max) c.allowZoomOutside || (q(a) && (d < l && (d = l), d > g && (d = g)), q(e) && (h < l && (h = l), h > g && (h = g))), c.displayBtn = "undefined" !== typeof d || "undefined" !== typeof h, c.setExtremes(d, h, !1, void 0, { trigger: "zoom" });
                    b.zoomed = !0
                });
                return b.zoomed
            };
            ...
            a.prototype.autoLabelAlign = function(b) {
                ...
                b = { align: "center" };
                m(this, "autoLabelAlign",
                    b,
                    function(b) { 15 < d && 165 > d ? b.align = "right" : 195 < d && 345 > d && (b.align = "left") });
                return b.align
            };
            a.prototype.tickSize = function(b) {
                ...
                if (c && a) { "inside" === d[b + "Position"] && (a = -a); var e = [a, c] }
                b = { tickSize: e };
            ...
            a.prototype.unsquish = function() {
                var d = this.options.labels,
                    ...
                    v = a,
                    f, D, p = Number.MAX_VALUE;
                if (c) {
                    if (!d.staggerLines && !d.step)
                        if (b(l)) var q = [l];
                        else h < d.autoRotationLimit && (q = d.autoRotation);
                    q &&
            ...
            a.prototype.renderUnsquish = function() {
                ...
                if (this.autoRotation) D > r && D > v.h ? k.rotation = this.labelRotation : this.labelRotation = 0;
                else if (m) { var p = r; if (!f) { var q = "clip"; for (r = c.length; !g && r--;) { var n = c[r]; if (n = a[n].label) n.styles && "ellipsis" === n.styles.textOverflow ? n.css({ textOverflow: "clip" }) : n.textPxLength > m && n.css({ width: m + "px" }), n.getBBox().height > this.len / c.length - (v.h - v.f) && (n.specificTextOverflow = "ellipsis") } } }
                ...
                c.forEach(function(b) {
                    var d = (b = a[b]) && b.label,
                        c = h.width,
                        e = {};
                    d && (d.attr(k), b.shortenLabel ? b.shortenLabel() : p && !c && "nowrap" !== h.whiteSpace && (p < d.textPxLength || "SPAN" === d.element.tagName) ? (e.width = p + "px", f || (e.textOverflow = d.specificTextOverflow || q), d.css(e)) : d.styles && d.styles.width && !e.width && !c && d.css({ width: null }), delete d.specificTextOverflow, b.rotation = k.rotation)
                }, this);
            ...
            a.prototype.addTitle = function(b) {
                ...
                l || h.style.width || this.isRadial || this.axisTitle.css({ width: this.len + "px" });
            ...
            a.prototype.getOffset = function() {
                ...
                if (!d.axisGroup) {
                    var N = function(d, c, a) { return D.g(d).attr({ zIndex: a }).addClass("highcharts-" + k.toLowerCase() + c + " " + (b.isRadial ? "highcharts-radial-axis" + c + " " : "") + (P || "")).add(f) };
                    d.gridGroup = N("grid", "-grid", e.gridZIndex);
                    d.axisGroup = N("axis", "", e.zIndex);
                    d.labelGroup = N("axis-labels", "-labels", z.zIndex)
                }
                n || d.isLinked ? (g.forEach(function(b) { d.generateTick(b) }), d.renderUnsquish(), d.reserveSpaceDefault =
                    0 === h || 2 === h || { 1: "left", 3: "right" }[h] === d.labelAlign, r(z.reserveSpace, "center" === d.labelAlign ? !0 : null, d.reserveSpaceDefault) && g.forEach(function(b) { ca = Math.max(l[b].getLabelSize(), ca) }), d.staggerLines && (ca *= d.staggerLines), d.labelOffset = ca * (d.opposite ? -1 : 1)) : v(l, function(b, d) {
                    b.destroy();
                    delete l[d]
                });
                ...
                d.renderLine();
                d.offset = O *
                    r(e.offset, y[h] ? y[h] + (e.margin || 0) : 0);
                ...
                "colorAxis" !== k && (a = this.tickSize("tick"), y[h] = Math.max(y[h], (d.axisTitleMargin || 0) + F + O * d.offset, n, g && g.length && a ? a[0] + O * d.offset : 0), e = !d.axisLine || e.offset ? 0 : 2 * Math.floor(d.axisLine.strokeWidth() / 2), c[p] =
                    Math.max(c[p], e));
            ...
            a.prototype.getLinePath = function(b) {
                ...
                return d.renderer.crispLine([
                    ["M", e ? this.left : h, e ? a : this.top],
                    ["L", e ? d.chartWidth - this.right : h, e ? a : d.chartHeight - this.bottom]
                ], b)
            };
            ...
            a.prototype.getTitlePosition = function() {
                ...
                a = { low: h + (b ? 0 : a), middle: h + a / 2, high: h + (b ? a : 0) }[e.align];
                d = (b ? c + this.height : d) + (b ? 1 : -1) * (l ? -1 : 1) * (this.axisTitleMargin ||
                    0) + [-v, v, f.f, -v][this.side];
                b = { x: b ? a + r : d + (l ? this.width : 0) + g + r, y: b ? d + k - (l ? this.height : 0) + g : a + k };
            ...
            a.prototype.render = function() {
                ...
                d.overlap = !1;
                [r, k, f].forEach(function(b) { v(b, function(b) { b.isActive = !1 }) });
                if (d.hasData() || h) {
                    var P = d.chart.hasRendered && d.old && b(d.old.min);
                    d.minorTickInterval && !d.categories &&
                        d.getMinorTickPositions().forEach(function(b) { d.renderMinorTick(b, P) });
                    l.length && (l.forEach(function(b, c) { d.renderTick(b, c, P) }), q && (0 === d.min || d.single) && (r[-1] || (r[-1] = new I(d, -1, null, !0)), r[-1].render(-1)));
                    p && l.forEach(function(b, e) {
                        O = "undefined" !== typeof l[e + 1] ? l[e + 1] + q : d.max - q;
                        0 === e % 2 && b < d.max && O <= d.max + (c.polar ? -q : q) && (f[b] || (f[b] = new E.PlotLineOrBand(d)), y = b + q, f[b].options = { from: a ? a.lin2log(y) : y, to: a ? a.lin2log(O) : O, color: p, className: "highcharts-alternate-grid" }, f[b].render(), f[b].isActive = !0)
                    });
                    ...
                    var d = [],
                        a = z.duration;
                    v(b, function(b, c) { b.isActive || (b.render(c, !1, 0), b.isActive = !1, d.push(c)) });
                    N(function() { for (var c = d.length; c--;) b[d[c]] && !b[d[c]].isActive && (b[d[c]].destroy(), delete b[d[c]]) }, b !== f && c.hasRendered && a ? a : 0)
                });
                n && (n[n.isPlaced ? "animate" : "attr"]({ d: this.getLinePath(n.strokeWidth()) }), n.isPlaced = !0, n[t ? "show" : "hide"](t));
                g && t &&
                    (e = d.getTitlePosition(), g[g.isNew ? "attr" : "animate"](e), g.isNew = !1);
            ...
            a.prototype.getKeepProps = function() { return this.keepProps || a.keepProps };
            a.prototype.destroy =
                function(b) {
                    var d = this,
                    ...
                    b || P(d);
                    [d.ticks, d.minorTicks, d.alternateBands].forEach(function(b) { F(b) });
                    if (c)
                        for (b = c.length; b--;) c[b].destroy();
                    "axisLine axisTitle axisGroup gridGroup labelGroup cross scrollbar".split(" ").forEach(function(b) { d[b] && (d[b] = d[b].destroy()) });
            ...
            a.prototype.drawCrosshair = function(b, d) {
                ...
                if (c && !1 !== (q(d) || !a)) {
                    ...
                    if (q(h)) {
                        var g = { value: d && (this.isXAxis ? d.x : r(d.stackY, d.y)), translatedValue: h };
                        e.polar && z(g, {
                            isCrosshair: !0,
                            chartX: b && b.chartX,
                            chartY: b && b.chartY,
                    ...
                    if (!q(g)) { this.hideCrosshair(); return }
                    a = this.categories && !this.isRadial;
                    l || (this.cross = l = e.renderer.path().addClass("highcharts-crosshair highcharts-crosshair-" + (a ? "category " : "thin ") + (c.className || "")).attr({ zIndex: r(c.zIndex, 2) }).add(), e.styledMode || (l.attr({ stroke: c.color || (a ? B.parse("#ccd6eb").setOpacity(.25).get() : "#cccccc"), "stroke-width": r(c.width, 1) }).css({ "pointer-events": "none" }), c.dashStyle && l.attr({ dashstyle: c.dashStyle })));
                    l.show().attr({ d: g });
            ...
            a.prototype.hasVerticalPanning = function() { var b = this.chart.options.chart.panning; return !!(b && b.enabled && /y/.test(b.type)) };
            a.prototype.validatePositiveValue = function(d) { return b(d) && 0 < d };
            a.prototype.update = function(b, c) {
                var a = this.chart;
                b = d(this.userOptions,
                    b);
                this.destroy(!0);
                this.init(a, b);
                a.isDirtyBox = !0;
            ...
            a.prototype.remove = function(b) {
                ...
                y(d.axes, this);
                y(d[c], this);
                d[c].forEach(function(b, d) { b.options.index = b.userOptions.index = d });
                this.destroy();
                d.isDirtyBox = !0;
                r(b, !0) && d.redraw()
            };
            a.prototype.setTitle = function(b, d) { this.update({ title: b }, d) };
            a.prototype.setCategories = function(b, d) { this.update({ categories: b }, d) };
    ...
    K(f, "Core/Axis/DateTimeAxis.js", [f["Core/Utilities.js"]], function(a) {
        ...
        (function(a) {
            ...
            function u(a) { "datetime" !== a.userOptions.type ? this.dateTime = void 0 : this.dateTime || (this.dateTime = new k(this)) }
            var n = [];
            a.compose = function(a) {
                -1 === n.indexOf(a) && (n.push(a),
                    a.keepProps.push("dateTime"), a.prototype.getTimeTicks = A, f(a, "init", u));
                return a
            };
            var k = function() {
                function a(c) { this.axis = c }
                a.prototype.normalizeTimeTickInterval = function(c, a) {
                    ...
                    var k = w[a[0]],
                        f = a[1],
                        p;
                    for (p = 0; p < e.length && !(a = e[p], k = w[a[0]], f = a[1], e[p + 1] && c <= (k * f[f.length - 1] + w[e[p +
                            1][0]]) / 2); p++);
                    k === w.year && c < 5 * k && (f = [1, 2, 5]);
                    c = H(c / k, f, "year" === a[0] ? Math.max(B(c / k), 1) : 1);
                    return { unitRange: k, count: c, unitName: a[0] }
                };
                a.prototype.getXDateFormat = function(c, a) { var e = this.axis; return e.closestPointRange ? e.chart.time.getDateFormat(e.closestPointRange, c, e.options.startOfWeek, a) || a.year : a.day };
                return a
            }();
            a.Additions = k
        })(E || (E = {}));
    ...
    K(f, "Core/Axis/LogarithmicAxis.js", [f["Core/Utilities.js"]], function(a) {
        ...
        (function(a) {
            ...
            function A() {
                ...
                a && (this.lin2val = function(e) { return a.lin2log(e) }, this.val2lin = function(e) { return a.log2lin(e) })
            }
            var u = [];
            a.compose = function(a) {-1 === u.indexOf(a) && (u.push(a), a.keepProps.push("logarithmic"), f(a, "init", w), f(a, "afterInit", A)); return a };
            var n = function() {
                ...
                a.prototype.getLogTickPositions = function(a, c, k, g) {
                    ...
                    if (.5 <= a) a = Math.round(a), n = e.getLinearTickPositions(a, c, k);
                    else if (.08 <= a) {
                        var x = Math.floor(c),
                            z, m = p = void 0;
                    ...
                    } else c = this.lin2log(c), k = this.lin2log(k), a = g ? e.getMinorTickInterval() : p.tickInterval, a = H("auto" === a ? null : a, this.minorAutoInterval, p.tickPixelInterval /
                        (g ? 5 : 1) * (k - c) / ((g ? f / e.tickPositions.length : f) || 1)), a = B(a), n = e.getLinearTickPositions(a, c, k).map(this.log2lin), g || (this.minorAutoInterval = a / 5);
                    g || (e.tickInterval = a);
                    return n
                };
    ...
    K(f, "Core/Axis/PlotLineOrBand/PlotLineOrBandAxis.js", [f["Core/Utilities.js"]], function(a) {
        ...
        (function(a) {
            var w = [],
                A;
            a.compose =
                function(a, k) { A || (A = a); - 1 === w.indexOf(k) && (w.push(k), B(k.prototype, u.prototype)); return k };
            var u = function() {
                function a() {}
                a.prototype.getPlotBandPath = function(a, e, c) {
                    void 0 === c && (c = this.options);
                    var k = this.getPlotLinePath({ value: e, force: !0, acrossPanes: c.acrossPanes }),
                        g = [],
                        f = this.horiz;
                    e = !H(this.min) || !H(this.max) || a < this.min && e < this.min || a > this.max && e > this.max;
                    a = this.getPlotLinePath({ value: a, force: !0, acrossPanes: c.acrossPanes });
                    c = 1;
                    if (a && k) {
                        if (e) {
                ...
                a.prototype.addPlotBand = function(a) { return this.addPlotBandOrLine(a, "plotBands") };
                a.prototype.addPlotLine = function(a) { return this.addPlotBandOrLine(a, "plotLines") };
                a.prototype.addPlotBandOrLine = function(a,
                    e) {
                    var c = this,
                        k = this.userOptions,
                        g = new A(this, a);
                    ...
                    if (g) {
                        this._addedPlotLB || (this._addedPlotLB = !0, (k.plotLines || []).concat(k.plotBands || []).forEach(function(a) { c.addPlotBandOrLine(a) }));
                        if (e) {
                            var f = k[e] || [];
                            f.push(a);
                            k[e] = f
                ...
                a.prototype.removePlotBandOrLine = function(a) {
                    ...
                    if (e) {
                        ...
                        [c.plotLines || [], k.plotLines || [], c.plotBands || [], k.plotBands || []].forEach(function(c) { for (g = c.length; g--;)(c[g] || {}).id === a && f(c, c[g]) })
                    }
                };
                a.prototype.removePlotBand = function(a) { this.removePlotBandOrLine(a) };
                a.prototype.removePlotLine = function(a) { this.removePlotBandOrLine(a) };
                return a
            }()
        })(w || (w = {}));
        return w
    ...
    K(f, "Core/Axis/PlotLineOrBand/PlotLineOrBand.js", [f["Core/Axis/PlotLineOrBand/PlotLineOrBandAxis.js"], f["Core/Utilities.js"]], function(a, f) {
        ...
        f = function() {
            ...
            e.compose = function(c) { return a.compose(e, c) };
            e.prototype.render = function() {
                ...
                r = w(D);
                var P = !v,
                    S = { "class": "highcharts-plot-" + (O ? "band " : "line ") + (q.className || "") },
                    N = O ? "bands" : "lines";
                f &&
                    (d = f.log2lin(d), l = f.log2lin(l), D = f.log2lin(D));
                ...
                if (r) r = a.getPlotLinePath({ value: D, lineWidth: v.strokeWidth(), acrossPanes: q.acrossPanes });
                else if (O) r = a.getPlotBandPath(d, l, q);
                else return;
                !c.eventsAdded && x && (n(x, function(b, d) { v.on(d, function(b) { x[d].apply(c, [b]) }) }), c.eventsAdded = !0);
                (P || !v.d) && r && r.length ? v.attr({ d: r }) : v && (r ? (v.show(), v.animate({ d: r })) : v.d && (v.hide(), b && (c.label = b = b.destroy())));
                h && (w(h.text) || w(h.formatter)) && r && r.length && 0 < a.width && 0 < a.height && !r.isFlat ? (h = u({ align: e && O && "center", x: e ? !O && 4 : 10, verticalAlign: !e && O && "middle", y: e ? O ? 16 : 10 : O ? 6 : -4, rotation: e && !O && 90 }, h), this.renderLabel(h, r, O, y)) : b && b.hide();
                return c
            };
            e.prototype.renderLabel =
                function(c, a, e, f) {
                    var g = this.axis,
                        k = g.chart.renderer,
                        p = this.label;
                    p || (this.label = p = k.text(this.getLabelText(c), 0, 0, c.useHTML).attr({ align: c.textAlign || c.align, rotation: c.rotation, "class": "highcharts-plot-" + (e ? "band" : "line") + "-label " + (c.className || ""), zIndex: f }).add(), g.chart.styledMode || p.css(u({ textOverflow: "ellipsis" }, c.style)));
                    f = a.xBounds || [a[0][1], a[1][1], e ? a[2][1] : a[0][1]];
                    a = a.yBounds || [a[0][2], a[1][2], e ? a[2][2] : a[0][2]];
                    e = H(f);
                    k = H(a);
                    p.align(c, !1, { x: e, y: k, width: C(f) - e, height: C(a) - k });
                    p.alignValue &&
                        "left" !== p.alignValue || p.css({ width: (90 === p.rotation ? g.height - (p.alignAttr.y - g.top) : g.width - (p.alignAttr.x - g.left)) + "px" });
                    p.show(!0)
                };
            e.prototype.getLabelText = function(a) { return w(a.formatter) ? a.formatter.call(this) : a.text };
    ...
    K(f, "Core/Tooltip.js", [f["Core/FormatUtilities.js"], f["Core/Globals.js"], f["Core/Renderer/RendererUtilities.js"], f["Core/Renderer/RendererRegistry.js"], f["Core/Utilities.js"]],
        function(a, f, B, H, w) {
            var C = a.format,
                I = f.doc,
                A = B.distribute,
            ...
            a = function() {
                ...
                a.prototype.applyFilter = function() {
                    ...
                    b.renderer.definition({
                        tagName: "filter",
                        attributes: { id: "drop-shadow-" + b.index, opacity: .5 },
                ...
                a.prototype.getLabel = function() {
                    ...
                    if (!this.label) {
                        if (this.outside) {
                            ...
                            k(n, { position: "absolute", top: "1px", pointerEvents: g, zIndex: Math.max(this.options.style.zIndex || 0, (z && z.zIndex || 0) + 3) });
                            u(n, "mouseenter", m);
                            u(n, "mouseleave", p);
                            f.doc.body.appendChild(n);
                            this.renderer = q = new t(n, 0, 0, z, void 0, void 0, q.styledMode)
                        }
                        c ? this.label = q.g(h) : (this.label = q.label("", 0, 0, d.shape, void 0, void 0, d.useHTML, void 0, h).attr({ padding: d.padding, r: d.borderRadius }), a || this.label.attr({
                            fill: d.backgroundColor,
                            "stroke-width": d.borderWidth
                        }).css(d.style).css({ pointerEvents: g }).shadow(d.shadow));
                        ...
                        this.label.on("mouseenter", m).on("mouseleave", p).attr({ zIndex: 8 }).add()
                    }
                    return this.label
                };
                a.prototype.getPosition = function(b,
                    ...
                    var c = this.chart,
                        ...
                        p = function(h) {
                            var l = "x" === h;
                            return [h, l ? m : f, l ? b : a].concat(g ? [l ? b * k.scaleX : a * k.scaleY, l ? k.left - e + (d.plotX + c.plotLeft) * k.scaleX : k.top - e + (d.plotY + c.plotTop) * k.scaleY, 0, l ? m : f] : [l ? b : a, l ?
                    ...
                    var t = !this.followPointer && x(d.ttBelow, !c.inverted === p),
                        y = function(b, d, a, c, m, f, r) {
                            ...
                            else if (G) h[b] = Math.min(r - c, 0 > n - l ? n : n - l);
                            else if (p) h[b] = Math.max(f, m +
                                l + a > d ? m : m + l);
                            else return !1
                        },
                        ...
                        T = function() {!1 !== y.apply(0, n) ? !1 !== F.apply(0, q) || z || (G(!0), T()) : z ? h.x = h.y = 0 : (G(!0), T()) };
                ...
                a.prototype.shouldStickOnContact = function() { return !(this.followPointer || !this.options.stickOnContact) };
                a.prototype.isStickyOnContact = function() { return !(!this.shouldStickOnContact() || !this.inContact) };
                a.prototype.move = function(b, a, d, c) {
                    var e = this,
                        h = e.now,
                        l = !1 !== e.options.animation &&
                        !e.isHidden && (1 < Math.abs(b - h.x) || 1 < Math.abs(a - h.y)),
                        g = e.followPointer || 1 < e.len;
                    p(h, { x: l ? (2 * h.x + b) / 3 : b, y: l ? (h.y + a) / 2 : a, anchorX: g ? void 0 : l ? (2 * h.anchorX + d) / 3 : d, anchorY: g ? void 0 : l ? (h.anchorY + c) / 2 : c });
                    e.getLabel().attr(h);
                    e.drawTracker();
                    l && (w.clearTimeout(this.tooltipTimeout), this.tooltipTimeout = setTimeout(function() { e && e.move(b, a, d, c) }, 32))
                };
                a.prototype.refresh = function(b, a) {
                    ...
                    if (c.enabled &&
                        ...
                        }), p = { x: h.category, y: h.y }, p.points = l) : p = h.getLabelConfig();
                        this.len = l.length;
                        m = m.call(p, this);
                        f = h.series;
                        ...
                        if (!1 === m) this.hide();
                            ...
                            if (this.split && this.allowShared) this.renderSplit(m, e);
                            else {
                                var y = n,
                                    F = q;
                                a && d.pointer.isDirectTouch && (y = a.chartX - d.plotLeft, F = a.chartY - d.plotTop);
                                if (d.polar || !1 === f.options.clip || e.some(function(b) { return b.series.shouldShowTooltip(y, F) })) a = this.getLabel(), c.style.width && !k || a.css({ width: this.chart.spacingBox.width + "px" }), a.attr({ text: m && m.join ? m.join("") : m }), a.removeClass(/highcharts-color-[\d]+/g).addClass("highcharts-color-" + x(h.colorIndex, f.colorIndex)), k || a.attr({
                                    stroke: c.borderColor || h.color ||
                                        f.color || "#666666"
                                }), this.updatePosition({ plotX: n, plotY: q, negative: h.negative, ttBelow: h.ttBelow, h: b[2] || 0 });
                ...
                a.prototype.renderSplit = function(b, a) {
                    ...
                    var w = h.styledMode,
                        ...
                        M = c.outside && "number" !== typeof t ? I.documentElement.getBoundingClientRect() : { left: u, right: u + l, top: y, bottom: y + g },
                        V = c.getLabel(),
                    ...
                    b = b.slice(0, a.length + 1).reduce(function(b, e, h) {
                        if (!1 !== e && "" !== e) {
                            h = a[h - 1] || { isHeader: !0, plotX: a[0].plotX, plotY: m, series: {} };
                            var l = h.isHeader,
                                g = l ? c : h.series;
                            e = e.toString();
                            var r = g.tt,
                            ...
                            r || (r = { padding: G.padding, r: G.borderRadius }, w || (r.fill = G.backgroundColor, r["stroke-width"] = G.borderWidth), r = W.label("", 0, 0, G[v ? "headerShape" : "shape"], void 0, void 0, G.useHTML).addClass((v ? "highcharts-tooltip-header " :
                                "") + "highcharts-tooltip-box " + p).attr(r).add(V));
                            r.isActive = !0;
                            r.attr({ text: e });
                            w || r.css(G.style).shadow(G.shadow).attr({ stroke: G.borderColor || h.color || D.color || "#333333" });
                            g = g.tt = r;
                            v = g.getBBox();
                            ...
                            p = void 0 === p ? 0 : p;
                            r = h.series;
                            if (h.isHeader) { D = f + D; var q = k + m / 2 } else {
                                var z = r.xAxis,
                                    fa = r.yAxis;
                                D = z.pos + n(D, -C, z.len + C);
                                r.shouldShowTooltip(0, fa.pos - k + p, { ignoreX: !0 }) && (q = fa.pos + p)
                            }
                            D = n(D, M.left - C, M.right + C);
                            "number" ===
                            typeof q ? (v = v.height + 1, p = T ? T.call(c, e, v, h) : d(D, q, l, e), b.push({ align: T ? 0 : void 0, anchorX: D, anchorY: q, boxWidth: e, point: h, rank: x(p.rank, l ? 1 : 0), size: v, target: p.y, tt: g, x: p.x })) : g.isActive = !1
                        }
                        return b
                    }, []);
                    !T && b.some(function(b) { var d = (c.outside ? R : 0) + b.anchorX; return d < M.left && d + b.boxWidth < M.right ? !0 : d < R - M.left + b.boxWidth && M.right - d > d }) && (b = b.map(function(b) { var a = d(b.anchorX, b.anchorY, b.point.isHeader, b.boxWidth, !1); return p(b, { target: a.y, x: a.x }) }));
                    c.cleanSplit();
                    A(b, E);
                    var H = R,
                        ba = R;
                    ...
                    b.forEach(function(b) {
                        var d = b.x,
                            ...
                            e = b.pos,
                            h = b.point.isHeader;
                        e = { visibility: "undefined" === typeof e ? "hidden" : "inherit", x: d, y: e + B, anchorX: a, anchorY: b.anchorY };
                        if (c.outside && d < a) {
                            var l = R - H;
                    ...
                    b = c.container;
                    z = c.renderer;
                    c.outside && b && z && (h = V.getBBox(), z.setSize(h.width + h.x, h.height + h.y, !1), b.style.left = H + "px", b.style.top =
                        e + "px")
                };
                a.prototype.drawTracker = function() {
                    if (this.followPointer || !this.options.stickOnContact) this.tracker && this.tracker.destroy();
                        ...
                        if (a && d) {
                            ...
                            c.height = 0 > d[1] ? Math.max(Math.abs(d[1]),
                                e.height - Math.abs(d[1])) : Math.max(Math.abs(d[1]), e.height);
                ...
                a.prototype.styledModeFormat = function(b) { return b.replace('style="font-size: 10px"', 'class="highcharts-header"').replace(/style="color:{(point|series)\.color}"/g, 'class="highcharts-color-{$1.colorIndex}"') };
                a.prototype.tooltipFooterHeaderFormatter = function(b, a) {
                    var d = b.series,
                        c = d.tooltipOptions,
                        e = d.xAxis,
                        h = e && e.dateTime;
                    e = { isFooter: a, labelConfig: b };
                    var l = c.xDateFormat,
                    ...
                    g(this, "headerFormatter", e, function(a) {
                        ...
                        h && l && (b.point && b.point.tooltipDateKeys || ["key"]).forEach(function(b) { m = m.replace("{point." + b + "}", "{point." + b + ":" + l + "}") });
                        d.chart.styledMode && (m = this.styledModeFormat(m));
                        a.text = C(m, { point: b, series: d }, this.chart)
                    });
                    return e.text
                };
        ...
        f = function() {
            ...
            l.prototype.animateBeforeDestroy = function() {
                ...
                c.singular.forEach(function(d) {
                    b[d] = b[d].animate("dataLabel" ===
                        d ? { x: b[d].startXPos, y: b[d].startYPos, opacity: 0 } : a)
                });
            ...
            l.prototype.applyOptions = function(b, a) {
                ...
                c && (this.y = l.prototype.getNestedProperty.call(this,
                    c));
            ...
            l.prototype.destroyElements = function(b) {
                ...
                b.singular.forEach(function(b) { d[b] = d[b].destroy() });
            ...
            l.prototype.firePointEvent = function(b, a, e) {
                ...
                "click" === b && h.allowPointSelect && (e = function(b) { d.select && d.select(null, b.ctrlKey || b.metaKey || b.shiftKey) });
                c(d, b, a, e)
            };
            ...
            l.prototype.getLabelConfig = function() { return { x: this.category, y: this.y, color: this.color, colorIndex: this.colorIndex, key: this.name || this.category, series: this.series, point: this, percentage: this.percentage, total: this.total || this.stackTotal } };
            l.prototype.getNestedProperty = function(b) { if (b) return 0 === b.indexOf("custom.") ? p(b, this.options) : this[b] };
            ...
            l.prototype.hasNewShapeType = function() { return (this.graphic && (this.graphic.symbolName || this.graphic.element.nodeName)) !== this.shapeType };
            ...
            l.prototype.optionsToObject = function(b) {
                var d = this.series,
                    ...
                    m = 0,
                    f = 0;
                if (q(b) || null === b) h[c[0]] = b;
                else if (g(b))
                    for (!a && b.length > e && (d = typeof b[0], "string" === d ? h.name = b[0] : "number" === d && (h.x = b[0]), m++); f < e;) a && "undefined" === typeof b[m] || (0 < c[f].indexOf(".") ? l.prototype.setNestedProperty(h, b[m], c[f]) : h[c[f]] = b[m]), m++, f++;
                else "object" === typeof b && (h = b, b.dataLabels && (d._hasPointLabels = !0), b.marker && (d._hasPointMarkers = !0));
                return h
            };
            ...
            l.prototype.setNestedProperty = function(b, a, c) {
                c.split(".").reduce(function(b,
                    d, c, e) { b[d] = e.length - 1 === c ? a : F(b[d], !0) ? b[d] : {}; return b[d] }, b);
                return b
            };
            l.prototype.tooltipFormatter = function(b) {
                ...
                return A(b, { point: this, series: this.series }, d.chart)
            };
            l.prototype.update =
                function(b, a, c, e) {
                    function d() {
                        ...
                        !l.fixedBox &&
                            l.hasCartesianSeries && (m.isDirtyBox = !0);
                    ...
                    var h = this,
                        ...
                        k;
                    a = z(a, !0);
                    !1 === e ? d() : h.firePointEvent("update", { options: b }, d)
                };
            l.prototype.remove = function(b, a) { this.series.removePoint(this.series.data.indexOf(this), b, a) };
            ...
            l.prototype.onMouseOut = function() {
                ...
                this.series.options.inactiveOtherPoints || (b.hoverPoints || []).forEach(function(b) { b.setState() });
                ...
                if (!(b === this.state && !h || this.selected && "select" !== b || !1 === g.enabled || b && (p || f && !1 === k.enabled) || b && n.states && n.states[b] && !1 === n.states[b].enabled)) {
                    ...
                    if (this.graphic && !this.hasDummyGraphic) {
                        ...
                        if (!D.styledMode) {
                            ...
                            d.options.inactiveOtherPoints && q(u.opacity) && ((this.dataLabels || []).forEach(function(b) { b && b.animate({ opacity: u.opacity }, G) }), this.connector && this.connector.animate({ opacity: u.opacity }, G));
                        ...
                        if (b && k) {
                            ...
                            F && F.currentSymbol !==
                                l && (F = F.destroy());
                            if (x)
                                if (F) F[h ? "animate" : "attr"]({ x: x.x, y: x.y });
                    ...
                    g && g.size && F && "hidden" !== x && !this.isCluster ? (t || (d.halo = t = D.renderer.path().add(F.parentGroup)),
    ...
    K(f, "Core/Pointer.js", [f["Core/Color/Color.js"], f["Core/Globals.js"], f["Core/Tooltip.js"], f["Core/Utilities.js"]], function(a, f, B, H) {
        ...
        a = function() {
            ...
            a.prototype.applyInactiveState = function(a) {
                ...
                this.chart.series.forEach(function(b) {-1 === c.indexOf(b) ? b.setState("inactive", !0) : b.options.inactiveOtherPoints && b.setAllPointsToState("inactive") })
            };
            a.prototype.destroy = function() {
                var c = this;
            ...
            a.prototype.drag = function(a) {
                ...
                if (!F || !F.touch)
                    if (x < g ? x = g : x > g + f && (x = g + f), z < m ? z = m : z > m + k && (z = m + k), this.hasDragged = Math.sqrt(Math.pow(p - x, 2) + Math.pow(n - z, 2)), 10 < this.hasDragged) {
                        var u = c.isInsidePlot(p - g, n - m, { visiblePlotOnly: !0 });
                        !c.hasCartesianSeries && !c.mapView || !this.zoomX && !this.zoomY || !u || y || F || (this.selectionMarker = F = c.renderer.rect(g, m, e ? 1 : f, d ? 1 : k, 0).attr({ "class": "highcharts-selection-marker", zIndex: 7 }).add(), c.styledMode || F.attr({
                            fill: b.selectionMarkerFill ||
                                w("#335cad").setOpacity(.25).get()
                        }));
                        F && e && (e = x - p, F.attr({ width: Math.abs(e), x: (0 < e ? 0 : e) + p }));
                        F && d && (e = z - n, F.attr({ height: Math.abs(e), y: (0 < e ? 0 : e) + n }));
            ...
            a.prototype.drop = function(a) {
                ...
                if (this.selectionMarker) {
                    var d = this.selectionMarker,
                        ...
                        t = { originalEvent: a, xAxis: [], yAxis: [], x: m, y: f, width: r, height: q },
                        y = !!b.mapView;
                    if (this.hasDragged || l) b.axes.forEach(function(b) {
                        if (b.zoomEnabled && k(b.min) && (l || c[{ xAxis: "zoomX", yAxis: "zoomY" }[b.coll]]) && g(m) && g(f)) {
                            var d = b.horiz,
                                e = "touchend" === a.type ? b.minPixelPadding : 0,
                                h = b.toValue((d ? m : f) + e);
                            d = b.toValue((d ? m + r : f + q) - e);
                            t[b.coll].push({ axis: b, min: Math.min(h, d), max: Math.max(h, d) });
                            y = !0
                        }
                ...
                b && g(b.index) && (n(b.container, { cursor: b._cursor }), b.cancelClick = 10 < this.hasDragged, b.mouseIsDown = this.hasDragged = this.hasPinched = !1, this.pinchDown = [])
            };
            ...
            a.prototype.getHoverData = function(a, e, b, l, d, g) {
                var h = [];
                l = !(!l || !a);
                var m = { chartX: g ? g.chartX : void 0, chartY: g ? g.chartY : void 0, shared: d };
                p(this, "beforeGetHoverData", m);
                var f = e && !e.stickyTracking ? [e] : b.filter(function(b) { return m.filter ? m.filter(b) : b.visible && !(!d && b.directTouch) && y(b.options.enableMouseTracking, !0) && b.stickyTracking });
                var k = l || !g ? a : this.findNearestKDPoint(f, d, g);
                e = k && k.series;
                k && (d && !e.noSharedTooltip ?
                    (f = b.filter(function(b) { return m.filter ? m.filter(b) : b.visible && !(!d && b.directTouch) && y(b.options.enableMouseTracking, !0) && !b.noSharedTooltip }), f.forEach(function(b) {
                        var d = c(b.points, function(b) { return b.x === k.x && !b.isNull });
            ...
            a.prototype.inClass = function(a, c) {
                for (var b; a;) {
                    if (b = u(a, "class")) { if (-1 !== b.indexOf(c)) return !0; if (-1 !== b.indexOf("highcharts-container")) return !1 }
                    a = a.parentElement
                }
            };
            ...
            a.prototype.normalize = function(a, c) {
                ...
                b /= c.scaleX;
                h /= c.scaleY;
                return e(a, { chartX: Math.round(b), chartY: Math.round(h) })
            };
            a.prototype.onContainerClick =
                function(a) {
                    ...
                    var l = c.plotLeft,
                        d = c.plotTop;
                    c.cancelClick || (b && this.inClass(a.target, "highcharts-tracker") ? (p(b.series, "click", e(a, { point: b })), c.hoverPoint && b.firePointEvent("click", a)) : (e(a, this.getCoordinates(a)), c.isInsidePlot(a.chartX - l, a.chartY - d, { visiblePlotOnly: !0 }) && p(c, "click", a)))
                };
            ...
            a.prototype.onContainerMouseEnter = function(a) { delete this.chartPosition };
            ...
            a.prototype.onDocumentMouseMove = function(a) {
                ...
                var e = c.tooltip;
                !b || e && e.isStickyOnContact() || c.isInsidePlot(a.chartX - c.plotLeft, a.chartY - c.plotTop, { visiblePlotOnly: !0 }) ||
            ...
            a.prototype.pinch = function(a) {
                ...
                k && c.initiated && !n && !1 !== a.cancelable &&
                    a.preventDefault();
                [].map.call(d, function(b) { return c.normalize(b) });
                "touchstart" === a.type ? ([].forEach.call(d, function(b, a) { l[a] = { chartX: b.chartX, chartY: b.chartY } }), f.x = [l[0].chartX, l[1] && l[1].chartX], f.y = [l[0].chartY, l[1] && l[1].chartY], b.axes.forEach(function(a) {
                    if (a.zoomEnabled) {
                ...
                }), c.res = !0) : c.followTouchMove && 1 === g ? this.runPointActions(c.normalize(a)) : l.length && (p(b, "touchpan", { originalEvent: a }, function() {
                    t || (c.selectionMarker = t = e({ destroy: I, touch: !0 }, b.plotBox));
            ...
            a.prototype.pinchTranslateDirection =
                function(a, c, b, e, d, g, f, k) {
                    ...
                    c();
                    b = G;
                    if (b < v.min) { b = v.min; var u = !0 } else b + x > v.max && (b = v.max - x, u = !0);
                    u ? (M -= .8 * (M - f[l][0]), "number" === typeof F && (F -= .8 * (F - f[l][1])),
                        c()) : f[l] = [M, F];
                    q || (g[l] = G - n, g[p] = x);
                    g = q ? 1 / z : z;
                    d[p] = x;
            ...
            a.prototype.reset = function(a, c) {
                var b = this.chart,
                    ...
                    g = b.tooltip,
                    f = g && g.shared ? h : d;
                a && f && x(f).forEach(function(b) { b.series.isCartesian && "undefined" === typeof b.plotX && (a = !1) });
                ...
                }) : d && (d.setState(d.state, !0), b.axes.forEach(function(b) { b.crosshair && d.series[b.coll] === b && b.drawCrosshair(null, d) })));
                else {
                    if (d) d.onMouseOut();
                    h && h.forEach(function(b) { b.setState() });
                    if (e) e.onMouseOut();
                    g && g.hide(c);
                    this.unDocMouseMove && (this.unDocMouseMove = this.unDocMouseMove());
                    b.axes.forEach(function(b) { b.hideCrosshair() });
            ...
            a.prototype.runPointActions = function(e, h) {
                ...
                if (f && (f !== b.hoverPoint || g && g.isHidden)) {
                    (b.hoverPoints || []).forEach(function(b) {-1 === m.indexOf(b) && b.setState() });
                    if (b.hoverSeries !==
                        k) k.onMouseOver();
                    this.applyInactiveState(m);
                    (m || []).forEach(function(b) { b.setState("hover") });
                    b.hoverPoint && b.hoverPoint.firePointEvent("mouseOut");
                    if (!f.series) return;
                    b.hoverPoints = m;
                    b.hoverPoint = f;
                    f.firePointEvent("mouseOver", void 0, function() { g && f && g.refresh(p ? m : f, e) })
                } else h && g && !g.isHidden && (d = g.getAnchor([{}], e), b.isInsidePlot(d[0], d[1], { visiblePlotOnly: !0 }) && g.updatePosition({ plotX: d[0], plotY: d[1] }));
                ...
                b.axes.forEach(function(a) {
                    var d = y((a.crosshair || {}).snap, !0),
                        h;
                    d && ((h = b.hoverPoint) && h.series[a.coll] === a || (h = c(m, function(b) { return b.series && b.series[a.coll] === a })));
            ...
            a.prototype.scaleGroups = function(a, c) {
                ...
                b.series.forEach(function(e) {
                    ...
                    e.group && (e.xAxis && e.xAxis.zoomEnabled || b.mapView) && (e.group.attr(d),
            ...
            a.prototype.setDOMEvents = function() {
                ...
                this.eventsToUnbind.push(A(e, "mouseleave",
                ...
                for (var g = this.chart.renderTo.parentElement; g && "BODY" !== g.tagName;) this.eventsToUnbind.push(A(g, "scroll", function() { delete c.chartPosition })), g = g.parentElement;
                f.hasTouch && (this.eventsToUnbind.push(A(e, "touchstart", this.onContainerTouchStart.bind(this), { passive: !1 })), this.eventsToUnbind.push(A(e, "touchmove", this.onContainerTouchMove.bind(this), { passive: !1 })),
                    a.unbindDocumentTouchEnd || (a.unbindDocumentTouchEnd = A(b, "touchend", this.onDocumentTouchEnd.bind(this), { passive: !1 })))
            };
            a.prototype.setHoverChartIndex = function() {
                var c = this.chart,
                    e = f.charts[y(a.hoverChartIndex, -1)];
                if (e && e !== c) e.pointer.onContainerMouseLeave({ relatedTarget: c.container });
            ...
            a.prototype.touch = function(a, c) {
                ...
                if (1 === a.touches.length)
                    if (a = this.normalize(a), (e = b.isInsidePlot(a.chartX - b.plotLeft, a.chartY -
                            b.plotTop, { visiblePlotOnly: !0 })) && !b.openMenu) {
                        c && this.runPointActions(a);
                        if ("touchmove" === a.type) { c = this.pinchDown; var d = c[0] ? 4 <= Math.sqrt(Math.pow(c[0].chartX - a.chartX, 2) + Math.pow(c[0].chartY - a.chartY, 2)) : !1 }
                        y(d, !0) && this.pinch(a)
                    } else c && this.reset();
                else 2 === a.touches.length && this.pinch(a)
            };
            a.prototype.touchSelect = function(a) { return !(!this.chart.options.chart.zoomBySingleTouch || !a.touches || 1 !== a.touches.length) };
    ...
    K(f, "Core/MSPointer.js", [f["Core/Globals.js"], f["Core/Pointer.js"], f["Core/Utilities.js"]], function(a, f, B) {
        function C() {
            ...
            c(g, function(c) { a.push({ pageX: c.pageX, pageY: c.pageY, target: c.target }) });
            return a
        }

        function w(a, c, e, g) {
            var k = I[f.hoverChartIndex ||
                NaN];
            "touch" !== a.pointerType && a.pointerType !== a.MSPOINTER_TYPE_TOUCH || !k || (k = k.pointer, g(a), k[c]({ type: e, target: a.currentTarget, preventDefault: u, touches: C() }))
        }
        var E = this && this.__extends || function() {
                var a = function(c, e) {
                    a = Object.setPrototypeOf || { __proto__: [] }
                    instanceof Array && function(a, c) { a.__proto__ = c } || function(a, c) { for (var e in c) c.hasOwnProperty(e) && (a[e] = c[e]) };
                    return a(c, e)
                };
                return function(c, e) {
                    function g() { this.constructor = c }
                    a(c, e);
                    c.prototype = null === e ? Object.create(e) : (g.prototype = e.prototype,
                        new g)
                }
            }(),
            I = a.charts,
            ...
            t = !!n.PointerEvent;
        return function(c) {
            function f() { return null !== c && c.apply(this, arguments) || this }
            E(f, c);
            f.isRequired = function() { return !(a.hasTouch || !n.PointerEvent && !n.MSPointerEvent) };
            ...
            f.prototype.onContainerPointerDown = function(a) { w(a, "onContainerTouchStart", "touchstart", function(a) { g[a.pointerId] = { pageX: a.pageX, pageY: a.pageY, target: a.currentTarget } }) };
            ...
            f.prototype.onDocumentPointerUp = function(a) { w(a, "onDocumentTouchEnd", "touchend", function(a) { delete g[a.pointerId] }) };
    ...
    K(f, "Core/Legend/Legend.js", [f["Core/Animation/AnimationUtilities.js"], f["Core/FormatUtilities.js"],
        f["Core/Globals.js"], f["Core/Series/Point.js"], f["Core/Renderer/RendererUtilities.js"], f["Core/Utilities.js"]
        ...
        E = function() {
            ...
            a.prototype.init = function(b, a) {
                this.chart =
                    b;
                this.setOptions(a);
                a.enabled && (this.render(), e(this.chart, "endResize", function() { this.legend.positionCheckboxes() }), this.proximate ? this.unchartrender = e(this.chart, "render", function() {
            ...
            a.prototype.colorizeItem = function(b, a) {
                ...
                F(this, "afterColorizeItem", { item: b, visible: a })
            };
            ...
            a.prototype.positionItem = function(b) {
                ...
                var l = b.checkbox,
                    f = b.legendGroup;
                f && f.element && (c = { translateX: e ? d : this.legendWidth - d - 2 * c - 4, translateY: h }, e = function() { F(a, "afterPositionItem", { item: b }) }, g(f.translateY) ? f.animate(c, void 0, e) : (f.attr(c), e()));
                l && (l.x = d, l.y = h)
            };
            ...
            a.prototype.destroy = function() {
                function b(b) { this[b] && (this[b] = this[b].destroy()) }
            ...
            a.prototype.positionCheckboxes = function() {
                ...
                if (b) {
                    ...
                    this.allItems.forEach(function(d) {
                        ...
                        if (h) {
                            var g = e +
                                c + h.y + (this.scrollOffset || 0) + 3;
                            p(h, { left: b.translateX + d.checkboxOffset + h.x - 20 + "px", top: g + "px", display: this.proximate || g > e - 6 && g < e + a - 6 ? "" : "none" })
                        }
                    }, this)
                }
            };
            a.prototype.renderTitle = function() {
                var b = this.options,
                    ...
                    c = b.title,
                    e = 0;
                c.text && (this.title || (this.title = this.chart.renderer.label(c.text, a - 3, a - 4, void 0, void 0, void 0, b.useHTML, void 0, "legend-title").attr({ zIndex: 1 }), this.chart.styledMode || this.title.css(c.style), this.title.add(this.group)), c.width || this.title.css({
                    width: this.maxLegendWidth +
                        "px"
                }), b = this.title.getBBox(), e = b.height, this.offsetWidth = b.width, this.contentGroup.attr({ translateY: e }));
                this.titleHeight = e
            };
            a.prototype.setText = function(b) {
                var a = this.options;
                b.legendItem.attr({ text: a.labelFormat ? u(a.labelFormat, b, this.chart) : a.labelFormatter.call(b) })
            };
            a.prototype.renderItem = function(b) {
                var a = this.chart,
                    ...
                    G = b.legendItem;
                n = e + h + f + (q ? 20 : 0);
                G || (b.legendGroup = d.g("legend-item").addClass("highcharts-" + p.type + "-series highcharts-color-" + b.colorIndex + (y ? " " + y : "") + (m ? " highcharts-series-" + b.index : "")).attr({ zIndex: 1 }).add(this.scrollGroup), b.legendItem = G = d.text("", k ? e + h : -h, this.baseline || 0, t), a.styledMode || G.css(x(b.visible ? g : l)), G.attr({ align: k ? "left" : "right", zIndex: 2 }).add(b.legendGroup),
                ...
                !a.styledMode && g.width || G.css({ width: (c.itemWidth || this.widthOption || a.spacingBox.width) - n + "px" });
                this.setText(b);
                a = G.getBBox();
            ...
            a.prototype.layoutItem = function(b) {
                ...
                d ? this.itemX += a : (this.itemY += g + e + h, this.lastLineHeight =
                    e);
            ...
            a.prototype.getAlignment = function() {
                var b = this.options;
                return this.proximate ? b.align.charAt(0) + "tv" : b.floating ? "" : b.align.charAt(0) +
            ...
            a.prototype.adjustMargins = function(b, a) {
                var c = this.chart,
                    d = this.options,
                    e = this.getAlignment();
                e && [/(lth|ct|rth)/, /(rtv|rm|rbv)/, /(rbh|cb|lbh)/, /(lbv|lm|ltv)/].forEach(function(h, f) { h.test(e) && !g(b[f]) && (c[n[f]] = Math.max(c[n[f]], c.legend[(f + 1) % 2 ? "legendHeight" : "legendWidth"] + [1, -1, -1, 1][f] * d[f % 2 ? "x" : "y"] + z(d.margin, 12) + a[f] + (c.titleOffset[f] || 0))) })
            };
            a.prototype.proximatePositions = function() {
                ...
                this.allItems.forEach(function(d) {
                    ...
                    if (d.yAxis) {
                        ...
                        d.points && (e = q(h ? d.points : d.points.slice(0).reverse(), function(b) { return y(b.plotY) }));
                ...
                k(a, b.plotHeight).forEach(function(a) { a.item._legendItemPos && (a.item._legendItemPos[1] = b.plotTop - b.spacing[0] + a.pos) })
            };
            a.prototype.render = function() {
                var b =
                    this.chart,
                ...
                f || (this.group = f = a.g("legend").addClass(c.className || "").attr({ zIndex: 7 }).add(), this.contentGroup = a.g().attr({ zIndex: 1 }).add(f), this.scrollGroup =
                    a.g().add(this.contentGroup));
                this.renderTitle();
                h(g, function(b, a) { return (b.options && b.options.legendIndex || 0) - (a.options && a.options.legendIndex || 0) });
                ...
                p += e;
                l || (this.box = l =
                    a.rect().addClass("highcharts-legend-box").attr({ r: c.borderRadius }).add(f));
                b.styledMode || l.attr({ stroke: c.borderColor, "stroke-width": c.borderWidth || 0, fill: c.backgroundColor || "none" }).shadow(c.shadow);
                if (0 < g && 0 < p) l[l.placed ? "animate" : "attr"](l.crisp.call({}, { x: 0, y: 0, width: g, height: p }, l.strokeWidth()));
                l[k ? "show" : "hide"]();
            ...
            a.prototype.align =
                function(b) {
                    ...
                    this.group.align(x(c, { width: this.legendWidth, height: this.legendHeight, verticalAlign: this.proximate ? "top" : c.verticalAlign }), !0, b)
                };
            a.prototype.handleOverflow = function(b) {
                var a = this,
                    ...
                    q = this.allItems,
                    t = function(b) {
                        "number" === typeof b ? F.attr({ height: b }) : F && (a.clipRect = F.destroy(), a.contentGroup.clip());
            ...
            a.prototype.scroll = function(a, c) {
                ...
                p > g && (p = g);
                0 < p && ("undefined" !== typeof c && A(c, e), this.nav.attr({ translateX: m, translateY: f + this.padding + 7 + this.titleHeight, visibility: "inherit" }), [this.up, this.upTracker].forEach(function(b) {
                        b.attr({
                            "class": 1 ===
                                p ? "highcharts-legend-nav-inactive" : "highcharts-legend-nav-active"
                        })
                    }), k.attr({ text: p + "/" + g }), [this.down, this.downTracker].forEach(function(b) { b.attr({ x: 18 + this.pager.getBBox().width, "class": p === g ? "highcharts-legend-nav-inactive" : "highcharts-legend-nav-active" }) }, this), e.styledMode || (this.up.attr({ fill: 1 === p ? l.inactiveColor : l.activeColor }), this.upTracker.css({ cursor: 1 === p ? "default" : "pointer" }), this.down.attr({ fill: p === g ? l.inactiveColor : l.activeColor }), this.downTracker.css({ cursor: p === g ? "default" : "pointer" })),
                    this.scrollOffset = -h[p - 1] + this.initialItemY, this.scrollGroup.animate({ translateY: this.scrollOffset }), this.currentPage = p, this.positionCheckboxes(), a = C(z(c, e.renderer.globalAnimation, !0)), b(function() { F(d, "afterScroll", { currentPage: p }) }, a.duration))
            };
                ...
                var d = this,
                    ...
                    l = function(a) {
                        d.allItems.forEach(function(c) {
                            b !== c && [c].concat(c.linkedSeries || []).forEach(function(b) { b.setState(a, !h) })
                        })
                    };
            ...
            a.prototype.createCheckboxForItem = function(b) {
                b.checkbox = c("input", { type: "checkbox", className: "highcharts-legend-checkbox", checked: b.selected, defaultChecked: b.selected }, this.options.itemCheckboxStyle, this.chart.container);
                e(b.checkbox, "click", function(a) { F(b.series || b, "checkboxClick", { checked: a.target.checked, item: b }, function() { b.select() }) })
            };
            return a
        }();
        (/Trident\/7\.0/.test(B.navigator && B.navigator.userAgent) ||
            a) && w(E.prototype, "positionItem", function(b, a) {
            var c = this,
                d = function() { a._legendItemPos && b.call(c, a) };
            d();
    ...
    K(f, "Core/Series/SeriesRegistry.js", [f["Core/Globals.js"], f["Core/DefaultOptions.js"], f["Core/Series/Point.js"], f["Core/Utilities.js"]], function(a, f, B, H) {
        ...
        (function(f) {
            ...
            f.seriesType = function(a, c, p, g, n) {
                ...
                n && (f.seriesTypes[a].prototype.pointClass =
                    I(B, n));
        ...
        function(a, f, B, H, w, E, I, A, u, n, k, e, c, p, g) {
            ...
            a = function() {
                function a(b, a, c) {
                    ...
                    this.sharedClips = {};
                    this.yAxis =
                        this.xAxis = this.userOptions = this.titleOffset = this.time = this.symbolCounter = this.spacingBox = this.spacing = void 0;
                    this.getArgs(b, a, c)
                }
                a.chart = function(b, c, d) { return new a(b, c, d) };
                a.prototype.getArgs = function(b, a, c) { V(b) || b.nodeName ? (this.renderTo = b, this.init(a, c)) : this.init(b, a) };
                a.prototype.init = function(b, a) {
                    var e = b.plotOptions || {};
                    Q(this, "init", { args: arguments }, function() {
                        var h = W(d, b),
                            g = h.chart;
                        Z(h.plotOptions, function(b, a) { M(b) && (b.tooltip = e[a] && W(e[a].tooltip) || void 0) });
                        h.tooltip.userOptions = b.chart &&
                ...
                a.prototype.setSeriesData = function() { this.getSeriesOrderByLinks().forEach(function(b) { b.points || b.data || !b.enabledDataSorting || b.setData(b.options.data, !1) }) };
                ...
                a.prototype.isInsidePlot = function(b, a, c) {
                    ...
                    f = c.inverted ? a : b;
                    a = c.inverted ? b : a;
                    b = { x: f, y: a, isInsidePlot: !0 };
                    if (!c.ignoreX) {
                        var p = m && (d ? m.yAxis : m.xAxis) || { pos: h, len: Infinity };
                        f = c.paneCoordinates ? p.pos + f : h + f;
                        f >= Math.max(l + h, p.pos) && f <= Math.min(l + h + e.width, p.pos + p.len) || (b.isInsidePlot = !1)
                    }!c.ignoreY && b.isInsidePlot && (d = m && (d ? m.xAxis : m.yAxis) || { pos: g, len: Infinity }, c = c.paneCoordinates ? d.pos + a : g + a, c >= Math.max(k + g, d.pos) && c <= Math.min(k + g + e.height, d.pos + d.len) || (b.isInsidePlot = !1));
                    Q(this, "afterIsInsidePlot",
                        b);
                ...
                a.prototype.redraw = function(b) {
                    ...
                    this.getMargins();
                    a.forEach(function(b) { b.isDirty && (k = !0) });
                    a.forEach(function(b) {
                        var a =
                            b.min + "," + b.max;
                    ...
                    l.forEach(function(b) { b.call() })
                };
                a.prototype.get = function(b) {
                    function a(a) { return a.id === b || a.options && a.options.id === b }
                    for (var c = this.series,
                            d = da(this.axes, a) || da(this.series, a), e = 0; !d && e < c.length; e++) d = da(c[e].points || [], a);
                    return d
                };
                a.prototype.getAxes = function() {
                    ...
                    a.forEach(function(b, a) { b.index = a });
                    c.concat(a).forEach(function(a) { new f(b, a) });
                    Q(this, "afterGetAxes")
                };
                ...
                a.prototype.getSelectedSeries = function() { return this.series.filter(function(b) { return b.selected }) };
                ...
                a.prototype.applyDescription = function(b, a) {
                    var c = this,
                        d = "title" === b ? { color: "#333333", fontSize: this.options.isStock ? "16px" : "18px" } : { color: "#666666" };
                    d = this.options[b] = W(!this.styledMode && { style: d },
                        this.options[b], a);
                    var e = this[b];
                    e && a && (this[b] = e = e.destroy());
                    d && !e && (e = this.renderer.text(d.text, 0, 0, d.useHTML).attr({ align: d.align, "class": "highcharts-" + b, zIndex: d.zIndex || 4 }).add(), e.update = function(a) { c[{ title: "setTitle", subtitle: "setSubtitle", caption: "setCaption" }[b]](a) }, this.styledMode || e.css(d.style), this[b] = e)
                };
                a.prototype.layOutTitles = function(b) {
                    ...
                    ["title", "subtitle", "caption"].forEach(function(b) {
                        ...
                        if (e) {
                            ...
                            e.css({ width: (h.width || d.width + (h.widthAdjust || 0)) + "px" });
                            var l = Math.round(e.getBBox(h.useHTML).height);
                            e.align(K({ y: "bottom" === g ? f : b + f, height: l }, h), !1, "spacingBox");
                    ...
                    a[2] && "bottom" ===
                        this.options.caption.verticalAlign && (a[2] += this.options.caption.margin);
                ...
                a.prototype.getChartSize = function() {
                    ...
                    this.chartWidth =
                        Math.max(0, a || this.containerWidth || 600);
                ...
                a.prototype.temporaryDisplay = function(b) {
                    var a = this.renderTo;
                    if (b)
                        for (; a && a.style;) a.hcOrigStyle && (N(a, a.hcOrigStyle), delete a.hcOrigStyle), a.hcOrigDetached && (m.body.removeChild(a), a.hcOrigDetached = !1), a = a.parentNode;
                    else
                        for (; a && a.style;) {
                            m.body.contains(a) || a.parentNode || (a.hcOrigDetached = !0, m.body.appendChild(a));
                            if ("none" === ea(a, "display", !1) || a.hcOricDetached) a.hcOrigStyle = { display: a.style.display, height: a.style.height, overflow: a.style.overflow }, b = { display: "block", overflow: "hidden" }, a !== this.renderTo && (b.height = 0), N(a, b), a.offsetWidth || a.style.setProperty("display", "block", "important");
                            a = a.parentNode;
                            if (a === m.body) break
                        }
                };
                a.prototype.setClassName = function(b) { this.container.className = "highcharts-container " + (b || "") };
                a.prototype.getContainer = function() {
                    ...
                    this.container = d = S("div", { id: d }, h, f);
                ...
                a.prototype.getAxisMargins = function() {
                    var b = this,
                        ...
                        c = b.colorAxis,
                        d = b.margin,
                        e = function(b) { b.forEach(function(b) { b.visible && b.getOffset() }) };
                    b.hasCartesianSeries ?
                        e(b.axes) : c && c.length && e(c);
                    h.forEach(function(c, e) { Y(d[e]) || (b[c] += a[e]) });
                    b.setChartSize()
                };
                a.prototype.reflow = function(b) {
                    ...
                    if (!e && !a.isPrinting && h && c && (d === l || d === m)) {
                        if (h !== a.containerWidth || c !== a.containerHeight) p.clearTimeout(a.reflowTimeout), a.reflowTimeout = ba(function() { a.container && a.setSize(void 0, void 0, !1) }, b ? 100 : 0);
                        a.containerWidth =
                            h;
                        a.containerHeight = c
                    }
                };
                a.prototype.setReflow = function(b) { var a = this;!1 === b || this.unbindReflow ? !1 === b && this.unbindReflow && (this.unbindReflow = this.unbindReflow()) : (this.unbindReflow = r(l, "resize", function(b) { a.options && a.reflow(b) }), r(this, "destroy", this.unbindReflow)) };
                a.prototype.setSize = function(b, a, c) {
                    ...
                    "undefined" !== typeof a &&
                        (d.options.chart.height = a);
                    d.getChartSize();
                    d.styledMode || (c ? t : N)(d.container, { width: d.chartWidth + "px", height: d.chartHeight + "px" }, c);
                    d.setChartSize(!0);
                    ...
                    Q(d, "resize");
                    ba(function() { d && Q(d, "endResize", null, function() {--d.isResizing }) }, q(c).duration)
                };
                a.prototype.setChartSize = function(b) {
                    ...
                    this.plotBox =
                        c.plotBox = { x: l, y: k, width: m, height: p };
                    a = 2 * Math.floor(this.plotBorderWidth / 2);
                    d = Math.ceil(Math.max(a, f[3]) / 2);
                    e = Math.ceil(Math.max(a, f[0]) / 2);
                    this.clipBox = { x: d, y: e, width: Math.floor(this.plotSizeX - Math.max(a, f[1]) / 2 - d), height: Math.max(0, Math.floor(this.plotSizeY - Math.max(a, f[2]) / 2 - e)) };
                ...
                a.prototype.resetMargins = function() {
                    ...
                    ["margin", "spacing"].forEach(function(c) {
                        var d = a[c],
                            e = M(d) ? d : [d, d, d, d];
                        ["Top", "Right", "Bottom", "Left"].forEach(function(d, h) { b[c][h] = R(a[c + d], e[h]) })
                    });
                    h.forEach(function(a, c) { b[a] = R(b.margin[c], b.spacing[c]) });
                ...
                a.prototype.drawChartBox = function() {
                    ...
                    t[x]({ x: z / 2, y: z / 2, width: c - z - v % 2, height: d - z - v % 2, r: b.borderRadius });
                    x = "animate";
                    M || (x = "attr", this.plotBackground = M = a.rect().addClass("highcharts-plot-background").add());
                    M[x](n);
                    e || (M.attr({ fill: f || "none" }).shadow(b.plotShadow), l && (h ? (l !== h.attr("href") && h.attr("href", l), h.animate(n)) : this.plotBGImage = a.image(l, k, m, p, G).add()));
                    q ? q.animate({ width: r.width, height: r.height }) : this.clipRect = a.clipRect(r);
                    x = "animate";
                    y || (x = "attr", this.plotBorder = y = a.rect().addClass("highcharts-plot-border").attr({ zIndex: 1 }).add());
                    e || y.attr({
                    ...
                    y[x](y.crisp({ x: k, y: m, width: p, height: G }, -y.strokeWidth()));
                    this.isDirtyBox = !1;
                ...
                a.prototype.renderLabels = function() {
                    ...
                    a.items && a.items.forEach(function(c) {
                        ...
                        delete d.left;
                        delete d.top;
                        b.renderer.text(c.html, e, h).attr({ zIndex: 2 }).css(d).add()
                    })
                };
                a.prototype.render = function() {
                    var b = this.axes,
                        ...
                        c = this.renderer,
                        d = this.options,
                        e = function(b) { b.forEach(function(b) { b.visible && b.render() }) },
                        h = 0;
                    this.setTitle();
                ...
                a.prototype.addCredits = function(b) {
                    ...
                    c.enabled && !this.credits && (this.credits = this.renderer.text(c.text + (this.mapCredits || ""), 0, 0).addClass("highcharts-credits").on("click", function() { c.href && (l.location.href = c.href) }).attr({ align: c.position.align, zIndex: 8 }), a.styledMode || this.credits.css(c.style), this.credits.add().align(c.position), this.credits.update = function(b) {
                ...
                a.prototype.firstRender = function() {
                    ...
                    if (!b.isReadyToRender || b.isReadyToRender()) {
                        ...
                        b.propFromSeries();
                        b.getAxes();
                        (G(a.series) ? a.series : []).forEach(function(a) { b.initSeries(a) });
                        b.linkSeries();
                        b.setSeriesData();
                        Q(b, "beforeRender");
                ...
                a.prototype.warnIfA11yModuleNotLoaded = function() {
                    ...
                    setTimeout(function() {
                        var a = b && b.options;
                        !a || b.accessibility || a.accessibility &&
                            !1 === a.accessibility.enabled || L('Highcharts warning: Consider including the "accessibility.js" module to make your chart more usable for people with disabilities. Set the "accessibility.enabled" option to false to remove this warning. See https://www.highcharts.com/docs/accessibility/accessibility-module.', !1, b)
                    }, 100)
                };
                ...
                a.prototype.addAxis = function(b, a, c, d) { return this.createAxis(a ? "xAxis" : "yAxis", { axis: b, redraw: c, animation: d }) };
                a.prototype.addColorAxis = function(b, a, c) { return this.createAxis("colorAxis", { axis: b, redraw: a, animation: c }) };
                a.prototype.createAxis = function(b, a) {
                    b = new f(this, W(a.axis, { index: this[b].length, isX: "xAxis" === b }));
                ...
                a.prototype.showLoading = function(b) {
                    var a = this,
                        c = a.options,
                        d = c.loading,
                        e = function() { h && N(h, { left: a.plotLeft + "px", top: a.plotTop + "px", width: a.plotWidth + "px", height: a.plotHeight + "px" }) },
                        h = a.loadingDiv,
                        f = a.loadingSpan;
                    h || (a.loadingDiv = h = S("div", { className: "highcharts-loading highcharts-loading-hidden" }, null, a.container));
                    f || (a.loadingSpan = f = S("span", { className: "highcharts-loading-inner" }, null, h), r(a, "redraw", e));
                    h.className = "highcharts-loading";
                    g.setElementHTML(f, R(b, c.lang.loading, ""));
                    a.styledMode || (N(h, K(d.style, { zIndex: 10 })), N(f, d.labelStyle), a.loadingShown || (N(h, {
                        opacity: 0,
                        display: ""
                    }), t(h, { opacity: d.style.opacity || .5 }, { duration: d.showDuration || 0 })));
                    a.loadingShown = !0;
                    e()
                };
                a.prototype.hideLoading = function() {
                    var b = this.options,
                        a = this.loadingDiv;
                    a && (a.className = "highcharts-loading highcharts-loading-hidden", this.styledMode || t(a, { opacity: 0 }, { duration: b.loading.hideDuration || 100, complete: function() { N(a, { display: "none" }) } }));
                    this.loadingShown = !1
                };
                a.prototype.update = function(b, a, d, e) {
                    ...
                    if (p) {
                        ...
                        if ("inverted" in p || "polar" in p || "type" in p) { h.propFromSeries(); var G = !0 }
                        "alignTicks" in p && (G = !0);
                        "events" in p && x(this, p);
                        Z(p, function(b, a) {
                            -1 !== h.propsRequireUpdateSeries.indexOf("chart." + a) && (k = !0); - 1 !== h.propsRequireDirtyBox.indexOf(a) && (h.isDirtyBox = !0); - 1 !== h.propsRequireReflow.indexOf(a) && (f ? h.isDirtyBox = !0 : m = !0)
                        });
                    ...
                    Z(b, function(a, c) {
                        if (h[c] && "function" === typeof h[c].update) h[c].update(a, !1);
                        else if ("function" === typeof h[g[c]]) h[g[c]](a);
                        else "colors" !== c && -1 === h.collectionsWithUpdate.indexOf(c) && W(!0, h.options[c], b[c]);
                        "chart" !== c && -1 !== h.propsRequireUpdateSeries.indexOf(c) &&
                            (k = !0)
                    });
                    this.collectionsWithUpdate.forEach(function(a) {
                        if (b[a]) {
                            var c = [];
                            h[a].forEach(function(b, a) { b.options.isInternal || c.push(R(b.options.index, a)) });
                    ...
                    l.forEach(function(b) { b.chart && b.remove && b.remove(!1) });
                    G && h.axes.forEach(function(b) { b.update({}, !1) });
                    k && h.getSeriesOrderByLinks().forEach(function(b) { b.chart && b.update({}, !1) }, this);
                    G = p && p.width;
                    ...
                    Q(h, "afterUpdate", { options: b, redraw: a, animation: e })
                };
                ...
                a.prototype.showResetZoom = function() {
                    ...
                    Q(this, "beforeShowResetZoom", null, function() {
                        a.resetZoomButton = a.renderer.button(c.resetZoom, null, null, b, h).attr({ align: e.position.align, title: c.resetZoomTitle }).addClass("highcharts-reset-zoom").add().align(e.position, !1, g)
                    });
                    Q(this, "afterShowResetZoom")
                };
                a.prototype.zoomOut = function() { Q(this, "selection", { resetSelection: !0 }, this.zoom) };
                a.prototype.zoom = function(b) {
                    var a = this,
                        ...
                        e = !1,
                        h;
                    !b || b.resetSelection ? (a.axes.forEach(function(b) { h = b.zoom() }), c.initiated = !1) : b.xAxis.concat(b.yAxis).forEach(function(b) {
                        var g = b.axis,
                        ...
                        c[k ? "zoomX" : "zoomY"] && m && (h = g.zoom(b.min,
                ...
                a.prototype.pan = function(b, a) {
                    ...
                    Q(this, "pan", { originalEvent: b }, function() {
                        d && d.forEach(function(b) { b.setState() });
                        var a = c.xAxis;
                        ...
                        a.forEach(function(a) {
                            if (a.options.panningEnabled && !a.options.isInternal) {
                                ...
                                a.panningState = t;
                                a.isOrdinal || (m = p - k, 0 < m && (n += m, k = p), m = n - q, 0 < m && (n = q, k -= m), a.series.length && k !== G.min && n !== G.max && k >= p && n <= q && (a.setExtremes(k, n, !1, !1, { trigger: "pan" }), c.resetZoomButton || h || k === p || n === q || !g.match("y") || (c.showResetZoom(), a.displayBtn = !1), f = !0), e[d] = l)
                            }
                        });
                        Z(e, function(b, a) { c[a] = b });
                        f && c.redraw(!1);
    ...
    K(f, "Core/Legend/LegendSymbol.js", [f["Core/Utilities.js"]], function(a) {
        ...
        (function(a) {
            a.drawLineMarker = function(a) {
                ...
                p && !1 !== p.enabled && A && (w = Math.min(B(p.radius, n), n), 0 === this.symbol.indexOf("url") && (p = f(p, { width: u, height: u }), w = 0), this.legendSymbol = A = k.symbol(this.symbol, A / 2 - w, a - w, 2 * w, 2 * w, p).addClass("highcharts-point").add(e), A.isMarker = !0)
            };
            a.drawRectangle = function(a, f) {
                var w = a.symbolHeight,
                    u = a.options.squareSymbol;
                f.legendSymbol = this.chart.renderer.rect(u ? (a.symbolWidth - w) / 2 : 0, a.baseline - w + 1, u ? w : a.symbolWidth, w, B(a.options.symbolRadius, w / 2)).addClass("highcharts-point").attr({ zIndex: 3 }).add(f.legendGroup)
            }
        })(H ||
            (H = {}));
        return H
    ...
    K(f, "Core/Series/Series.js", [f["Core/Animation/AnimationUtilities.js"], f["Core/DefaultOptions.js"], f["Core/Foundation.js"], f["Core/Globals.js"], f["Core/Legend/LegendSymbol.js"], f["Core/Series/Point.js"], f["Core/Series/SeriesDefaults.js"], f["Core/Series/SeriesRegistry.js"], f["Core/Renderer/SVG/SVGElement.js"], f["Core/Utilities.js"]], function(a, f, B, H, w, E, I, A, u, n) {
        ...
        a = function() {
            ...
            a.prototype.init = function(b, a) {
                ...
                c.linkedSeries = [];
                c.bindAxes();
                v(c, { name: a.name, state: "", visible: !1 !== a.visible, selected: !0 === a.selected });
                p(this, a);
                var e = a.events;
                if (e && e.click || a.point && a.point.events && a.point.events.click || a.allowPointSelect) b.runTrackerClick = !0;
                c.getColor();
                c.getSymbol();
                c.parallelArrays.forEach(function(b) { c[b + "Data"] || (c[b + "Data"] = []) });
                c.isCartesian &&
            ...
            a.prototype.is = function(b) { return F[b] && this instanceof F[b] };
            a.prototype.insert = function(b) {
                var a = this.options.index,
                    c;
                if (N(a)) {
                    for (c = b.length; c--;)
                        if (a >= L(b[c].options.index, b[c]._i)) { b.splice(c + 1, 0, this); break } - 1 === c && b.unshift(this);
                    c +=
                        1
                } else b.push(this);
            ...
            a.prototype.updateParallelArrays = function(b,
                a) {
                var c = b.series,
                    d = arguments,
                    e = N(a) ? function(d) {
                        ...
                        c[d + "Data"][a] = e
                    } : function(b) { Array.prototype[a].apply(c[b + "Data"], Array.prototype.slice.call(d, 2)) };
                c.parallelArrays.forEach(e)
            };
            a.prototype.hasData = function() { return this.visible && "undefined" !== typeof this.dataMax && "undefined" !== typeof this.dataMin || this.visible && this.yData && 0 < this.yData.length };
            ...
            a.prototype.setDataSortingOptions = function() {
                var b = this.options;
                v(this, { requireSorting: !1, sorted: !1, enabledDataSorting: !0, allowDG: !1 });
                l(b.pointRange) ||
                    (b.pointRange = 1)
            };
            a.prototype.setOptions = function(b) {
                ...
                b = X(b);
                a = a.styledMode;
                var g = { plotOptions: e, userOptions: b };
                C(this, "setOptions", g);
                var f = g.plotOptions[this.type],
                    k = h.plotOptions || {};
                this.userOptions = g.userOptions;
                h = X(f, e.series, h.plotOptions && h.plotOptions[this.type], b);
                this.tooltipOptions = X(c.tooltip, c.plotOptions.series && c.plotOptions.series.tooltip, c.plotOptions[this.type].tooltip, d.tooltip.userOptions, e.series && e.series.tooltip,
                    e[this.type].tooltip, b.tooltip);
                ...
                !h.negativeColor && !h.negativeFillColor || h.zones || (d = { value: h[this.zoneAxis + "Threshold"] || h.threshold || 0, className: "highcharts-negative" }, a || (d.color = h.negativeColor, d.fillColor = h.negativeFillColor),
                    e.push(d));
                e.length && l(e[e.length - 1].value) && e.push(a ? {} : { color: this.color, fillColor: this.fillColor });
                C(this, "afterSetOptions", { options: h });
                return h
            };
            a.prototype.getName = function() { return L(this.options.name, "Series " + (this.index + 1)) };
            ...
            a.prototype.getColor = function() { this.chart.styledMode ? this.getCyclic("color") : this.options.colorByPoint ? this.color = "#cccccc" : this.getCyclic("color", this.options.color || c.plotOptions[this.type].color, this.chart.options.colors) };
            a.prototype.getPointsCollection = function() { return (this.hasGroupedData ? this.points : this.data) || [] };
            a.prototype.getSymbol = function() { this.getCyclic("symbol", this.options.marker.symbol, this.chart.options.symbols) };
            a.prototype.findPointIndex = function(b,
                a) {
                var c = b.id,
                    d = b.x,
                    e = this.points,
                    ...
                    g, f;
                if (c) h = this.chart.get(c), h instanceof E && (g = h);
                else if (this.linkedParent || this.enabledDataSorting || this.options.relativeXValue)
                    if (g = function(a) { return !a.touched && a.index === b.index }, h && h.matchByName ? g = function(a) { return !a.touched && a.name === b.name } : this.options.relativeXValue && (g = function(a) { return !a.touched && a.options.x === b.x }), g = r(e, g), !g) return;
                if (g) { var l = g && g.index; "undefined" !== typeof l && (f = !0) }
                "undefined" === typeof l && N(d) && (l = this.xData.indexOf(d,
                    a)); - 1 !== l && "undefined" !== typeof l && this.cropped && (l = l >= this.cropStart ? l - this.cropStart : l);
            ...
            a.prototype.updateData = function(b, a) {
                ...
                b.forEach(function(b, a) {
                    var m = l(b) && this.pointClass.prototype.optionsToObject.call({ series: this }, b) || {},
                        n = m.x;
                    if (m.id || N(n)) {
                        if (m = this.findPointIndex(m, p), -1 === m || "undefined" === typeof m ? h.push(b) :
                            e[m] && b !== c.data[m] ? (e[m].update(b, !1, null, !1), e[m].touched = !0, g && (p = m + 1)) : e[m] && (e[m].touched = !0), !f || a !== m || d && d.enabled || this.hasDerivedData) k = !0
                    } else h.push(b)
                }, this);
                if (k)
                    for (b = e.length; b--;)(m = e[b]) && !m.touched && m.remove && m.remove(!1, a);
                else !f || d && d.enabled ? n = !1 : (b.forEach(function(b, a) { b !== e[a].y && e[a].update && e[a].update(b, !1, null, !1) }), h.length = 0);
                e.forEach(function(b) { b && (b.touched = !1) });
                if (!n) return !1;
                h.forEach(function(b) { this.addPoint(b, !1, null, null, !1) }, this);
                null === this.xIncrement &&
                    this.xData && this.xData.length && (this.xIncrement = x(this.xData), this.autoIncrement());
                return !0
            };
            a.prototype.setData = function(b, a, c, d) {
                ...
                if (!t) {
                    e.xIncrement = null;
                    e.colorCounter = 0;
                    this.parallelArrays.forEach(function(b) { e[b + "Data"].length = 0 });
                    if (p && v > p)
                        if (x = e.getFirstValidPoint(b), N(x))
                            for (c = 0; c < v; c++) n[c] = this.autoIncrement(), q[c] = b[c];
                        else if (S(x))
                        if (r)
                            if (x.length === r)
                                for (c = 0; c < v; c++) n[c] = this.autoIncrement(), q[c] = b[c];
                            else
                                for (c = 0; c < v; c++) d = b[c], n[c] = d[0], q[c] = d.slice(1, r + 1);
                    else if (G && (y = G.indexOf("x"), z = G.indexOf("y"), y = 0 <= y ? y : 0, z = 0 <= z ? z : 1), 1 === x.length && (z = 0), y === z)
                        for (c = 0; c < v; c++) n[c] = this.autoIncrement(), q[c] = b[c][z];
                    else
                        for (c = 0; c < v; c++) d = b[c], n[c] = d[y], q[c] = d[z];
                    else D(12, !1, l);
                    else
                        for (c = 0; c < v; c++) "undefined" !== typeof b[c] && (d = { series: e }, e.pointClass.prototype.applyOptions.apply(d, [b[c]]), e.updateParallelArrays(d, c));
                    q && Y(q[0]) && D(14, !0, l);
                    e.data = [];
            ...
            a.prototype.sortData = function(b) {
                var a = this,
                    ...
                    d = function(b, a) { return l(a) && b.pointClass.prototype.optionsToObject.call({ series: b }, a) || {} };
                ...
                }).forEach(function(b, a) { b.x = a }, this);
            ...
            a.prototype.getProcessedData = function(b) {
                ...
                for (d = f.length || 1; --d;)
                    if (a = c ? b(f[d]) - b(f[d - 1]) : f[d] - f[d - 1], 0 < a && ("undefined" === typeof G || a < G)) var G = a;
                    else 0 > a && k && !m && (D(15, !1, this.chart), k = !1);
                return { xData: f, yData: l, cropped: r, cropStart: g, closestPointRange: G }
            };
            a.prototype.processData = function(b) {
                var a = this.xAxis;
                if (this.isCartesian &&
                    !this.isDirty && !a.isDirty && !this.yAxis.isDirty && !b) return !1;
            ...
            a.prototype.cropData = function(b, a, c, d, e) {
                ...
                for (g = 0; g < h; g++)
                    if (b[g] >= c) { f = Math.max(0, g - e); break }
                for (c = g; c < h; c++)
                    if (b[c] > d) { l = c + e; break }
                return {
                    xData: b.slice(f, l),
                    yData: a.slice(f,
                        l),
            ...
            a.prototype.generatePoints = function() {
                ...
                for (p = 0; p < h; p++) {
                    ...
                    if (f) {
                        ...
                        r.dataGroup.options &&
                            (r.options = r.dataGroup.options, v(r, r.dataGroup.options), delete r.dataLabels)
                    } else(r = n[q]) || "undefined" === typeof a[q] || (n[q] = r = (new e).init(this, a[q], c[p]));
                    r && (r.index = f ? b + p : q, k[p] = r)
                }
                this.options.keys = l;
                if (n && (h !== (m = n.length) || f))
                    for (p = 0; p < m; p++) p !== g || f || (p += h), n[p] && (n[p].destroyElements(), n[p].plotX = void 0);
                this.data = n;
                this.points = k;
                C(this, "afterGeneratePoints")
            };
            a.prototype.getXExtremes = function(b) { return { min: z(b), max: x(b) } };
            ...
            a.prototype.getFirstValidPoint = function(b) { for (var a = b.length, c = 0, d = null; null === d && c < a;) d = b[c], c++; return d };
            a.prototype.translate = function() {
                ...
                for (y = 0; y < k; y++) {
                    ...
                    if (!v.isNull && !1 !== v.visible) { "undefined" !== typeof I && (x = Math.min(x, Math.abs(z - I))); var I = z }
            ...
            a.prototype.getValidPoints = function(b, a, c) {
                var d = this.chart;
                return (b || this.points || []).filter(function(b) { return a && !d.isInsidePlot(b.plotX, b.plotY, { inverted: d.inverted }) ? !1 : !1 !== b.visible && (c || !b.isNull) })
            };
            ...
            a.prototype.getSharedClipKey = function() { return this.sharedClipKey = (this.options.xAxis || 0) + "," + (this.options.yAxis || 0) };
            ...
            a.prototype.animate = function(b) {
                var a = this.chart,
                    ...
                    f = a.sharedClips[g],
                    l = a.sharedClips[g + "m"];
                if (b && c) h = this.getClipBox(), f ? f.attr("height", h.height) : (h.width = 0, e && (h.x = a.plotHeight), f = a.renderer.clipRect(h),
                    a.sharedClips[g] = f, l = a.renderer.clipRect({ x: e ? (a.plotSizeX || 0) + 99 : -99, y: e ? -a.plotLeft : -a.plotTop, width: 99, height: e ? a.chartWidth : a.chartHeight }), a.sharedClips[g + "m"] = l), c.clip(f), d && d.clip(l);
            ...
            a.prototype.afterAnimate = function() {
                var b = this;
                this.setClip();
                J(this.chart.sharedClips, function(a, c, d) { a && !b.chart.container.querySelector('[clip-path="url(#' + a.id + ')"]') && (a.destroy(), delete d[c]) });
                ...
                if (!1 !== c.enabled || this._hasPointMarkers)
                    for (g = 0; g < b.length; g++) {
                        ...
                        if ((h && "undefined" === typeof m.enabled || m.enabled) && !l.isNull && !1 !== l.visible) {
                            ...
                            var r = !1 !== l.isInside;
                            f ? f[r ? "show" : "hide"](r).animate(q) : r && (0 < (q.width || 0) || l.hasImage) && (l.graphic = f = a.renderer.symbol(n, q.x, q.y, q.width, q.height, p ? m : c).add(d), this.enabledDataSorting &&
                                a.hasRendered && (f.attr({ x: l.startXPos }), k = "animate"));
            ...
            a.prototype.markerAttribs = function(b, a) {
                ...
                b.hasImage && (g = 0);
                b = N(g) ? { x: c.crisp ? Math.floor(b.plotX - g) : b.plotX - g, y: b.plotY - g } : {};
            ...
            a.prototype.pointAttribs = function(b, a) {
                ...
                b = L(a.lineWidth, c.lineWidth, b + L(a.lineWidthPlus, c.lineWidthPlus,
                    0));
            ...
            a.prototype.destroy = function(b) {
                ...
                for (f = h.length; f--;)(l = h[f]) &&
                    l.destroy && l.destroy();
                a.clips && a.clips.forEach(function(b) { return b.destroy() });
                n.clearTimeout(a.animationTimeout);
                J(a, function(b, a) { b instanceof u && !b.survive && (g = e && "group" === a ? "hide" : "destroy", b[g]()) });
                c.hoverSeries === a && (c.hoverSeries = void 0);
                d(c.series, a);
                c.orderSeries();
                J(a, function(c, d) { b && "hcEvents" === d || delete a[d] })
            };
            a.prototype.applyZones = function() {
                ...
                if (d.length && (h || g) && l && "undefined" !== typeof l.min) {
                    ...
                    d.forEach(function(d, G) {
                        ...
                        t = Math.min(p, n);
                        y = Math.max(p, n);
                        l.isXAxis ? (q = { x: k ? y : t, y: 0, width: r, height: f }, u || (q.x = a.plotHeight - q.x)) : (q = {
                            x: 0,
                            y: k ? y : t,
                            width: f,
                            height: r
                        }, u && (q.y = a.plotWidth - q.y));
                        k && c.isVML && (q = l.isXAxis ? { x: 0, y: F ? t : y, height: q.width, width: a.chartWidth } : { x: q.y - a.plotLeft - a.spacingBox.x, y: 0, width: q.height, height: a.chartHeight });
            ...
            a.prototype.plotGroup = function(b, a, c, d, e) {
                ...
                h.addClass("highcharts-" +
                    a + " highcharts-series-" + this.index + " highcharts-" + this.type + "-series " + (l(this.colorIndex) ? "highcharts-color-" + this.colorIndex + " " : "") + (this.options.className || "") + (h.hasClass("highcharts-tracker") ? " highcharts-tracker" : ""), !0);
            ...
            a.prototype.getPlotBox = function() {
                ...
                return { translateX: a ? a.left : b.plotLeft, translateY: c ? c.top : b.plotTop, scaleX: 1, scaleY: 1 }
            };
            a.prototype.removeEvents =
                function(b) {
                    b || K(this);
                    this.eventsToUnbind.length && (this.eventsToUnbind.forEach(function(b) { b() }), this.eventsToUnbind.length = 0)
                };
            a.prototype.render = function() {
                var b = this,
                    a = b.chart,
                ...
                g || (a && d.defer && (a += d.defer), b.animationTimeout = Q(function() { b.afterAnimate() }, a || 0));
                b.isDirty = !1;
                b.hasRendered = !0;
                C(b, "afterRender")
            };
            a.prototype.redraw = function() {
                var b = this.chart,
                    ...
                    d = this.xAxis,
                    e = this.yAxis;
                c && (b.inverted && c.attr({ width: b.plotWidth, height: b.plotHeight }), c.animate({ translateX: L(d && d.left, b.plotLeft), translateY: L(e && e.top, b.plotTop) }));
                this.translate();
                this.render();
            ...
            a.prototype.searchPoint = function(b, a) {
                ...
                return this.searchKDTree({ clientX: e ? c.len - b.chartY + c.pos : b.chartX - c.pos, plotY: e ? d.len - b.chartX + d.pos : b.chartY - d.pos }, a, b)
            };
            a.prototype.buildKDTree = function(b) {
                function a(b,
                    ...
                    if (h) {
                        ...
                        b.sort(function(b, a) { return b[g] - a[g] });
                        h = Math.floor(h / 2);
                        return { point: b[h], left: a(b.slice(0, h), d + 1, e), right: a(b.slice(h + 1), d + 1, e) }
                    }
                }
            ...
            a.prototype.searchKDTree = function(b, a, c) {
                ...
                var e = this,
                    ...
                    f = a ? "distX" : "dist";
                a = -1 < e.options.findNearestPointBy.indexOf("y") ?
                    2 : 1;
            ...
            a.prototype.isPointInside = function(b) {
                var a = this.chart,
                    c = this.xAxis,
                    d = this.yAxis;
                return "undefined" !== typeof b.plotY && "undefined" !== typeof b.plotX && 0 <= b.plotY && b.plotY <= (d ? d.len : a.plotHeight) && 0 <= b.plotX && b.plotX <= (c ?
                    c.len : a.plotWidth)
            };
            a.prototype.drawTracker = function() {
                var b = this,
                    ...
                    k = b.tracker,
                    m = function(a) { if (e.hoverSeries !== b) b.onMouseOver() },
                    p = "rgba(192,192,192," + (t ? .0001 : .002) + ")";
                k ? k.attr({ d: d }) : b.graph && (b.tracker = f.path(d).attr({ visibility: b.visible ? "inherit" : "hidden", zIndex: 2 }).addClass(c ? "highcharts-tracker-area" : "highcharts-tracker-line").add(b.group), e.styledMode || b.tracker.attr({
                    "stroke-linecap": "round",
                    "stroke-linejoin": "round",
                    stroke: p,
                    fill: c ? p : "none",
                    "stroke-width": b.graph.strokeWidth() + (c ? 0 : 2 * l)
                }), [b.tracker, b.markerGroup, b.dataLabelsGroup].forEach(function(b) { if (b && (b.addClass("highcharts-tracker").on("mouseover", m).on("mouseout", function(b) { h.onTrackerMouseOut(b) }), a.cursor && !e.styledMode && b.css({ cursor: a.cursor }), g)) b.on("touchstart", m) }));
            ...
            a.prototype.addPoint = function(b, a, c, d, e) {
                ...
                c && (g[0] && g[0].remove ? g[0].remove(!1) : (g.shift(), this.updateParallelArrays(n,
                    "shift"), k.shift()));
            ...
            a.prototype.removePoint = function(b, a, c) {
                var d = this,
                    ...
                    k = function() {
                        ...
                        d.updateParallelArrays(g || { series: d }, "splice", b, 1);
                        g && g.destroy();
                        d.isDirty = !0;
                        d.isDirtyData = !0;
                        a && l.redraw()
            ...
            a.prototype.update = function(b, a) {
                ...
                var c = this,
                    ...
                    l = F[g].prototype,
                    k = c.finishedAnimating && { animation: !1 },
                    m = {},
                    p, n = ["eventOptions", "navigatorSeries", "baseSeries"],
                    q = b.type || e.type || d.options.chart.type,
                    r = !(this.hasDerivedData || q && q !== this.type || "undefined" !==
                        typeof b.pointStart || "undefined" !== typeof b.pointInterval || "undefined" !== typeof b.relativeXValue || b.joinBy || b.mapData || c.hasOptionChanged("dataGrouping") || c.hasOptionChanged("pointStart") || c.hasOptionChanged("pointInterval") || c.hasOptionChanged("pointIntervalUnit") || c.hasOptionChanged("keys"));
                q = q || g;
                r && (n.push("data", "isDirtyData", "points", "processedData", "processedXData", "processedYData", "xIncrement", "cropped", "_hasPointMarkers", "_hasPointLabels", "clips", "nodes", "layout", "level", "mapMap", "mapData",
                    "minY", "maxY", "minX", "maxX"), !1 !== b.visible && n.push("area", "graph"), c.parallelArrays.forEach(function(b) { n.push(b + "Data") }), b.data && (b.dataSorting && v(c.options.dataSorting, b.dataSorting), this.setData(b.data, !1)));
                b = X(e, k, { index: "undefined" === typeof e.index ? c.index : e.index, pointStart: L(f && f.series && f.series.pointStart, e.pointStart, c.xData[0]) }, !r && { data: c.options.data }, b);
                ...
                if (F[q]) {
                    if (f = q !== c.type, c.remove(!1, !1, !1, !0), f)
                        if (Object.setPrototypeOf) Object.setPrototypeOf(c, F[q].prototype);
                        else {
                ...
                } else D(17, !0, d, { missingModuleFor: q });
                n.forEach(function(b) { c[b] = n[b] });
                c.init(d, b);
                if (r && this.points) {
                    var t = c.options;
                    !1 === t.visible ? (m.graphic = 1, m.dataLabel = 1) : c._hasPointLabels || (b = t.marker, l = t.dataLabels, !b || !1 !== b.enabled &&
                        (e.marker && e.marker.symbol) === b.symbol || (m.graphic = 1), l && !1 === l.enabled && (m.dataLabel = 1));
                    this.points.forEach(function(b) { b && b.series && (b.resolveColor(), Object.keys(m).length && b.destroyElements(m), !1 === t.showInLegend && b.legendItem && d.legend.destroyItem(b)) }, this)
                }
                c.initialType = g;
                d.linkSeries();
            ...
            a.prototype.onMouseOut = function() {
                ...
                a.series.forEach(function(b) { b.setState("", !0) })
            };
            a.prototype.setState = function(b, a) {
                ...
                if (c.state !== b && ([c.group, c.markerGroup, c.dataLabelsGroup].forEach(function(a) {
                    ...
                    if (e && !e.dashstyle)
                        for (d = { "stroke-width": l }, e.animate(d, f); c["zone-graph-" + k];) c["zone-graph-" + k].animate(d, f), k += 1;
                    h || [c.group, c.markerGroup, c.dataLabelsGroup, c.labelBySeries].forEach(function(b) { b && b.animate({ opacity: m }, f) })
                }
                a && h && c.points && c.setAllPointsToState(b || void 0)
            };
            a.prototype.setAllPointsToState = function(b) { this.points.forEach(function(a) { a.setState && a.setState(b) }) };
            a.prototype.setVisible = function(b, a) {
                ...
                ["group", "dataLabelsGroup", "markerGroup", "tracker", "tt"].forEach(function(b) { if (c[b]) c[b][f]() });
                if (d.hoverSeries === c || (d.hoverPoint && d.hoverPoint.series) === c) c.onMouseOut();
                e &&
                    d.legend.colorizeItem(c, b);
                c.isDirty = !0;
                c.options.stacking && d.series.forEach(function(b) { b.options.stacking && b.visible && (b.isDirty = !0) });
                c.linkedSeries.forEach(function(a) { a.setVisible(b, !1) });
                h && (d.isDirtyBox = !0);
                C(c, f);
                !1 !== a && d.redraw()
            };
            a.prototype.show = function() { this.setVisible(!0) };
            a.prototype.hide = function() { this.setVisible(!1) };
        ...
        v(a.prototype, { axisTypes: ["xAxis", "yAxis"], coll: "series", colorCounter: 0, cropShoulder: 1, directTouch: !1, drawLegendSymbol: w.drawLineMarker, isCartesian: !0, kdAxisArray: ["clientX", "plotY"], parallelArrays: ["x", "y"], pointClass: E, requireSorting: !0, sorted: !0 });
        A.series = a;
        "";
        "";
        return a
    ...
    K(f, "Extensions/ScrollablePlotArea.js", [f["Core/Animation/AnimationUtilities.js"], f["Core/Axis/Axis.js"], f["Core/Chart/Chart.js"], f["Core/Series/Series.js"], f["Core/Renderer/RendererRegistry.js"], f["Core/Utilities.js"]], function(a, f, B, H, w, E) {
        ...
        A(B, "afterSetChartSize", function(a) {
            ...
            if (!this.renderer.forExport) {
                ...
                } else c && (this.scrollablePixelsY = e = Math.max(0, c - this.chartHeight)) && (this.scrollablePlotBox = this.renderer.scrollablePlotBox = n(this.plotBox), this.plotBox.height = this.plotHeight += e, this.inverted ? this.clipBox.width += e : this.clipBox.height += e, g = { 2: { name: "bottom", value: e } });
        ...
        B.prototype.setUpScrolling = function() {
            var a = this,
                c = { WebkitOverflowScrolling: "touch", overflowX: "hidden", overflowY: "hidden" };
            this.scrollablePixelsX && (c.overflowX =
                "auto");
        ...
        B.prototype.moveFixedElements = function() {
            var a = this.container,
                ...
                g;
            this.scrollablePixelsX && !this.inverted ? g = ".highcharts-yaxis" : this.scrollablePixelsX &&
                this.inverted ? g = ".highcharts-xaxis" : this.scrollablePixelsY && !this.inverted ? g = ".highcharts-xaxis" : this.scrollablePixelsY && this.inverted && (g = ".highcharts-yaxis");
        ...
        A(f, "afterInit", function() { this.chart.scrollableDirty = !0 });
        A(H, "show", function() { this.chart.scrollableDirty = !0 });
        ""
    });
    K(f, "Core/Axis/StackingAxis.js", [f["Core/Animation/AnimationUtilities.js"], f["Core/Axis/Axis.js"], f["Core/Utilities.js"]], function(a, f, B) {
        ...
        (function(a) {
            ...
            function c() { this.stacking || (this.stacking = new g(this)) }
            var f = [];
            a.compose = function(a) {-1 === f.indexOf(a) && (f.push(a), w(a, "init", c), w(a, "destroy", e)); return a };
            var g = function() {
                function a(a) {
                    this.oldStacks = {};
                    this.stacks = {};
                ...
                a.prototype.cleanStacks = function() {
                    if (!this.axis.isXAxis) {
                        ...
                        u(a, function(a) { u(a, function(a) { a.cumulative = a.total }) })
                    }
                };
                a.prototype.resetStacks = function() {
                    ...
                    a.axis.isXAxis || u(c, function(c) {
                        u(c, function(e, g) {
                            A(e.touched) && e.touched < a.stacksTouched ? (e.destroy(), delete c[g]) : (e.total = null, e.cumulative =
                                null)
                        })
                    })
                };
                a.prototype.renderStackTotals = function() {
                    ...
                    var f = this.stackTotalGroup = this.stackTotalGroup || e.g("stack-labels").attr({ zIndex: 6, opacity: 0 }).add();
                    f.translate(c.plotLeft, c.plotTop);
                    u(g, function(a) { u(a, function(a) { a.render(f) }) });
                    f.animate({ opacity: 1 }, a)
                };
                return a
            }();
            a.Additions = g
    ...
    K(f, "Extensions/Stacking.js", [f["Core/Axis/Axis.js"], f["Core/Chart/Chart.js"],
        f["Core/FormatUtilities.js"], f["Core/Globals.js"], f["Core/Series/Series.js"], f["Core/Axis/StackingAxis.js"], f["Core/Utilities.js"]
        ...
        var A = B.format,
            ...
            t = function() {
                function a(a, c, e, g, f) {
                    ...
                    this.alignOptions = { align: c.align || (h ? e ? "left" : "right" : "center"), verticalAlign: c.verticalAlign || (h ? "middle" : e ? "bottom" : "top"), y: c.y, x: c.x };
                    this.textAlign = c.textAlign || (h ? e ? "right" : "left" : "center")
                }
                a.prototype.destroy = function() { k(this, this.axis) };
                a.prototype.render = function(a) {
                    var c = this.axis.chart,
                        e = this.options,
                        f = e.format;
                    f = f ? A(f, this, c) : e.formatter.call(this);
                    this.label ? this.label.attr({ text: f, visibility: "hidden" }) : (this.label = c.renderer.label(f, null, null, e.shape, null, null, e.useHTML, !1, "stack-labels"), f = {
                        r: e.borderRadius ||
                            0,
                        text: f,
                        rotation: e.rotation,
                ...
                a.prototype.setOffset = function(a, e, f, k, m) {
                    ...
                    h =
                        n(k) && this.getStackBox(b, this, a, k, e, f, h);
                    e = this.label;
                    f = this.isNegative;
                    ...
                    e && h && (m = e.getBBox(), k = e.padding, l = "left" === l ? b.inverted ? -k : k : "right" === l ? m.width : b.inverted && "center" === l ? m.width / 2 : b.inverted ? f ? m.width + k : -k : m.width / 2, f = b.inverted ? m.height / 2 : f ? -k : m.height, this.alignOptions.x = g(this.options.x, 0), this.alignOptions.y = g(this.options.y, 0), h.x -= l, h.y -= f, e.align(this.alignOptions, null, h), b.isInsidePlot(e.alignAttr.x + l - this.alignOptions.x,
                        e.alignAttr.y + f - this.alignOptions.y) ? e.show() : (e.hide(), a = !1), a && w.prototype.justifyDataLabel.call(this.axis, e, this.alignOptions, e.alignAttr, m, h), e.attr({ x: e.alignAttr.x, y: e.alignAttr.y }), g(!a && this.options.crop, !0) && ((b = c(e.x) && c(e.y) && b.isInsidePlot(e.x - k + e.width, e.y) && b.isInsidePlot(e.x + k, e.y)) || e.hide()))
                };
                a.prototype.getStackBox = function(a, c, e, g, f, h, b) {
                    ...
                    return {
                        x: d ? c ? g - b.right : g - h +
                            b.pos - a.plotLeft : e + a.xAxis[0].transB - a.plotLeft,
        ...
        f.prototype.getStacks = function() {
            ...
            a.series.forEach(function(e) {
                ...
                !e.options.stacking || !0 !== e.visible && !1 !== a.options.chart.ignoreHiddenSeries || (e.stackKey = [e.type, g(e.options.stack, ""), c ? f.top : f.left, c ? f.height :
                    f.width
                ].join())
            })
        };
        ...
        w.prototype.setGroupedPoints = function() {
            ...
            this.options.centerInCategory && (this.is("column") || this.is("columnrange")) && !this.options.stacking && 1 < this.chart.series.length ? w.prototype.setStackedPoints.call(this, "group") : a && p(a.stacks, function(c, e) { "group" === e.slice(-5) && (p(c, function(a) { return a.destroy() }), delete a.stacks[e]) })
        };
        w.prototype.setStackedPoints = function(a) {
            ...
            if (c && (!0 === this.visible || !1 === this.chart.options.chart.ignoreHiddenSeries)) {
                ...
                for (C = 0; C < m; C++) {
                    ...
                    r[E] || (r[E] = {});
                    r[E][B] || (w[E] && w[E][B] ? (r[E][B] = w[E][B], r[E][B].total = null) : r[E][B] = new t(v, v.options.stackLabels,
                        A, B, h));
                    E = r[E][B];
                    ...
                    "percent" === c ? (A = A ? a : d, q && r[A] && r[A][B] ? (A = r[A][B], E.total = A.total = Math.max(A.total, E.total) + Math.abs(H) || 0) : E.total = u(E.total + (Math.abs(H) || 0))) : "group" === c ? (e(H) && (H = H[0]), null !== H && (E.total = (E.total || 0) + 1)) : E.total = u(E.total + (H ||
                        0));
        ...
        w.prototype.modifyStacks = function() {
            var a = this,
                ...
                g = a.processedXData,
                f, k = a.options.stacking;
            a[k + "Stacker"] && [c, "-" + c].forEach(function(c) {
                for (var b = g.length, h, d; b--;)
                    if (h = g[b], f = a.getStackIndicator(f, h, a.index,
                            c), d = (h = e[c] && e[c][h]) && h.points[f.key]) a[k + "Stacker"](d, h, b)
            })
        };
        ...
        w.prototype.getStackIndicator = function(a, c, e, g) {
            !n(a) || a.x !== c || g && a.stackKey !== g ? a = { x: c, index: 0, key: g, stackKey: g } : a.index++;
    ...
    K(f, "Series/Line/LineSeries.js", [f["Core/Series/Series.js"], f["Core/Series/SeriesRegistry.js"], f["Core/Utilities.js"]],
        function(a, f, B) {
            var C = this && this.__extends || function() {
                    var a = function(f, u) {
                        a = Object.setPrototypeOf || { __proto__: [] }
                        instanceof Array && function(a, f) { a.__proto__ = f } || function(a, f) { for (var e in f) f.hasOwnProperty(e) && (a[e] = f[e]) };
                        return a(f, u)
                    };
                    return function(f, u) {
                        function n() { this.constructor = f }
                        a(f, u);
            ...
            B = function(f) {
                ...
                A.prototype.drawGraph = function() {
                    ...
                    c.forEach(function(c, g) {
                        var p = c[0],
                            n = a[p],
                            u = n ? "animate" : "attr";
                        n ? (n.endX = a.preventGraphAnimation ? null : k.xMap, n.animate({ d: k })) : k.length && (a[p] = n = a.chart.renderer.path(k).addClass(c[1]).attr({ zIndex: 1 }).add(a.group));
                        n && !e && (p = {
                            stroke: c[2],
                ...
                A.prototype.getGraphPath = function(a, f, k) {
                    ...
                    var u = a.reversed;
                    u && a.reverse();
                    (q = { right: 1, center: 2 }[q] || q && 3) && u && (q = 4 - q);
                    ...
                    a.forEach(function(t, x) {
                        ...
                        t.isNull && !w(f) && 0 < x ? n = !c.connectNulls : t.isNull && !f ? n = !0 : (0 === x || n ? x = [
                            ["M", t.plotX, t.plotY]
                        ] : e.getPointSpline ? x = [e.getPointSpline(a, t, x)] : q ? (x = 1 === q ? [
                            ["L", h.plotX, m]
                        ] : 2 === q ? [
                            ["L", (h.plotX + z) / 2, h.plotY],
                            ["L", (h.plotX + z) / 2, m]
                        ] : [
                            ["L", z, h.plotY]
                        ], x.push(["L", z, m])) : x = [
                            ["L", z, m]
                        ], g.push(t.x), q && (g.push(t.x), 2 === q && g.push(t.x)), p.push.apply(p, x), n = !1)
                    });
                    p.xMap = g;
    ...
    K(f, "Series/Area/AreaSeries.js", [f["Core/Color/Color.js"], f["Core/Legend/LegendSymbol.js"], f["Core/Series/SeriesRegistry.js"], f["Core/Utilities.js"]], function(a, f, B, H) {
        ...
        H = function(a) {
            ...
            e.prototype.drawGraph = function() {
                ...
                this.zones.forEach(function(a, e) { k.push(["zone-area-" + e, "highcharts-area highcharts-zone-area-" + e + " " + a.className, a.color || c.color, a.fillColor || f.fillColor]) });
                k.forEach(function(a) {
                    var g = a[0],
                        k = c[g],
                        p = k ? "animate" : "attr",
                        q = {};
                    k ? (k.endX = c.preventGraphAnimation ? null : e.xMap, k.animate({ d: e })) : (q.zIndex =
                        0, k = c[g] = c.chart.renderer.path(e).addClass(a[1]).add(c.group), k.isArea = !0);
            ...
            e.prototype.getGraphPath = function(a) {
                ...
                var l = function(c, d, e) {
                    ...
                    "undefined" !== typeof p && (x.push({ plotX: D, plotY: null === p ? b : k.getThreshold(p), isNull: g, isCliff: !0 }), y.push({ plotX: D, plotY: null === n ? b : k.getThreshold(n), doCurve: !1 }))
                };
                a = a || this.points;
                ...
                for (u = 0; u < a.length; u++) {
                    ...
                    if (!d || e) e || l(u, u - 1, "left"), d && !f && e || (x.push(a[u]), y.push({ x: u, plotX: D, plotY: v })), e || l(u, u + 1, "right")
                }
                u = c.call(this, x, !0, !0);
                y.reversed = !0;
                d = c.call(this, y, !0, !0);
            ...
            e.prototype.getStackPoints = function(a) {
                ...
                if (this.options.stacking) {
                    ...
                    u(y, function(b, a) { null !== b.total && f.push(a) });
                    f.sort(function(b, a) { return b - a });
                    var d = z.map(function(b) { return b.visible });
                        ...
                        if (x[a] && !x[a].isNull) e.push(x[a]), [-1, 1].forEach(function(e) {
                            ...
                            if (n)
                                for (var r = b; 0 <= r && r < m;) {
                                    var t = z[r].index;
                                    p = n.points[t];
                                    p || (t === c.index ? x[a][l] = !0 : d[r] &&
                                        (q = y[a].points[t]) && (k -= q[1] - q[0]));
                                    r += h
                                }
                            ...
                            for (var t = b; 0 <= t && t < m;) {
                                if (p = y[a].points[z[t].index]) { l = p[1]; break }
                                t += h
                            }
                            l = n(l, 0);
                            l = w.translate(l, 0, 1, 0, 1);
                            e.push({ isNull: !0, plotX: k.translate(a, 0, 0, 0, 1), x: a, plotY: l, yBottom: l })
                        }
                    })
                }
                return e
        ...
        a(H.prototype, { singleStacks: !1, drawLegendSymbol: f.drawRectangle });
        B.registerSeriesType("area", H);
        "";
        return H
    });
    K(f, "Series/Spline/SplineSeries.js", [f["Core/Series/SeriesRegistry.js"],
        f["Core/Utilities.js"]
    ], function(a, f) {
        var C = this && this.__extends || function() {
                var a = function(f, u) {
        ...
        f = function(a) {
            ...
            f.prototype.getPointSpline = function(a, f, k) {
                ...
                if (p && !p.isNull && !1 !== p.doCurve && !f.isCliff && k && !k.isNull && !1 !== k.doCurve && !f.isCliff) {
                    ...
                    y > k &&
                        y > c ? (y = Math.max(k, c), u = 2 * c - y) : y < k && y < c && (y = Math.min(k, c), u = 2 * c - y);
                    f.rightContX = g;
                    f.rightContY = y
                }
    ...
    K(f, "Series/AreaSpline/AreaSplineSeries.js", [f["Series/Area/AreaSeries.js"], f["Series/Spline/SplineSeries.js"], f["Core/Legend/LegendSymbol.js"], f["Core/Series/SeriesRegistry.js"], f["Core/Utilities.js"]],
        function(a, f, B, H, w) {
            var C = this && this.__extends || function() {
                    var a = function(f, e) {
                        a = Object.setPrototypeOf || { __proto__: [] }
                        instanceof Array && function(a, e) { a.__proto__ = e } || function(a, e) { for (var c in e) e.hasOwnProperty(c) && (a[c] = e[c]) };
                        return a(f, e)
                    };
                    return function(f, e) {
            ...
            A(w.prototype, { getGraphPath: I.getGraphPath, getStackPoints: I.getStackPoints, drawGraph: I.drawGraph, drawLegendSymbol: B.drawRectangle });
            H.registerSeriesType("areaspline", w);
            "";
            return w
        });
    K(f, "Series/Column/ColumnSeries.js", [f["Core/Animation/AnimationUtilities.js"], f["Core/Color/Color.js"], f["Core/Globals.js"], f["Core/Legend/LegendSymbol.js"], f["Core/Series/Series.js"], f["Core/Series/SeriesRegistry.js"],
        f["Core/Utilities.js"]
    ], function(a, f, B, H, w, E, I) {
        var C = this && this.__extends || function() {
                var a = function(c, b) {
                    a = Object.setPrototypeOf || { __proto__: [] }
                    instanceof Array && function(b, a) { b.__proto__ = a } || function(b, a) { for (var c in a) a.hasOwnProperty(c) && (b[c] = a[c]) };
                    return a(c, b)
                };
                return function(c, b) {
                    function e() { this.constructor = c }
                    a(c, b);
        ...
        I = function(a) {
            ...
            f.prototype.animate = function(b) {
                ...
                if (b) k.scaleY = .001, b = e(c.toPixels(f.threshold), c.pos, c.pos + c.len), h ? k.translateX = b - c.len : k.translateY = b, a.clipBox && a.setClip(), a.group.attr(k);
                else {
                    var p =
                        Number(a.group.attr(m));
                    a.group.animate({ scaleY: 1 }, g(u(a.options.animation), { step: function(b, d) { a.group && (k[m] = p + d.pos * (c.pos - p), a.group.attr(k)) } }))
                }
            };
            f.prototype.init = function(b, c) {
                ...
                var d = this;
                b = d.chart;
                b.hasRendered && b.series.forEach(function(b) { b.type === d.type && (b.isDirty = !0) })
            };
            f.prototype.getColumnMetrics = function() {
                ...
                !1 === a.grouping ? k = 1 : b.chart.series.forEach(function(a) {
                    ...
                    if (a.type === b.type && (a.visible || !b.chart.options.chart.ignoreHiddenSeries) && e.len === c.len && e.pos === c.pos) {
                        if (d.stacking && "group" !== d.stacking) { g = a.stackKey; "undefined" === typeof h[g] && (h[g] = k++); var f = h[g] } else !1 !== d.grouping && (f = k++);
                        a.columnIndex = f
                    }
                });
                ...
                b.columnMetrics = { width: a, offset: (n - a) / 2 + (p + ((b.columnIndex || 0) + (f ? 1 : 0)) * n - m / 2) * (f ? -1 : 1), paddedWidth: n, columnCount: k };
            ...
            f.prototype.adjustForMissingColumns = function(b,
                a, c, e) {
                var d = this,
            ...
            f.prototype.translate = function() {
                var b = this,
                    a = b.chart,
                    c = b.options,
                    f = b.dense = 2 > b.closestPointRange *
                    b.xAxis.transA;
                ...
                b.points.forEach(function(d) {
                    ...
                    d.barX = A;
                    d.pointWidth = D;
                    d.tooltipPos = a.inverted ? [e(g.len + g.pos - a.plotLeft - l, g.pos - a.plotLeft, g.len + g.pos - a.plotLeft), h.len + h.pos - a.plotTop - A - B / 2, w] : [h.left - a.plotLeft + A +
                        B / 2, e(l + g.pos - a.plotTop, g.pos - a.plotTop, g.len + g.pos - a.plotTop), w
                    ];
                    d.shapeType = b.pointClass.prototype.shapeType || "rect";
                    d.shapeArgs = b.crispCol.apply(b, d.isNull ? [A, m, B, 0] : [A, v, B, w])
                })
            };
            f.prototype.drawGraph = function() { this.group[this.dense ? "addClass" : "removeClass"]("highcharts-dense-data") };
            f.prototype.pointAttribs = function(b, a) {
                ...
                f = { fill: g, stroke: l, "stroke-width": k, opacity: m };
                e && (f.dashstyle =
                    e);
                return f
            };
            f.prototype.drawPoints = function() {
                ...
                b.points.forEach(function(d) {
                    ...
                    if (F(d.plotY) && null !== d.y) {
                        ...
                        g || (d.graphic = g = e[d.shapeType](h).add(d.group || b.group)) && b.enabledDataSorting && a.hasRendered && a.pointCount < f && (g.attr({ x: d.startXPos }),
                            l = !0, k = "animate");
                        if (g && l) g[k](y(h));
                        if (c.borderRadius) g[k]({ r: c.borderRadius });
            ...
            f.prototype.drawTracker = function() {
                var b = this,
                    a = b.chart,
                    d = a.pointer,
                    e = function(b) { var a = d.getPointFromEvent(b); "undefined" !== typeof a && (d.isDirectTouch = !0, a.onMouseOver(b)) },
                    f;
                b.points.forEach(function(b) {
                    f = q(b.dataLabels) ? b.dataLabels : b.dataLabel ? [b.dataLabel] : [];
                    b.graphic && (b.graphic.element.point = b);
                    f.forEach(function(a) { a.div ? a.div.point = b : a.element.point = b })
                });
                b._hasTracking || (b.trackerGroups.forEach(function(f) { if (b[f]) { b[f].addClass("highcharts-tracker").on("mouseover", e).on("mouseout", function(b) { d.onTrackerMouseOut(b) }); if (k) b[f].on("touchstart", e);!a.styledMode && b.options.cursor && b[f].css(c).css({ cursor: b.options.cursor }) } }), b._hasTracking = !0);
                t(this, "afterDrawTracker")
            };
            f.prototype.remove = function() {
                var b = this,
                    a = b.chart;
                a.hasRendered && a.series.forEach(function(a) { a.type === b.type && (a.isDirty = !0) });
        ...
        g(I.prototype, { cropShoulder: 0, directTouch: !0, drawLegendSymbol: H.drawRectangle, getSymbol: a, negStacks: !0, trackerGroups: ["group", "dataLabelsGroup"] });
        ...
        (function(a) {
            function f(a, b, c, d, f) {
                var h = this,
                    ...
                    n = c.rotation,
                    q = c.align,
                    t = E(m) && E(p) && g.isInsidePlot(m, Math.round(p), { inverted: l, paneCoordinates: !0, series: h }),
                    z = function(c) { k && h.xAxis && !u && h.setDataLabelStartPos(a, b, f, t, c) },
                    u = "justify" === e(c.overflow, k ? "none" : "justify"),
                    x = this.visible && !1 !== a.visible && (a.series.forceDL || k && !u || t || e(c.inside, !!this.options.stacking) && d && g.isInsidePlot(m, l ? d.x + 1 : d.y + d.height - 1, { inverted: l, paneCoordinates: !0, series: h }));
                if (x && E(m) && E(p)) {
                    n && b.attr({ align: q });
                    q = b.getBBox(!0);
                    var y = [0, 0];
                    var w = g.renderer.fontMetrics(g.styledMode ? void 0 : c.style.fontSize, b).b;
                    d = I({ x: l ? this.yAxis.len - p : m, y: Math.round(l ? this.xAxis.len - m : p), width: 0, height: 0 }, d);
                    I(c, { width: q.width, height: q.height });
                    n ? (u = !1, y = g.renderer.rotCorr(w, n), m = { x: d.x + (c.x || 0) + d.width / 2 + y.x, y: d.y + (c.y || 0) + { top: 0, middle: .5, bottom: 1 }[c.verticalAlign] * d.height },
                        y = [q.x - Number(b.attr("x")), q.y - Number(b.attr("y"))], z(m), b[f ? "attr" : "animate"](m)) : (z(d), b.align(c, void 0, d), m = b.alignAttr);
                    u && 0 <= d.height ? this.justifyDataLabel(b, c, m, q, d, f) : e(c.crop, !0) && (d = m.x, z = m.y, d += y[0], z += y[1], x = g.isInsidePlot(d, z, { paneCoordinates: !0, series: h }) && g.isInsidePlot(d + q.width, z + q.height, { paneCoordinates: !0, series: h }));
                    if (c.shape && !n) b[f ? "attr" : "animate"]({ anchorX: l ? g.plotWidth - a.plotY : a.plotX, anchorY: l ? g.plotHeight - a.plotX : a.plotY })
                }
                f && k && (b.placed = !1);
                x || k && !u ? b.show() : (b.hide(),
                    b.placed = !1)
            ...
            function g(a, b) { var c = b.filter; return c ? (b = c.operator, a = a[c.property], c = c.value, ">" === b && a > c || "<" === b && a < c || ">=" === b && a >= c || "<=" === b && a <= c || "==" === b && a == c || "===" === b && a === c ? !0 : !1) : !0 }
            ...
            function p() {
                var a = this,
                    ...
                    n = f.dataLabels,
                    q, t = n.animation;
                t = n.defer ? C(b, t, a) : { defer: 0, duration: 0 };
                n = x(x(b.options.plotOptions && b.options.plotOptions.series && b.options.plotOptions.series.dataLabels, b.options.plotOptions && b.options.plotOptions[a.type] &&
                    b.options.plotOptions[a.type].dataLabels), n);
                ...
                if (u(n) || n.enabled || a._hasPointLabels) {
                    ...
                    z.attr({ opacity: +m });
                    !m && (m = a.dataLabelsGroup) && (a.visible && z.show(), m[f.animation ? "animate" : "attr"]({ opacity: 1 }, t));
                    d.forEach(function(d) {
                        ...
                        q.forEach(function(c, h) {
                            ...
                            if (l) {
                                ...
                                var x = { r: c.borderRadius || 0, rotation: u, padding: c.padding, zIndex: 1 };
                                b.styledMode || (x.fill = c.backgroundColor, x.stroke = c.borderColor, x["stroke-width"] = c.borderWidth);
                                k(x, function(b, a) { "undefined" === typeof b && delete x[a] })
                            }!n || l && E(t) && !!n.div === !!c.useHTML && (n.rotation && c.rotation || n.rotation === c.rotation) || (q = !0, d.dataLabel = n = d.dataLabel && d.dataLabel.destroy(), d.dataLabels && (1 === d.dataLabels.length ? delete d.dataLabels : delete d.dataLabels[h]), h || delete d.dataLabel, m && (d.connector = d.connector.destroy(),
                                d.connectors && (1 === d.connectors.length ? delete d.connectors : delete d.connectors[h])));
                            l && E(t) ? (n ? x.text = t : (d.dataLabels = d.dataLabels || [], n = d.dataLabels[h] = u ? p.text(t, 0, 0, c.useHTML).addClass("highcharts-data-label") : p.label(t, 0, 0, c.shape, null, null, c.useHTML, null, "data-label"), h || (d.dataLabel = n), n.addClass(" highcharts-data-label-color-" + d.colorIndex + " " + (c.className || "") + (c.useHTML ? " highcharts-tracker" : ""))), n.options = c, n.attr(x), b.styledMode || n.css(v).shadow(c.shadow), n.added || n.add(z), c.textPath &&
                                !c.useHTML && (n.setTextPath(d.getDataLabelPath && d.getDataLabelPath(n) || d.graphic, c.textPath), d.dataLabelPath && !c.textPath.enabled && (d.dataLabelPath = d.dataLabelPath.destroy())), a.alignDataLabel(d, n, c, null, q)) : n && n.hide()
                        })
                    })
                }
            ...
            function y(a, b, c, d, e, f) {
                ...
                p = void 0 === p ? 0 : p;
                var n = (c.x || 0) + l;
                if (0 > n) { "right" === g && 0 <= m ? (b.align = "left", b.inside = !0) : m -= n; var q = !0 }
                n = (c.x || 0) + d.width - l;
            ...
            function x(a, b) {
                var c = [],
                    d;
                if (u(a) && !u(b)) c = a.map(function(a) { return n(a, b) });
                else if (u(b) && !u(a)) c = b.map(function(b) { return n(a, b) });
                else if (u(a) || u(b))
                    for (d =
                        Math.max(a.length, b.length); d--;) c[d] = n(a[d], b[d]);
                else c = n(a, b);
                return c
            }
    ...
    K(f, "Series/Column/ColumnDataLabel.js", [f["Core/Series/DataLabel.js"], f["Core/Series/SeriesRegistry.js"], f["Core/Utilities.js"]], function(a, f, B) {
        ...
        (function(f) {
            function u(a, e, c, f, g) {
                ...
                n = (n.yAxis ? n.yAxis.len : this.chart.plotSizeY) ||
                    0;
                var u = a.dlBox || a.shapeArgs,
                    x = E(a.below, a.plotY > E(this.translatedThreshold, n)),
                    z = E(c.inside, !!this.options.stacking);
                u && (f = w(u), 0 > f.y && (f.height += f.y, f.y = 0), u = f.y + f.height - n, 0 < u && u < f.height && (f.height -= u), k && (f = { x: n - f.y - f.height, y: p - f.x - f.width, width: f.height, height: f.width }), z || (k ? (f.x += x ? 0 : f.width, f.width = 0) : (f.y += x ? f.height : 0, f.height = 0)));
                c.align = E(c.align, !k || z ? "center" : x ? "right" : "left");
                c.verticalAlign = E(c.verticalAlign, k || z ? "middle" : x ? "top" : "bottom");
                C.prototype.alignDataLabel.call(this, a,
                    e, c, f, g);
                c.inside && a.contrastColor && e.css({ color: a.contrastColor })
            }
            var n = [];
            f.compose = function(f) { a.compose(C); - 1 === n.indexOf(f) && (n.push(f), f.prototype.alignDataLabel = u) }
        })(I || (I = {}));
        return I
    });
    K(f, "Series/Bar/BarSeries.js", [f["Series/Column/ColumnSeries.js"], f["Core/Series/SeriesRegistry.js"], f["Core/Utilities.js"]], function(a, f, B) {
        var C = this && this.__extends || function() {
                var a = function(f, u) {
                    a = Object.setPrototypeOf || { __proto__: [] }
                    instanceof Array && function(a, f) { a.__proto__ = f } || function(a, f) {
        ...
        w(B.prototype, { inverted: !0 });
        f.registerSeriesType("bar", B);
        "";
        return B
    });
    K(f, "Series/Scatter/ScatterSeries.js", [f["Series/Column/ColumnSeries.js"],
        f["Series/Line/LineSeries.js"], f["Core/Series/SeriesRegistry.js"], f["Core/Utilities.js"]
    ], function(a, f, B, H) {
        var w = this && this.__extends || function() {
                var a = function(f, k) {
                    a = Object.setPrototypeOf || { __proto__: [] }
        ...
        H =
            function(a) {
                ...
                n.prototype.drawGraph = function() { this.options.lineWidth ? a.prototype.drawGraph.call(this) : this.graph && (this.graph = this.graph.destroy()) };
                n.defaultOptions = A(f.defaultOptions, { lineWidth: 0, findNearestPointBy: "xy", jitter: { x: 0, y: 0 }, marker: { enabled: !0 }, tooltip: { headerFormat: '<span style="color:{point.color}">\u25cf</span> <span style="font-size: 10px"> {series.name}</span><br/>', pointFormat: "x: <b>{point.x}</b><br/>y: <b>{point.y}</b><br/>" } });
                return n
            }(f);
        I(H.prototype, {
        ...
        C(H, "afterTranslate", function() { this.applyJitter() });
    ...
    K(f, "Series/Pie/PiePoint.js", [f["Core/Animation/AnimationUtilities.js"], f["Core/Series/Point.js"], f["Core/Utilities.js"]], function(a, f, B) {
        ...
        f = function(a) {
            ...
            e.prototype.getTranslate = function() { return this.sliced ? this.slicedTranslation : { translateX: 0, translateY: 0 } };
            e.prototype.haloPath = function(a) { var c = this.shapeArgs; return this.sliced || !this.visible ? [] : this.series.chart.renderer.symbols.arc(c.x, c.y, c.r + a, c.r + a, { innerR: c.r - 1, start: c.start, end: c.end }) };
            ...
            e.prototype.isValid = function() { return A(this.y) && 0 <= this.y };
            e.prototype.setVisible = function(a, e) {
                ...
                e = u(e, n);
                a !== this.visible && (this.visible = this.options.visible = a = "undefined" === typeof a ? !this.visible : a, f.options.data[f.data.indexOf(this)] = this.options, ["graphic", "dataLabel", "connector", "shadowGroup"].forEach(function(e) { if (c[e]) c[e][a ? "show" : "hide"](a) }), this.legendItem && k.legend.colorizeItem(this,
                    a), a || "hover" !== this.state || this.setState(""), n && (f.isDirty = !0), e && k.redraw())
            };
            ...
            connectorShapes: {
                fixedOffset: function(a, e, c) {
                    ...
                    return [
                        ["M", a.x,
                            a.y
                        ], c.softConnector ? ["C", a.x + ("left" === a.alignment ? -5 : 5), a.y, 2 * f.x - e.x, 2 * f.y - e.y, f.x, f.y] : ["L", f.x, f.y],
                        ["L", e.x, e.y]
                    ]
                },
        ...
        u = function(a) {
            ...
            c.prototype.animate = function(a) {
                ...
                a || e.forEach(function(a) {
                    var b = a.graphic,
                        d = a.shapeArgs;
                    b && d && (b.attr({ r: t(a.startR, c.center && c.center[3] / 2), start: f, end: f }), b.animate({ r: d.r, start: d.start, end: d.end }, c.options.animation))
                })
            };
            c.prototype.drawEmpty = function() {
                ...
                if (0 === this.total && this.center) {
                    ...
                    this.graph || (this.graph = this.chart.renderer.arc(f,
                        b, this.center[1] / 2, 0, a, c).addClass("highcharts-empty-series").add(this.group));
                    this.graph.attr({ d: A.arc(f, b, this.center[2] / 2, 0, { start: a, end: c, innerR: this.center[3] / 2 }) });
                    this.chart.styledMode || this.graph.attr({ "stroke-width": e.borderWidth, fill: e.fillColor || "none", stroke: e.color || "#cccccc" })
            ...
            c.prototype.hasData = function() { return !!this.processedXData.length };
            c.prototype.redrawPoints = function() {
                ...
                a.points.forEach(function(h) {
                    ...
                    if (!h.isNull && l) {
                        ...
                        h.delayedRendering ? (l.setRadialReference(a.center).attr(k).attr(b),
                            c.styledMode || l.attr(d).attr({ "stroke-linejoin": "round" }).shadow(f, n), h.delayedRendering = !1) : (l.setRadialReference(a.center), c.styledMode || g(!0, m, d), g(!0, m, k, b), l.animate(m));
                        l.attr({ visibility: h.visible ? "inherit" : "hidden" });
                        l.addClass(h.getClassName(), !0)
                    } else l && (h.graphic = l.destroy())
                })
            };
            c.prototype.sortByAngle = function(a, c) { a.sort(function(a, e) { return "undefined" !== typeof a.angle && (e.angle - a.angle) * c }) };
            c.prototype.translate = function(a) {
                ...
                for (r = 0; r < v; r++) {
                    ...
                    var x = g + u * b;
                    var C = { x: a[0], y: a[1], r: a[2] / 2, innerR: a[3] / 2, start: Math.round(1E3 * y) / 1E3, end: Math.round(1E3 * x) / 1E3 };
                    w.shapeType = "arc";
                    w.shapeArgs = C;
                    w.labelDistance = t(w.options.dataLabels &&
                        w.options.dataLabels.distance, n);
                    ...
                    w.slicedTranslation = { translateX: Math.round(Math.cos(x) * e), translateY: Math.round(Math.sin(x) * e) };
                    C = Math.cos(x) * a[2] / 2;
                    ...
                    w.labelPosition = {
                        natural: {
                            x: a[0] + C +
                                Math.cos(x) * w.labelDistance,
                            y: a[1] + A + Math.sin(x) * w.labelDistance
                        },
                        "final": {},
                        alignment: 0 > w.labelDistance ? "center" : w.half ? "right" : "left",
                        connectorPosition: { breakAt: { x: a[0] + C + Math.cos(x) * y, y: a[1] + A + Math.sin(x) * y }, touchingSliceAt: { x: a[0] + C, y: a[1] + A } }
                    }
                }
            ...
            c.prototype.updateTotals = function() {
                var a = this.points,
                    ...
                    f, b = 0;
                for (f = 0; f < c; f++) { var g = a[f];!g.isValid() || e && !g.visible || (b += g.y) }
                this.total = b;
        ...
        (function(f) {
            function g() {
                var a = this,
                    ...
                    F, E, H, K, U, G, T, M, V, W, Z, R;
                a.visible && (g.enabled || a._hasPointLabels) && (f.forEach(function(a) { a.dataLabel && a.visible && a.dataLabel.shortened && (a.dataLabel.attr({ width: "auto" }).css({ width: "auto", textOverflow: "clip" }), a.dataLabel.shortened = !1) }), A.prototype.drawDataLabels.apply(a), f.forEach(function(a) {
                    ...
                    if (h) {
                        ...
                        if (0 < a.maxLabelDistance) {
                            ...
                            e.forEach(function(a) {
                                0 < a.labelDistance && a.dataLabel && (a.top = Math.max(0, x - z - a.labelDistance), a.bottom = Math.min(x + z + a.labelDistance, b.plotHeight), m = a.dataLabel.getBBox().height ||
                                    21, a.distributeBox = { target: a.labelPosition.natural.y - a.top + m / 2, size: m, rank: a.y }, l.push(a.distributeBox))
                            });
                            r = t + m - r;
                            I(l, r, r / 5)
                        }
                        for (Z = 0; Z < h; Z++) {
                            ...
                            if (g.justify) M = B.justify(F, z, w);
                                ...
                                case "plotEdges":
                                    M =
                                        B.alignToPlotEdges(K, f, n, q);
                                    break;
                                default:
                                    M = B.radialDistributionX(a, F, V, r)
                            }
                            K._attr = { visibility: W, align: G.alignment };
                            R = F.options.dataLabels || {};
                            K._pos = { x: M + c(R.x, g.x) + ({ left: d, right: -d }[G.alignment] || 0), y: V + c(R.y, g.y) - 10 };
                            G.final.x = M;
                            G.final.y = V;
                            c(g.crop, !0) && (U = K.getBBox().width, r = null, M - U < d && 1 === f ? (r = Math.round(U - M + d), C[3] = Math.max(r, C[3])) : M + U > n - d && 0 === f && (r = Math.round(M + U - n + d), C[1] = Math.max(r, C[1])), 0 > V - T / 2 ? C[0] = Math.max(Math.round(-V + T / 2), C[0]) : V + T / 2 > p && (C[2] = Math.max(Math.round(V + T / 2 - p), C[2])),
                                K.sideOverflow = r)
                        }
                    }
                    ...
                    if (E = c(R.connectorWidth, 1)) {
                        ...
                        if ((K = d.dataLabel) && K._pos && d.visible && 0 < d.labelDistance) {
                            ...
                            H[f ? "attr" : "animate"]({ d: d.getConnectorPath() });
                            H.attr("visibility", W)
            ...
            function t() {
                this.points.forEach(function(a) {
                    var c = a.dataLabel,
                        b;
                    c && a.visible && ((b = c._pos) ? (c.sideOverflow && (c._attr.width = Math.max(c.getBBox().width - c.sideOverflow, 0), c.css({ width: c._attr.width + "px", textOverflow: (this.options.dataLabels.style || {}).textOverflow || "ellipsis" }), c.shortened = !0), c.attr(c._attr), c[c.moved ? "animate" : "attr"](b), c.moved = !0) : c && c.attr({ y: -9999 }));
            ...
            var x = [],
                z = {
                    ...
                    radialDistributionX: function(a, c, b, e) { return a.getX(b < c.top + 2 || b > c.bottom - 2 ? e : b, c.half, c) },
                    justify: function(a, c, b) { return b[0] + (a.half ? -1 : 1) * (c + a.labelDistance) },
                    alignToPlotEdges: function(a, c, b, e) { a = a.getBBox().width; return c ? a + e : b - a - e },
            ...
            f.compose = function(c) {
                a.compose(A); - 1 === x.indexOf(c) &&
                    (x.push(c), c = c.prototype, c.dataLabelPositioners = z, c.alignDataLabel = C, c.drawDataLabels = g, c.placeDataLabels = t, c.verifyDataLabelOverflow = w)
            }
        })(g || (g = {}));
        return g
    });
    K(f, "Extensions/OverlappingDataLabels.js", [f["Core/Chart/Chart.js"], f["Core/Utilities.js"]], function(a, f) {
        function C(a, f) {
            ...
            if (a) {
                ...
                }), w(f, "afterHideOverlappingLabel")) : a.attr({ opacity: c }));
                a.isOld = !0
            }
            return e
        }
        ...
        H(a, "render", function() {
            var a = this,
                f = [];
            (this.labelCollectors || []).forEach(function(a) { f = f.concat(a()) });
            (this.yAxis || []).forEach(function(a) { a.stacking && a.options.stackLabels && !a.options.stackLabels.allowOverlap && A(a.stacking.stacks, function(a) { A(a, function(a) { a.label && f.push(a.label) }) }) });
        ...
        a.prototype.hideOverlappingLabels = function(a) {
            ...
            var u = function(a) {
                ...
                if (a && (!a.alignAttr || a.placed)) {
                    ...
                    var n = a.width - 2 * f;
                    (g = { left: "0", center: "0.5", right: "1" }[a.alignValue]) ? b = +g * n: I(a.x) && Math.round(a.x) !== a.translateX && (b = a.x - a.translateX);
                    return {
            ...
            for (g = 0; g < e; g++)
                if (n = a[g]) n.oldOpacity = n.opacity, n.newOpacity = 1, n.absoluteBox = u(n);
            a.sort(function(a, c) { return (c.labelrank || 0) - (a.labelrank || 0) });
            for (g = 0; g < e; g++) { var y = (u = a[g]) && u.absoluteBox; for (n = g + 1; n < e; ++n) { var x = (t = a[n]) && t.absoluteBox;!y || !x || u === t || 0 === u.newOpacity || 0 === t.newOpacity || "hidden" === u.visibility || "hidden" === t.visibility || x.x >= y.x + y.width || x.x + x.width <= y.x || x.y >= y.y + y.height || x.y + x.height <= y.y || ((u.labelrank < t.labelrank ? u : t).newOpacity = 0) } }
            a.forEach(function(a) {
                C(a,
                    f) && (q = !0)
            });
    ...
    K(f, "Core/Responsive.js", [f["Core/Utilities.js"]], function(a) {
        ...
        (function(a) {
            var c = [];
            a.compose = function(a) {-1 === c.indexOf(a) && (c.push(a), f(a.prototype, e.prototype)); return a };
            var e = function() {
                function a() {}
                    ...
                    function c(a, f, g, h) {
                        ...
                        I(a, function(a, d) {
                            if (!h && -1 < e.collectionsWithUpdate.indexOf(d) && f[d])
                                for (a =
                                    u(a), g[d] = [], b = 0; b < Math.max(a.length, f[d].length); b++) f[d][b] && (void 0 === a[b] ? g[d][b] = f[d][b] : (g[d][b] = {}, c(a[b], f[d][b], g[d][b], h + 1)));
                            else w(a) ? (g[d] = H(a) ? [] : {}, c(a, f[d] || {}, g[d], h + 1)) : g[d] = "undefined" === typeof f[d] ? null : f[d]
                        })
                    }
                    var e = this,
                        f = {};
                ...
                a.prototype.matchResponsiveRule = function(a, c) {
                    var e = a.condition;
                    (e.callback || function() {
                        return this.chartWidth <= A(e.maxWidth, Number.MAX_VALUE) && this.chartHeight <= A(e.maxHeight, Number.MAX_VALUE) && this.chartWidth >= A(e.minWidth,
                            0) && this.chartHeight >= A(e.minHeight, 0)
                ...
                a.prototype.setResponsive = function(a, c) {
                    ...
                    c = E.apply(void 0, k.map(function(a) { return B((f || {}).rules || [], function(c) { return c._id === a }) }).map(function(a) { return a && a.chartOptions }));
    ...
    K(f, "masters/highcharts.src.js", [f["Core/Globals.js"], f["Core/Utilities.js"], f["Core/DefaultOptions.js"], f["Core/Animation/Fx.js"], f["Core/Animation/AnimationUtilities.js"], f["Core/Renderer/HTML/AST.js"], f["Core/FormatUtilities.js"], f["Core/Renderer/RendererUtilities.js"],
        ...
        f["Series/Column/ColumnSeries.js"], f["Series/Column/ColumnDataLabel.js"], f["Series/Pie/PieSeries.js"], f["Series/Pie/PieDataLabel.js"], f["Core/Series/DataLabel.js"], f["Core/Responsive.js"], f["Core/Color/Color.js"], f["Core/Time.js"]
    ], function(a, f, B, H, w, E, I, A, u, n, k, e, c, p, g, t, q, F, y, x, z, m, h, b, l, d, D, v, r, K, P, S, N) {
        a.animate = w.animate;
