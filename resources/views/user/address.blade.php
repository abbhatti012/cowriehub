   ...
   <div class="container-fluid">
        <div class="row page-titles">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="javascript:void(0)">Save Address</a></li>
            </ol>
        </div>
        ...
        <div class="row">
                        ...
                        <div class="card-body">
                            ...
                            <div class="basic-form">
                                <div class="mb-3">
                                    ...
                                    <input class="form-control form-control-lg" name="first_name" type="text" id="first_name" value="{{ $shipping['first_name'] }}" placeholder="Please enter your first name" required>
                                </div>
                            </div>
                            <div class="basic-form">
                                <div class="mb-3">
                                    <label for="last_name">Last Name *</label>
                                    <input class="form-control form-control-lg" name="last_name" type="text" id="last_name" value="{{ $shipping['last_name'] }}" placeholder="Please enter your last name" required>
                                </div>
                            </div>
                            <div class="basic-form">
                                <div class="mb-3">
            ...
            <div class="col-xl-6 col-lg-6">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Billing Detail</h4>
                    </div>
                    <div class="card-body">
