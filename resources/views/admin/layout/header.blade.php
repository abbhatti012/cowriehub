                        ...
                        <ul class="contacts">
                            <li class="active">
                                <div class="d-flex bd-highlight">
                                    ...
                                    <div class="ms-auto">
                                        <a href="javascript:void(0);" class="btn btn-primary btn-xs sharp me-1"><i class="fa fa-pencil-alt"></i></a>
...
<div class="deznav">
    <div class="deznav-scroll">
        <ul class="metismenu" id="menu">
            ...
            <li class="<?php if(request()->segment(2) == 'authors'){echo 'mm-active';} ?>"><a href="{{ route('admin.author') }}" class="ai-icon" aria-expanded="false">
                    <i class="fa fa-user"></i>
                    <span class="nav-text">Authors</span>
                </a>
            </li>
            <li class="<?php if(request()->segment(2) == 'consultants'){echo 'mm-active';} ?>"><a href="{{ route('admin.consultant') }}" class="ai-icon" aria-expanded="false">
                    <i class="fa fa-user"></i>
                    <span class="nav-text">Consultants</span>
                </a>
            </li>
            <li class="<?php if(request()->segment(2) == 'users' && request()->segment(3) != 'admin'){echo 'mm-active';} ?>"><a href="{{ route('admin.general-user') }}" class="ai-icon" aria-expanded="false">
                    <i class="fa fa-user"></i>
                    <span class="nav-text">General Users</span>
                </a>
            </li>
            <li class="<?php if(request()->segment(2) == 'publisher'){echo 'mm-active';} ?>"><a href="{{ route('admin.publisher') }}" class="ai-icon" aria-expanded="false">
                    <i class="fa fa-user"></i>
                    <span class="nav-text">Publishers</span>
                </a>
            </li>
            <li class="<?php if(request()->segment(2) == 'pos'){echo 'mm-active';} ?>"><a href="{{ route('admin.pos') }}" class="ai-icon" aria-expanded="false">
                    <i class="fa fa-user"></i>
                    <span class="nav-text">POS</span>
                </a>
            </li>
            <li class="<?php if(request()->segment(2) == 'affiliate'){echo 'mm-active';} ?>"><a href="{{ route('admin.affiliates') }}" class="ai-icon" aria-expanded="false">
