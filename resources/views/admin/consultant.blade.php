                            ...
                            <table id="example5" class="display" style="min-width: 845px">
                                ...
                                <?php for($i = 1; $i <= 30; $i++): ?>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex">
                                                <a href="#" class="btn btn-success shadow btn-xs sharp me-1" title="Approve Consultant"><i class="fa fa-check"></i></a>
                                                <a href="#" class="btn btn-primary shadow btn-xs sharp me-1" title=""><i class="fa fa-thumbs-down"></i></a>
                                                <a href="#" class="btn btn-warning shadow btn-xs sharp me-1" title=""><i class="fa fa-arrow-up"></i></a>
