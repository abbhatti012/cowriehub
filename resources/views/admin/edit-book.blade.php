                    ...
                    <div class="card-body">
                        ...
                        <div class="basic-form">
                            <div class="mb-3">
                                ...
                                <input type="number" min="1" class="form-control" value="{{ $book->quantity }}" name="quantity" id="quantity" required>
                            </div>
                        </div>
                        <div class="basic-form">
                            <div class="mb-3">
...
<script>
    $(document).ready(function(){
        ...
        $('.selectExtraField').on('change',function(){
            ...
            //     html += '<div class="basic-form">'+
            //                     '<div class="mb-3">'+
            //                         '<label for="title"><?php //echo $extra->label ?></label>'+
            //                         '<input class="form-control form-control-lg" name="extraFieldValue[]" value="<?php //echo $extra->value ?>" type="text">'+
            //                         '<input class="form-control form-control-lg" name="extraFieldLabel[]" value="<?php //echo $extra->label ?>" type="hidden">'+
            //                     '</div>'+
            //                 '</div>';
            // $('#selectExtraField').val("<?php //echo $extra->label ?>").prop("selected", "selected");
            <?php //endforeach; ?>
            // $('.extraFieldsHere').html(html);
        $('#sub_author').val('');
