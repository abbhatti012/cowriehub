                ...
                <div class="col-xl-12 col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Sellers Contract For Authors</h4>
                        </div>
                        @csrf
                            ...
                            <div class="basic-form custom_file_input col-xl-12">
                                <div class="input-group mb-3">
                                    <div class="card-body custom-ekeditor">
                                        <textarea name="seller_contracts_for_authors" id="ckeditor">{{ $setting->seller_contracts_for_authors }}</textarea>
                                    </div>
                                </div>
                            </div>
