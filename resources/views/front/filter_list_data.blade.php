...
<ul class="products list-unstyled mb-6">
        ...
        <div class="product__inner overflow-hidden p-3 p-md-4d875">
            <div class="woocommerce-LoopProduct-link woocommerce-loop-product__link row position-relative">
                <div class="col-md-auto woocommerce-loop-product__thumbnail mb-3 mb-md-0">
                    <a href="{{ route('product', $book->slug) }}" class="d-block"><img src="{{asset($book->cover)}}" class="img-fluid d-block mx-auto attachment-shop_catalog size-shop_catalog wp-post-image img-fluid listImage" alt="image-description"></a>
                </div>
                <div class="col-md woocommerce-loop-product__body product__body pt-3 bg-white mb-3 mb-md-0">
                    ...
                    <h2 class="woocommerce-loop-product__title product__title h6 text-lh-md mb-1 crop-text-2 h-dark"><a href="{{ route('product', $book->slug) }}" tabindex="0">{{ $book->title }}</a></h2>
    ...
    <div class="empty-state">
        <div class="empty-state__content">
            ...
            <div class="empty-state__message">Oops No book found!</div>
        </div>
    </div>
    @endforelse
</ul>