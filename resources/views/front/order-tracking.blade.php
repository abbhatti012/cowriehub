                    ...
                    <div class="row mb-6">
                        <div class="col-md-6 mb-5 mb-md-0">
                            <div class="js-form-message">
                                ...
                                <input type="text" class="form-control rounded-0" name="name" aria-label="Jack Wayley" id="exampleFormControlInput1" required="" data-error-class="u-has-error" data-msg="Please enter your name." data-success-class="u-has-success">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="js-form-message">
                                <label for="exampleFormControlInput2">Billing Email</label>
                                <input type="email" class="form-control rounded-0 font-size pl-3 placeholder-color-3" id="exampleFormControlInput2" name="email" aria-label="jackwayley@gmail.com" required="" placeholder="creativelayers088@gmail.com" data-msg="Please enter a valid email address." data-error-class="u-has-error" data-success-class="u-has-success">
                            </div>
                        </div>
                    </div>
                    <div class="d-flex justify-content-lg-start">
                        <button type="submit" class="btn btn-wide btn-dark text-white rounded-0 transition-3d-hover height-60 width-250">Track</button>
                    </div>
                </div>
            </div>
        </div>
