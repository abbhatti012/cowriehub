                                    ...
                                    @if(session('cart'))
                                        @foreach(session('cart') as $id => $cart)
                                            <tr class="woocommerce-cart-form__cart-item cart_item">
                                                ...
                                                <td class="product-subtotal" data-title="Total">
                                                    <span class="woocommerce-Price-amount amount"><span class="woocommerce-Price-currencySymbol">GHS</span>{{ ($cart['extraPrice'] + $cart['bookPrice']) * $cart['quantity']  }}</span>
                                                </td>
                                        ...
                                        <!-- <tr>
                                            <td colspan="5" class="actions">
                                                <input type="submit" class="button update_cart" name="update_cart" value="Update cart">
                                            </td>
                                        </tr> -->
                                    </tbody>
                                </table>
                        ...
                        <table class="shop_table shop_table_responsive">
                            <tbody>
                                <tr class="cart-subtotal">
                                    <th>Subtotal</th>
                                    <td data-title="Subtotal"><span class="woocommerce-Price-amount amount"><span class="woocommerce-Price-currencySymbol">GHS</span>{{ ($cart['extraPrice'] + $cart['bookPrice']) * $cart['quantity']  }}</span></td>
                                </tr>
                ...
                <div class="p-4d875 border">
                    ...
                    <div id="cartCollapseTwo" class="mt-4 cart-content collapse show"
                        ...
                        <ul id="shipping_method">
                            <li>
                                <input type="radio" name="shipping_method[0]" data-index="0" id="shipping_method_0_flat_rate1" checked="checked" value="0" class="shipping_method">
                                <label for="shipping_method_0_flat_rate1">Free shipping</label>
                            </li>

                            <li>
                                <input type="radio" name="shipping_method[0]" data-index="0" id="shipping_method_0_flat_rate3" value="8" class="shipping_method">
                                <label for="shipping_method_0_flat_rate3">Local pickup:: <span class="woocommerce-Price-amount amount"><span class="woocommerce-Price-currencySymbol">GHS</span>8</span></label>
                            </li>
                        </ul>
                        <!-- End Checkboxes -->
                    ...
                    <table class="shop_table shop_table_responsive">
                        <tbody>
                            <tr class="order-total">
                                <th>Total</th>
                                <td data-title="Total"><strong><span class="woocommerce-Price-amount amount"><span class="woocommerce-Price-currencySymbol">GHS </span>{{ ($cart['extraPrice'] + $cart['bookPrice']) * $cart['quantity']  }}</span></strong> </td>
                            </tr>
                        </tbody>
                    </table>
                </div>
