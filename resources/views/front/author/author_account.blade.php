                                ...
                                <div class="col">
                                    <div class="border py-6 text-center">
                                        <a href="#" class="btn btn-primary rounded-circle px-4 mb-2">
                                            <span class="fa fa-file font-size-10 btn-icon__inner"></span>
                                        </a>
                                        <div class="font-size-3 mb-xl-1">My Page</div>
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="border border-left-0 py-6 text-center">
                                        ...
                                        <div class="font-size-3 mb-xl-1">My Books</div>
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="border border-left-0 py-6 text-center">
                                        ...
                                        <div class="font-size-3 mb-xl-1">My Marketing</div>
                                    </div>
                                </div>
                            </div>
                        </div>
