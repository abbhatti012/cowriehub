                        ...
                        <ul class="my__account-nav nav flex-column mb-0" role="tablist" id="pills-tab">
                            ...
                            <li class="nav-item mx-0">
                                <a class="nav-link d-flex align-items-center px-0" id="pills-three-example1-tab" data-toggle="pill" href="#pills-three-example1" role="tab" aria-controls="pills-three-example1" aria-selected="false">
                                    <span class="font-weight-normal text-gray-600">Shipping Address</span>
                                </a>
                            </li>
                            <li class="nav-item mx-0">
                                <a class="nav-link d-flex align-items-center px-0" id="pills-four-example1-tab" data-toggle="pill" href="#pills-four-example1" role="tab" aria-controls="pills-four-example1" aria-selected="false">
                                    <span class="font-weight-normal text-gray-600">Billing Address</span>
                                </a>
                            </li>
                            <li class="nav-item mx-0">
                ...
                <div class="col-md-9">
                    ...
                    <div class="tab-content" id="pills-tabContent">
                        ...
                        <div class="tab-pane fade" id="pills-three-example1" role="tabpanel" aria-labelledby="pills-three-example1-tab">
                            <div class="pt-5 pl-md-5 pt-lg-8 pl-lg-9 space-bottom-lg-2 mb-lg-4">
                                <h6 class="font-weight-medium font-size-7 ml-lg-1 mb-lg-8 pb-xl-1">Shipping Address</h6>
                                <form action="{{ route('shipping-detail') }}" method="post" id="basic-validation">
                                    @csrf
                                    @if($shipping)
                                        <div class="pt-5 pl-md-5 pt-lg-8 pl-lg-9">
                                            <h6 class="font-weight-medium font-size-7 ml-lg-1 mb-lg-8 pb-xl-1">Address</h6>
                                            <div class="font-weight-medium font-size-22 mb-4 pb-xl-1">Shipping Address</div>
                                            <div class="row">
                                                <div class="col-md-6 mb-4">
                                                    <div class="js-form-message">
                                                        <label for="first_name">First name *</label>
                                                        <input type="text" class="form-control rounded-0 pl-3 placeholder-color-3" id="first_name" value="{{ $shipping['first_name'] }}" name="first_name" placeholder="Please enter your first name" required>
                                                    </div>
                                                </div>
                                                <div class="col-md-6 mb-4">
                                                    <div class="js-form-message">
                                                        <label for="last_name">Last name *</label>
                                                        <input type="text" class="form-control rounded-0 pl-3 placeholder-color-3" id="last_name" name="last_name" value="{{ $shipping['last_name'] }}" placeholder="Please enter your last name." required>
                                                    </div>
                                                </div>
                                                <div class="col-md-6 mb-4">
                                                    <div class="js-form-message">
                                                        <label for="shipping_country" class="form-label">Country <abbr class="required" title="required">*</abbr></label>
                                                        <select name="country" required id="shipping_country" class="form-control country_to_state country_select  select2-hidden-accessible"
                                                ...
                                                <div class="col-md-6 mb-4 mb-md-0">
                                                    <div class="js-form-message">
                                                        ...
                                                        <input type="email" class="form-control rounded-0" name="email" value="{{ $shipping['email'] }}" id="email" placeholder="Please enter your email" required>
                                                    </div>
                                                </div>
                                                <div class="col-md-6 mb-4 mb-md-0">
                                                    <div class="js-form-message">
                                                        <label for="address">Street Address *</label>
                                                        <input type="text" class="form-control rounded-0" name="address" id="address" value="{{ $shipping['address'] }}" required placeholder="Please enter your address">
                                                    </div>
                                                </div>
                                                <div class="col-md-6 mb-4 mb-md-0">
                                                    <div class="js-form-message">
                                                        <label for="phone">Phone *</label>
                                                        <input type="text" class="form-control rounded-0" name="phone" id="phone" value="{{ $shipping['phone'] }}" required placeholder="Please enter your phone">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="js-form-message">
                                                    ...
                                                    <textarea name="notes" class="input-text form-control" id="order_comments" placeholder="Notes about your order, e.g. special notes for delivery." rows="8" cols="5">{{ $shipping['notes'] }}</textarea>
                                                </div>
                                            </div>
                                                <div class="ml-3">
