...
<div class="container">
    <header class="entry-header space-top-2 space-bottom-1 mb-2">
        <h1 class="entry-title font-size-7">Your wishlist: {{ count($wishlist) }} items</h1>
    </header>
                                            ...
                                            <tr class="woocommerce-cart-form__cart-item cart_item">
                                                <td  class="product-name" data-title="Product">
                                                    <div class="d-flex align-items-center">
                                                        <a href="#">
                                                            <img width="100" src="{{ asset($wish->cover) }}" class="attachment-shop_thumbnail size-shop_thumbnail wp-post-image" alt="">
                                                        </a>
                                                ...
                                                <td class="product-price" data-title="Price">
                                                    <span class="woocommerce-Price-amount amount"><span class="woocommerce-Price-currencySymbol">GHS</span>{{ $wish->price }}</span>
                                                </td>

                                              
                                                <td class="product-remove">
                                                    <a href="javascript:void(0)" class="removeWishlist" data-id="{{ $wish->wish_id }}" aria-label="Remove this item">
